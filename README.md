...
draft-2020-12    80    1990 |         50          149      -67%
--------------------------------------------------------------------------------
TOTAL            315    7516 |         49           99      -51%
--------------------------------------------------------------------------------
```

Format validation is where tjs really shines — up to **264x faster** for complex formats:

```
idn-email                264x faster than ajv
