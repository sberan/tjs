...
--------------------------------------------------------------------------------
draft-04         43     881 |         36           75      -51%
draft-06         52    1170 |         34           66      -49%
draft-07         63    1534 |         62           76      -19%
...
Format validation is where tjs really shines — up to **249x faster** for complex formats:

```
idn-email                249x faster than ajv
