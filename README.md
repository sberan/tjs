...
100% spec compliance. 63% faster than ajv. Zero dependencies. Full TypeScript inference.
...
tjs uses JIT compilation to generate optimized validation code — **63% faster than ajv** overall:
...
────────────────────────────────────────────────────────────────────────────
draft-04         38     790 │         41           84      -51%
draft-06         49    1120 │         38           78      -51%
draft-07         54    1324 │         44           84      -48%
draft-2019-09    69    1703 │         67          180      -63%
draft-2020-12    68    1665 │         46          176      -74%
────────────────────────────────────────────────────────────────────────────
TOTAL            278    6602 │         49          131      -63%
────────────────────────────────────────────────────────────────────────────
```

Format validation is where tjs really shines — up to **217x faster** for complex formats:

```
idn-email                217x faster than ajv
