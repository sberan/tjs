...
────────────────────────────────────────────────────────────────────────────
draft-04         38     790 │         40           83      -52%
draft-06         49    1120 │         36           75      -51%
draft-07         54    1324 │         43           83      -48%
draft-2019-09    69    1703 │         46          183      -75%
draft-2020-12    68    1665 │         60          195      -69%
────────────────────────────────────────────────────────────────────────────
TOTAL            278    6602 │         47          136      -66%
────────────────────────────────────────────────────────────────────────────
```

Format validation is where tjs really shines — up to **268x faster** for complex formats:

```
idn-email                268x faster than ajv
