...
draft-2019-09    77    1941 |         58          154      -63%
draft-2020-12    80    1990 |         52          148      -65%
--------------------------------------------------------------------------------
TOTAL            315    7516 |         51           99      -48%
--------------------------------------------------------------------------------
```

Format validation is where tjs really shines — up to **252x faster** for complex formats:

```
idn-email                252x faster than ajv
