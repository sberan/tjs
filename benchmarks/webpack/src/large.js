/**
 * Large test case: complex e-commerce order schema with many $defs
 * This represents a real-world enterprise-level schema with:
 * - 14 $def definitions (address, phone, email, money, user, product, etc.)
 * - Deep nesting and multiple $ref usages
 * - Various validation keywords (format, pattern, enum, minItems, etc.)
...
const orderSchema = {
  "$defs": {
    "address": {
      ...
      "properties": {
        ...
        "country": { "type": "string", "enum": ["US", "CA", "MX", "UK", "DE", "FR", "JP", "CN", "AU", "BR"] },
        "coordinates": {
          "type": "object",
          "properties": {
    ...
    "money": {
      ...
      "properties": {
        ...
        "currency": { "type": "string", "enum": ["USD", "EUR", "GBP", "JPY", "CNY", "CAD", "AUD", "CHF", "INR", "MXN"] }
      },
    ...
    "user": {
      ...
      "properties": {
        ...
        "emails": { "type": "array", "items": { "$ref": "#/$defs/email" }, "minItems": 1, "maxItems": 5 },
        ...
        "status": { "type": "string", "enum": ["active", "inactive", "pending", "suspended", "deleted"] },
    ...
    "payment": {
      ...
      "properties": {
        "id": { "type": "string", "format": "uuid" },
        "method": { "type": "string", "enum": ["credit_card", "debit_card", "paypal", "bank_transfer", "cash", "check", "crypto", "gift_card"] },
        "amount": { "$ref": "#/$defs/money" },
        "status": { "type": "string", "enum": ["pending", "authorized", "captured", "refunded", "failed", "cancelled"] },
        "transactionId": { "type": "string" },
        "cardLast4": { "type": "string", "pattern": "^[0-9]{4}$" },
        "cardBrand": { "type": "string", "enum": ["visa", "mastercard", "amex", "discover", "jcb", "unionpay"] },
    ...
    "shipment": {
      ...
      "properties": {
        ...
        "status": { "type": "string", "enum": ["pending", "label_created", "in_transit", "out_for_delivery", "delivered", "exception", "returned"] },
  ...
  "properties": {
    ...
    "type": { "type": "string", "enum": ["standard", "subscription", "preorder", "backorder", "exchange", "return"] },
    "status": {
      "type": "string",
      "enum": ["draft", "pending", "confirmed", "processing", "shipped", "partial_shipped", "delivered", "completed", "cancelled", "refunded", "on_hold"]
    },
  ...
  "required": ["id", "orderNumber", "type", "status", "customer", "billingAddress", "shippingAddress", "items", "subtotal", "total", "audit"],
  "if": {
...
const orderValidator = schema(orderSchema);

export { orderValidator };

export function validateOrder(data) {
  return orderValidator.validate(data);
}
