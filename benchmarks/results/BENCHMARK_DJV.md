...
|-------|-------:|---------:|----------:|-----------:|----------:|----------:|-----:|
| draft4 | 199 | 198/199 | 28.8M | 150/199 | 3.5M | 150 | 🟢 **-88%** |
| draft6 | 276 | ✅ 276 | 29.6M | 208/276 | 3.6M | 208 | 🟢 **-88%** |
| draft7 | 313 | ✅ 313 | 16.3M | 219/313 | 4.0M | 219 | 🟢 **-75%** |
| draft2019-09 | 435 | ✅ 435 | 19.6M | 254/435 | 4.6M | 254 | 🟢 **-76%** |
...
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 64.6M | ✅ | 7.2M | 🟢 **-89%** |
| additionalItems.json | when items is schema, additionalItems... | 1 | ✅ | 174.6M | ✅ | 86.9M | 🟢 **-50%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 147.6M | ✅ | 19.6M | 🟢 **-87%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 189.7M | ✅ | 114.2M | 🟢 **-40%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 129.1M | ✅ | 85.9M | 🟢 **-33%** |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 41.2M | ✅ | 3.5M | 🟢 **-91%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 58.2M | ✅ | 6.8M | 🟢 **-88%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 69.0M | ✅ | 9.3M | 🟢 **-87%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 174.5M | ✅ | 103.8M | 🟢 **-41%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 51.9M | ✅ | 14.3M | 🟢 **-72%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 47.9M | ✅ | 7.5M | 🟢 **-84%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 37.0M | ✅ | 8.0M | 🟢 **-79%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 43.4M | ✅ | 6.7M | 🟢 **-85%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 174.6M | ✅ | 103.8M | 🟢 **-41%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 37.5M | ✅ | 3.6M | 🟢 **-90%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 52.3M | ✅ | 60.8M | +16% |
| allOf.json | allOf | 4 | ✅ | 45.3M | ✅ | 1.4M | 🟢 **-97%** |
| allOf.json | allOf with base schema | 5 | ✅ | 25.5M | ✅ | 1.4M | 🟢 **-94%** |
| allOf.json | allOf simple types | 2 | ✅ | 124.4M | ✅ | 6.5M | 🟢 **-95%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 173.5M | ✅ | 101.0M | 🟢 **-42%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 72.8M | ✅ | 103.1M | 🔴 **+42%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 69.4M | ✅ | 6.8M | 🟢 **-90%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 124.6M | ✅ | 7.0M | 🟢 **-94%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 70.4M | ✅ | 4.8M | 🟢 **-93%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 86.9M | ✅ | 3.4M | 🟢 **-96%** |
| anyOf.json | anyOf | 4 | ✅ | 64.2M | ✅ | 6.3M | 🟢 **-90%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 49.4M | ✅ | 3.6M | 🟢 **-93%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 53.2M | ✅ | 1.5M | 🟢 **-97%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 188.3M | ✅ | 12.8M | 🟢 **-93%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 71.0M | ✅ | 4.8M | 🟢 **-93%** |
| default.json | invalid type for default | 2 | ✅ | 108.2M | ✅ | 3.5M | 🟢 **-97%** |
| default.json | invalid string value for default | 2 | ✅ | 46.2M | ✅ | 2.7M | 🟢 **-94%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 84.6M | ✅ | 1.8M | 🟢 **-98%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 11.8M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 103.0M | ✅ | 4.4M | 🟢 **-96%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 32.2M | ✅ | 2.5M | 🟢 **-92%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 60.3M | ✅ | 1.4M | 🟢 **-98%** |
...
| enum.json | heterogeneous enum validation | 5 | ✅ | 61.8M | ✅ | 1.3M | 🟢 **-98%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 68.3M | ✅ | 4.6M | 🟢 **-93%** |
| enum.json | enums in properties | 6 | ✅ | 52.5M | ✅ | 1.6M | 🟢 **-97%** |
| enum.json | enum with escaped characters | 3 | ✅ | 56.3M | ✅ | 3.8M | 🟢 **-93%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 44.7M | ❌ | - | - |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 24.7M | ✅ | 3.0M | 🟢 **-88%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 113.7M | ❌ | - | - |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 57.7M | ✅ | 3.0M | 🟢 **-95%** |
| enum.json | enum with 0 does not match false | 3 | ✅ | 128.1M | ❌ | - | - |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 66.1M | ✅ | 3.8M | 🟢 **-94%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 125.6M | ❌ | - | - |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 56.6M | ✅ | 3.8M | 🟢 **-93%** |
| enum.json | nul characters in strings | 2 | ✅ | 92.8M | ✅ | 4.3M | 🟢 **-95%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 54.8M | ❌ | - | - |
| enum.json | characters with the same visual repre... | 2 | ✅ | 91.9M | ❌ | - | - |
...
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 39.2M | ✅ | 1.8M | 🟢 **-96%** |
| items.json | a schema given for items | 4 | ✅ | 72.6M | ✅ | 12.8M | 🟢 **-82%** |
| items.json | an array of schemas for items | 6 | ✅ | 68.0M | ✅ | 27.2M | 🟢 **-60%** |
| items.json | items and subitems | 6 | ✅ | 35.0M | ✅ | 2.1M | 🟢 **-94%** |
| items.json | nested items | 3 | ✅ | 13.5M | ✅ | 3.2M | 🟢 **-76%** |
| items.json | items with null instance elements | 1 | ✅ | 83.6M | ✅ | 88.3M | +6% |
| items.json | array-form items with null instance e... | 1 | ✅ | 89.1M | ✅ | 92.6M | +4% |
| maxItems.json | maxItems validation | 4 | ✅ | 71.6M | ✅ | 20.0M | 🟢 **-72%** |
| maxLength.json | maxLength validation | 5 | ✅ | 63.8M | ✅ | 21.1M | 🟢 **-67%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 52.1M | ✅ | 24.2M | 🟢 **-53%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 45.8M | ✅ | 9.9M | 🟢 **-78%** |
| maximum.json | maximum validation | 4 | ✅ | 81.7M | ✅ | 18.6M | 🟢 **-77%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 74.5M | ✅ | 20.4M | 🟢 **-73%** |
| maximum.json | maximum validation (explicit false ex... | 4 | ✅ | 75.9M | ❌ | - | - |
| maximum.json | exclusiveMaximum validation | 2 | ✅ | 64.2M | ❌ | - | - |
| minItems.json | minItems validation | 4 | ✅ | 79.8M | ✅ | 20.2M | 🟢 **-75%** |
| minLength.json | minLength validation | 5 | ✅ | 58.2M | ✅ | 12.4M | 🟢 **-79%** |
| minProperties.json | minProperties validation | 6 | ✅ | 58.4M | ✅ | 23.5M | 🟢 **-60%** |
| minimum.json | minimum validation | 4 | ✅ | 75.2M | ✅ | 18.6M | 🟢 **-75%** |
| minimum.json | minimum validation (explicit false ex... | 4 | ✅ | 73.7M | ✅ | 16.3M | 🟢 **-78%** |
| minimum.json | exclusiveMinimum validation | 2 | ✅ | 64.0M | ❌ | - | - |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 68.5M | ✅ | 17.4M | 🟢 **-75%** |
| multipleOf.json | by int | 3 | ✅ | 71.2M | ✅ | 12.9M | 🟢 **-82%** |
| multipleOf.json | by number | 3 | ✅ | 63.3M | ✅ | 14.1M | 🟢 **-78%** |
| multipleOf.json | by small number | 2 | ✅ | 61.4M | ✅ | 9.8M | 🟢 **-84%** |
| multipleOf.json | float division = inf | 1 | ✅ | 45.6M | ✅ | 5.4M | 🟢 **-88%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 74.4M | ✅ | 19.8M | 🟢 **-73%** |
| not.json | not | 2 | ✅ | 68.4M | ✅ | 6.9M | 🟢 **-90%** |
| not.json | not multiple types | 3 | ✅ | 61.5M | ✅ | 7.0M | 🟢 **-89%** |
| not.json | not more complex schema | 3 | ✅ | 65.4M | ✅ | 2.6M | 🟢 **-96%** |
| not.json | forbidden property | 2 | ✅ | 50.3M | ✅ | 2.8M | 🟢 **-94%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 45.6M | ✅ | 7.0M | 🟢 **-85%** |
| not.json | double negation | 1 | ✅ | 174.6M | ✅ | 6.9M | 🟢 **-96%** |
| oneOf.json | oneOf | 4 | ✅ | 66.3M | ✅ | 3.9M | 🟢 **-94%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 35.0M | ✅ | 5.6M | 🟢 **-84%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 43.4M | ✅ | 1.2M | 🟢 **-97%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 64.3M | ✅ | 6.2M | 🟢 **-90%** |
| oneOf.json | oneOf with required | 4 | ✅ | 43.5M | ✅ | 1.3M | 🟢 **-97%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 48.2M | ✅ | 1.8M | 🟢 **-96%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 68.6M | ✅ | 4.6M | 🟢 **-93%** |
| pattern.json | pattern validation | 8 | ✅ | 54.3M | ✅ | 28.6M | 🟢 **-47%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 54.4M | ✅ | 31.2M | 🟢 **-43%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 27.5M | ✅ | 9.2M | 🟢 **-66%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 15.2M | ✅ | 5.1M | 🟢 **-66%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 18.4M | ✅ | 5.1M | 🟢 **-72%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 12.8M | ✅ | 22.4M | 🔴 **+75%** |
...
| properties.json | properties with escaped characters | 2 | ✅ | 47.5M | ✅ | 390K | 🟢 **-99%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 73.8M | ✅ | 3.3M | 🟢 **-96%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 27.3M | ✅ | 866K | 🟢 **-97%** |
| ref.json | root pointer ref | 4 | ✅ | 25.2M | ✅ | 1.6M | 🟢 **-94%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 49.9M | ✅ | 1.6M | 🟢 **-97%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 56.0M | ✅ | 6.5M | 🟢 **-88%** |
| ref.json | escaped pointer ref | 6 | ✅ | 43.0M | ✅ | 1.2M | 🟢 **-97%** |
| ref.json | nested refs | 2 | ✅ | 38.6M | ✅ | 3.0M | 🟢 **-92%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 53.8M | ✅ | 2.3M | 🟢 **-96%** |
| ref.json | $ref prevents a sibling id from chang... | 2 | ✅ | 67.2M | ❌ | - | - |
| ref.json | remote ref, containing refs itself | 2 | ✅ | 23.4M | ❌ | - | - |
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 48.1M | ✅ | 2.3M | 🟢 **-95%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 49.3M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 11.6M | ✅ | 129K | 🟢 **-99%** |
...
| ref.json | naive replacement of $ref with its de... | 2 | ✅ | 52.5M | ✅ | 2.2M | 🟢 **-96%** |
| ref.json | id must be resolved against nearest p... | 2 | ✅ | 55.4M | ❌ | - | - |
| ref.json | id with file URI still resolves point... | 2 | ✅ | 69.7M | ✅ | 4.7M | 🟢 **-93%** |
| ref.json | id with file URI still resolves point... | 2 | ✅ | 69.0M | ✅ | 4.4M | 🟢 **-94%** |
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 69.5M | ✅ | 4.5M | 🟢 **-93%** |
...
| required.json | required validation | 5 | ✅ | 68.8M | ✅ | 8.6M | 🟢 **-87%** |
| required.json | required default validation | 1 | ✅ | 175.6M | ✅ | 44.5M | 🟢 **-75%** |
| required.json | required with escaped characters | 2 | ✅ | 39.9M | ✅ | 1.0M | 🟢 **-97%** |
| required.json | required properties whose names are J... | 7 | ✅ | 23.7M | ✅ | 2.8M | 🟢 **-88%** |
| type.json | integer type matches integers | 8 | ✅ | 53.3M | ✅ | 7.2M | 🟢 **-87%** |
| type.json | number type matches numbers | 9 | ✅ | 60.0M | ✅ | 8.9M | 🟢 **-85%** |
| type.json | string type matches strings | 9 | ✅ | 59.7M | ✅ | 8.9M | 🟢 **-85%** |
| type.json | object type matches objects | 7 | ✅ | 49.3M | ✅ | 7.1M | 🟢 **-86%** |
| type.json | array type matches arrays | 7 | ✅ | 54.7M | ✅ | 7.4M | 🟢 **-87%** |
| type.json | boolean type matches booleans | 10 | ✅ | 56.3M | ✅ | 7.8M | 🟢 **-86%** |
| type.json | null type matches only the null object | 10 | ✅ | 51.9M | ✅ | 7.0M | 🟢 **-87%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 54.6M | ✅ | 8.4M | 🟢 **-85%** |
| type.json | type as array with one item | 2 | ✅ | 69.4M | ✅ | 10.9M | 🟢 **-84%** |
| type.json | type: array or object | 5 | ✅ | 58.1M | ✅ | 9.5M | 🟢 **-84%** |
| type.json | type: array, object or null | 5 | ✅ | 70.5M | ✅ | 13.0M | 🟢 **-82%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 16.3M | ❌ | - | - |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 32.4M | ✅ | 4.8M | 🟢 **-85%** |
| uniqueItems.json | uniqueItems with an array of items an... | 5 | ✅ | 18.7M | ✅ | 5.0M | 🟢 **-73%** |
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 156.9M | ❌ | - | - |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 74.3M | ❌ | - | - |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 74.4M | ❌ | - | - |
| optional/bignum.json | integer | 2 | ✅ | 90.3M | ✅ | 12.6M | 🟢 **-86%** |
| optional/bignum.json | number | 2 | ✅ | 94.6M | ✅ | 41.5M | 🟢 **-56%** |
| optional/bignum.json | string | 1 | ✅ | 52.7M | ✅ | 6.3M | 🟢 **-88%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 85.8M | ✅ | 43.3M | 🟢 **-50%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 49.9M | ✅ | 4.3M | 🟢 **-91%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 84.6M | ✅ | 43.3M | 🟢 **-49%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 49.8M | ✅ | 4.4M | 🟢 **-91%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 58.5M | ✅ | 7.8M | 🟢 **-87%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 29.1M | ✅ | 8.1M | 🟢 **-72%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 28.5M | ✅ | 8.1M | 🟢 **-72%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.5M | ✅ | 8.1M | 🟢 **-72%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 28.3M | ✅ | 6.4M | 🟢 **-77%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 27.2M | ✅ | 9.0M | 🟢 **-67%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 29.1M | ✅ | 7.7M | 🟢 **-74%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 28.8M | ✅ | 7.7M | 🟢 **-73%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 27.1M | ✅ | 12.0M | 🟢 **-56%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 30.0M | ✅ | 5.5M | 🟢 **-82%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 16.7M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 16.3M | ✅ | 5.0M | 🟢 **-69%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 14.7M | ✅ | 5.3M | 🟢 **-64%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 27.4M | ✅ | 6.5M | 🟢 **-76%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 21.7M | ✅ | 4.8M | 🟢 **-78%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 22.0M | ✅ | 5.3M | 🟢 **-76%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 8.4M | ✅ | 3.8M | 🟢 **-54%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 95.6M | ✅ | 45.8M | 🟢 **-52%** |
...
| additionalItems.json | when items is schema, additionalItems... | 2 | ✅ | 44.6M | ✅ | 6.6M | 🟢 **-85%** |
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 159.1M | ✅ | 87.0M | 🟢 **-45%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 76.8M | ✅ | 18.1M | 🟢 **-76%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 170.8M | ✅ | 113.8M | 🟢 **-33%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 83.0M | ✅ | 92.9M | +12% |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 56.9M | ✅ | 3.6M | 🟢 **-94%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 45.2M | ✅ | 6.7M | 🟢 **-85%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 107.6M | ✅ | 9.2M | 🟢 **-91%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 158.8M | ✅ | 103.9M | 🟢 **-35%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 66.8M | ✅ | 14.3M | 🟢 **-79%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 34.7M | ✅ | 7.4M | 🟢 **-79%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 46.9M | ✅ | 8.3M | 🟢 **-82%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 35.9M | ✅ | 6.8M | 🟢 **-81%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 140.4M | ✅ | 103.3M | 🟢 **-26%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 28.7M | ✅ | 3.6M | 🟢 **-88%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 66.7M | ✅ | 61.5M | -8% |
...
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 159.3M | ✅ | 103.8M | 🟢 **-35%** |
...
| allOf.json | allOf with one empty schema | 1 | ✅ | 159.3M | ✅ | 102.6M | 🟢 **-36%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.3M | ✅ | 103.8M | 🟢 **-35%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 62.3M | ✅ | 7.0M | 🟢 **-89%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 115.7M | ✅ | 6.9M | 🟢 **-94%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 64.7M | ✅ | 4.7M | 🟢 **-93%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 83.3M | ✅ | 3.4M | 🟢 **-96%** |
| anyOf.json | anyOf | 4 | ✅ | 66.3M | ✅ | 6.5M | 🟢 **-90%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 50.1M | ✅ | 3.7M | 🟢 **-93%** |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 159.5M | ✅ | 103.8M | 🟢 **-35%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 159.4M | ✅ | 104.4M | 🟢 **-34%** |
...
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 183.1M | ✅ | 113.6M | 🟢 **-38%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 89.7M | ✅ | 7.0M | 🟢 **-92%** |
| const.json | const validation | 3 | ✅ | 55.1M | ✅ | 6.8M | 🟢 **-88%** |
| const.json | const with object | 4 | ✅ | 50.0M | ✅ | 1.6M | 🟢 **-97%** |
| const.json | const with array | 3 | ✅ | 49.4M | ✅ | 2.7M | 🟢 **-95%** |
| const.json | const with null | 2 | ✅ | 117.7M | ✅ | 4.1M | 🟢 **-97%** |
...
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 55.9M | ✅ | 5.4M | 🟢 **-90%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 110.6M | ✅ | 3.0M | 🟢 **-97%** |
...
| dependencies.json | dependencies | 7 | ✅ | 98.7M | ✅ | 4.4M | 🟢 **-96%** |
| dependencies.json | dependencies with empty array | 3 | ✅ | 175.4M | ✅ | 7.5M | 🟢 **-96%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 33.9M | ✅ | 2.5M | 🟢 **-93%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 40.0M | ✅ | 1.4M | 🟢 **-97%** |
| dependencies.json | dependencies with boolean subschemas | 4 | ✅ | 85.1M | ✅ | 2.7M | 🟢 **-97%** |
| dependencies.json | dependencies with escaped characters | 7 | ✅ | 18.7M | ✅ | 1.1M | 🟢 **-94%** |
| dependencies.json | dependent subschema incompatible with... | 4 | ✅ | 51.9M | ❌ | - | - |
| enum.json | simple enum validation | 2 | ✅ | 63.5M | ✅ | 6.1M | 🟢 **-90%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 60.1M | ✅ | 1.3M | 🟢 **-98%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 67.0M | ✅ | 4.6M | 🟢 **-93%** |
| enum.json | enums in properties | 6 | ✅ | 56.7M | ✅ | 1.6M | 🟢 **-97%** |
...
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 60.5M | ✅ | 3.8M | 🟢 **-94%** |
| enum.json | nul characters in strings | 2 | ✅ | 88.8M | ✅ | 4.3M | 🟢 **-95%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 60.0M | ✅ | 8.6M | 🟢 **-86%** |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 113.4M | ✅ | 8.8M | 🟢 **-92%** |
...
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 57.2M | ✅ | 1.7M | 🟢 **-97%** |
| items.json | a schema given for items | 4 | ✅ | 56.0M | ✅ | 12.9M | 🟢 **-77%** |
| items.json | an array of schemas for items | 6 | ✅ | 105.7M | ✅ | 26.8M | 🟢 **-75%** |
| items.json | items with boolean schema (true) | 2 | ✅ | 172.0M | ✅ | 100.9M | 🟢 **-41%** |
| items.json | items with boolean schema (false) | 2 | ✅ | 104.4M | ✅ | 7.0M | 🟢 **-93%** |
| items.json | items with boolean schemas | 3 | ✅ | 61.3M | ✅ | 15.7M | 🟢 **-74%** |
| items.json | items and subitems | 6 | ✅ | 35.2M | ✅ | 2.1M | 🟢 **-94%** |
| items.json | nested items | 3 | ✅ | 13.0M | ✅ | 3.3M | 🟢 **-75%** |
| items.json | single-form items with null instance ... | 1 | ✅ | 69.1M | ✅ | 87.4M | 🔴 **+26%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 83.0M | ✅ | 92.0M | +11% |
| maxItems.json | maxItems validation | 4 | ✅ | 73.7M | ✅ | 20.0M | 🟢 **-73%** |
| maxItems.json | maxItems validation with a decimal | 2 | ✅ | 63.5M | ✅ | 11.0M | 🟢 **-83%** |
| maxLength.json | maxLength validation | 5 | ✅ | 59.1M | ✅ | 20.1M | 🟢 **-66%** |
| maxLength.json | maxLength validation with a decimal | 2 | ✅ | 49.8M | ✅ | 10.2M | 🟢 **-79%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 49.9M | ✅ | 24.0M | 🟢 **-52%** |
...
| maximum.json | maximum validation | 4 | ✅ | 68.9M | ✅ | 18.7M | 🟢 **-73%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 62.1M | ✅ | 20.2M | 🟢 **-67%** |
| minItems.json | minItems validation | 4 | ✅ | 72.2M | ✅ | 19.8M | 🟢 **-73%** |
| minItems.json | minItems validation with a decimal | 2 | ✅ | 63.4M | ✅ | 10.9M | 🟢 **-83%** |
| minLength.json | minLength validation | 5 | ✅ | 50.8M | ✅ | 12.3M | 🟢 **-76%** |
| minLength.json | minLength validation with a decimal | 2 | ✅ | 52.3M | ✅ | 10.2M | 🟢 **-80%** |
| minProperties.json | minProperties validation | 6 | ✅ | 55.0M | ✅ | 22.6M | 🟢 **-59%** |
| minProperties.json | minProperties validation with a decimal | 2 | ✅ | 42.4M | ✅ | 9.4M | 🟢 **-78%** |
| minimum.json | minimum validation | 4 | ✅ | 69.1M | ✅ | 18.7M | 🟢 **-73%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 64.7M | ✅ | 17.4M | 🟢 **-73%** |
| multipleOf.json | by int | 3 | ✅ | 69.4M | ✅ | 12.3M | 🟢 **-82%** |
| multipleOf.json | by number | 3 | ✅ | 61.8M | ✅ | 14.4M | 🟢 **-77%** |
...
| not.json | not multiple types | 3 | ✅ | 55.9M | ✅ | 7.0M | 🟢 **-88%** |
| not.json | not more complex schema | 3 | ✅ | 58.1M | ✅ | 2.6M | 🟢 **-96%** |
| not.json | forbidden property | 2 | ✅ | 46.3M | ✅ | 2.8M | 🟢 **-94%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 49.1M | ✅ | 7.0M | 🟢 **-86%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 48.9M | ✅ | 7.0M | 🟢 **-86%** |
| not.json | allow everything with boolean schema ... | 9 | ✅ | 179.6M | ✅ | 7.2M | 🟢 **-96%** |
| not.json | double negation | 1 | ✅ | 158.8M | ✅ | 6.5M | 🟢 **-96%** |
| oneOf.json | oneOf | 4 | ✅ | 49.1M | ✅ | 4.0M | 🟢 **-92%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 18.2M | ✅ | 5.7M | 🟢 **-69%** |
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 49.9M | ✅ | 5.8M | 🟢 **-88%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 159.2M | ✅ | 3.4M | 🟢 **-98%** |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 40.9M | ✅ | 3.3M | 🟢 **-92%** |
...
| oneOf.json | oneOf with required | 4 | ✅ | 35.2M | ✅ | 1.2M | 🟢 **-96%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 22.1M | ✅ | 1.6M | 🟢 **-93%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 62.3M | ✅ | 4.5M | 🟢 **-93%** |
| pattern.json | pattern validation | 8 | ✅ | 52.7M | ✅ | 28.5M | 🟢 **-46%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 48.2M | ✅ | 31.8M | 🟢 **-34%** |
...
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 16.8M | ✅ | 5.2M | 🟢 **-69%** |
| patternProperties.json | patternProperties with boolean schemas | 5 | ✅ | 19.7M | ✅ | 4.4M | 🟢 **-78%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 17.7M | ✅ | 22.8M | 🔴 **+29%** |
| properties.json | object properties validation | 6 | ✅ | 49.4M | ✅ | 2.0M | 🟢 **-96%** |
...
| properties.json | properties with escaped characters | 2 | ✅ | 42.8M | ✅ | 395K | 🟢 **-99%** |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 169.9M | ✅ | 64.9M | 🟢 **-62%** |
| propertyNames.json | propertyNames with boolean schema false | 2 | ✅ | 39.8M | ✅ | 6.1M | 🟢 **-85%** |
| propertyNames.json | propertyNames with const | 3 | ✅ | 39.6M | ✅ | 5.4M | 🟢 **-86%** |
| propertyNames.json | propertyNames with enum | 4 | ✅ | 42.0M | ✅ | 4.2M | 🟢 **-90%** |
| ref.json | root pointer ref | 4 | ✅ | 23.7M | ✅ | 1.6M | 🟢 **-93%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 40.2M | ✅ | 1.6M | 🟢 **-96%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 46.8M | ✅ | 6.4M | 🟢 **-86%** |
| ref.json | escaped pointer ref | 6 | ✅ | 40.4M | ✅ | 1.2M | 🟢 **-97%** |
| ref.json | nested refs | 2 | ✅ | 44.3M | ✅ | 2.9M | 🟢 **-93%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 48.7M | ✅ | 2.3M | 🟢 **-95%** |
...
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 45.0M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | $ref to boolean schema true | 1 | ✅ | 159.4M | ✅ | 104.2M | 🟢 **-35%** |
| ref.json | $ref to boolean schema false | 1 | ✅ | 49.9M | ✅ | 2.5M | 🟢 **-95%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.9M | ✅ | 131K | 🟢 **-99%** |
...
| ref.json | naive replacement of $ref with its de... | 3 | ✅ | 43.5M | ✅ | 2.1M | 🟢 **-95%** |
...
| ref.json | URN base URI with NSS | 2 | ✅ | 22.2M | ✅ | 2.0M | 🟢 **-91%** |
| ref.json | URN base URI with r-component | 2 | ✅ | 39.1M | ✅ | 2.0M | 🟢 **-95%** |
| ref.json | URN base URI with q-component | 2 | ✅ | 44.8M | ✅ | 2.0M | 🟢 **-95%** |
| ref.json | URN base URI with URN and JSON pointe... | 2 | ✅ | 43.7M | ✅ | 2.0M | 🟢 **-95%** |
| ref.json | URN base URI with URN and anchor ref | 2 | ✅ | 43.8M | ❌ | - | - |
| ref.json | ref with absolute-path-reference | 2 | ✅ | 59.3M | ❌ | - | - |
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 62.3M | ✅ | 4.6M | 🟢 **-93%** |
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 62.3M | ✅ | 4.6M | 🟢 **-93%** |
...
| required.json | required validation | 5 | ✅ | 58.1M | ✅ | 9.6M | 🟢 **-83%** |
| required.json | required default validation | 1 | ✅ | 158.3M | ✅ | 104.5M | 🟢 **-34%** |
| required.json | required with empty array | 1 | ✅ | 156.8M | ✅ | 95.3M | 🟢 **-39%** |
| required.json | required with escaped characters | 2 | ✅ | 44.0M | ✅ | 1.1M | 🟢 **-98%** |
| required.json | required properties whose names are J... | 7 | ✅ | 23.2M | ✅ | 2.9M | 🟢 **-87%** |
| type.json | integer type matches integers | 9 | ✅ | 52.8M | ✅ | 8.7M | 🟢 **-83%** |
...
| type.json | array type matches arrays | 7 | ✅ | 51.0M | ✅ | 8.0M | 🟢 **-84%** |
...
| type.json | multiple types can be specified in an... | 7 | ✅ | 51.2M | ✅ | 9.3M | 🟢 **-82%** |
...
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 31.3M | ✅ | 5.2M | 🟢 **-83%** |
...
| optional/bignum.json | integer | 2 | ✅ | 80.0M | ✅ | 15.0M | 🟢 **-81%** |
| optional/bignum.json | number | 2 | ✅ | 84.1M | ✅ | 103.1M | 🔴 **+23%** |
| optional/bignum.json | string | 1 | ✅ | 47.7M | ✅ | 6.6M | 🟢 **-86%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 77.1M | ✅ | 98.7M | 🔴 **+28%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 45.6M | ✅ | 4.7M | 🟢 **-90%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 76.6M | ✅ | 98.6M | 🔴 **+29%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 26.9M | ✅ | 9.2M | 🟢 **-66%** |
...
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 27.1M | ✅ | 9.1M | 🟢 **-66%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 26.8M | ✅ | 8.8M | 🟢 **-67%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 24.8M | ✅ | 16.0M | 🟢 **-35%** |
...
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 14.5M | ✅ | 5.3M | 🟢 **-64%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 14.3M | ✅ | 5.9M | 🟢 **-59%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 24.6M | ✅ | 7.1M | 🟢 **-71%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 18.2M | ✅ | 5.2M | 🟢 **-71%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 20.6M | ✅ | 5.8M | 🟢 **-72%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 8.3M | ✅ | 4.3M | 🟢 **-48%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 82.0M | ✅ | 118.5M | 🔴 **+45%** |
...
| optional/id.json | non-schema object containing a plain-... | 2 | ✅ | 43.0M | ✅ | 832K | 🟢 **-98%** |
| optional/id.json | non-schema object containing an $id p... | 2 | ✅ | 43.5M | ✅ | 846K | 🟢 **-98%** |
...
| File | Group | Tests | tjs | tjs ops/s | djv | djv ops/s | Diff |
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 59.6M | ✅ | 7.1M | 🟢 **-88%** |
| additionalItems.json | when items is schema, additionalItems... | 2 | ✅ | 40.2M | ✅ | 6.7M | 🟢 **-83%** |
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 159.1M | ✅ | 82.2M | 🟢 **-48%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 76.4M | ✅ | 20.7M | 🟢 **-73%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 169.5M | ✅ | 110.8M | 🟢 **-35%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 83.0M | ✅ | 79.6M | -4% |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 56.9M | ✅ | 3.5M | 🟢 **-94%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 38.8M | ✅ | 6.8M | 🟢 **-83%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 107.4M | ✅ | 9.3M | 🟢 **-91%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 159.3M | ✅ | 102.8M | 🟢 **-35%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 67.1M | ✅ | 14.0M | 🟢 **-79%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 34.7M | ✅ | 7.4M | 🟢 **-79%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 45.0M | ✅ | 8.3M | 🟢 **-82%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 33.1M | ✅ | 6.7M | 🟢 **-80%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.4M | ✅ | 94.7M | 🟢 **-41%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 28.7M | ✅ | 3.6M | 🟢 **-88%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 66.8M | ✅ | 59.8M | -10% |
| allOf.json | allOf | 4 | ✅ | 34.8M | ✅ | 1.5M | 🟢 **-96%** |
| allOf.json | allOf with base schema | 5 | ✅ | 30.7M | ✅ | 1.5M | 🟢 **-95%** |
| allOf.json | allOf simple types | 2 | ✅ | 60.6M | ✅ | 6.5M | 🟢 **-89%** |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 159.6M | ✅ | 103.5M | 🟢 **-35%** |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 49.8M | ✅ | 3.6M | 🟢 **-93%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 3.7M | 🟢 **-96%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 158.3M | ✅ | 101.6M | 🟢 **-36%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.5M | ✅ | 86.5M | 🟢 **-46%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 61.7M | ✅ | 7.0M | 🟢 **-89%** |
...
| anyOf.json | anyOf | 4 | ✅ | 66.1M | ✅ | 6.4M | 🟢 **-90%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 48.3M | ✅ | 3.6M | 🟢 **-92%** |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 159.4M | ✅ | 103.6M | 🟢 **-35%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 159.0M | ✅ | 103.5M | 🟢 **-35%** |
...
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 179.4M | ✅ | 112.0M | 🟢 **-38%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 90.5M | ✅ | 7.0M | 🟢 **-92%** |
| const.json | const validation | 3 | ✅ | 55.1M | ✅ | 7.0M | 🟢 **-87%** |
| const.json | const with object | 4 | ✅ | 50.0M | ✅ | 1.6M | 🟢 **-97%** |
| const.json | const with array | 3 | ✅ | 49.5M | ✅ | 2.7M | 🟢 **-95%** |
...
| const.json | const with 0 does not match other zer... | 6 | ✅ | 53.4M | ❌ | - | - |
| const.json | const with 1 does not match true | 3 | ✅ | 114.4M | ❌ | - | - |
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 55.8M | ✅ | 5.3M | 🟢 **-90%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 110.3M | ✅ | 3.0M | 🟢 **-97%** |
| const.json | nul characters in strings | 2 | ✅ | 55.4M | ✅ | 4.3M | 🟢 **-92%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 78.1M | ❌ | - | - |
| const.json | characters with the same visual repre... | 2 | ✅ | 56.3M | ❌ | - | - |
| contains.json | contains keyword validation | 6 | ✅ | 103.8M | ✅ | 3.3M | 🟢 **-97%** |
| contains.json | contains keyword with const keyword | 3 | ✅ | 58.0M | ✅ | 1.7M | 🟢 **-97%** |
| contains.json | contains keyword with boolean schema ... | 2 | ✅ | 104.3M | ✅ | 11.1M | 🟢 **-89%** |
...
| contains.json | contains with null instance elements | 1 | ✅ | 127.0M | ✅ | 92.3M | 🟢 **-27%** |
| default.json | invalid type for default | 2 | ✅ | 62.5M | ✅ | 3.5M | 🟢 **-94%** |
| default.json | invalid string value for default | 2 | ✅ | 71.3M | ✅ | 2.8M | 🟢 **-96%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 45.4M | ✅ | 1.9M | 🟢 **-96%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 12.4M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 58.5M | ✅ | 4.4M | 🟢 **-93%** |
| dependencies.json | dependencies with empty array | 3 | ✅ | 175.3M | ✅ | 7.3M | 🟢 **-96%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 30.9M | ✅ | 2.5M | 🟢 **-92%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 40.3M | ✅ | 1.4M | 🟢 **-97%** |
| dependencies.json | dependencies with boolean subschemas | 4 | ✅ | 25.9M | ✅ | 2.8M | 🟢 **-89%** |
...
| enum.json | simple enum validation | 2 | ✅ | 60.6M | ✅ | 6.2M | 🟢 **-90%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 42.6M | ✅ | 1.4M | 🟢 **-97%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 64.5M | ✅ | 4.6M | 🟢 **-93%** |
| enum.json | enums in properties | 6 | ✅ | 38.1M | ✅ | 1.6M | 🟢 **-96%** |
| enum.json | enum with escaped characters | 3 | ✅ | 71.1M | ✅ | 3.7M | 🟢 **-95%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 56.3M | ❌ | - | - |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 52.2M | ✅ | 3.0M | 🟢 **-94%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 58.0M | ❌ | - | - |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 49.0M | ✅ | 3.0M | 🟢 **-94%** |
| enum.json | enum with 0 does not match false | 3 | ✅ | 57.0M | ❌ | - | - |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 52.0M | ✅ | 3.8M | 🟢 **-93%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 67.1M | ❌ | - | - |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 52.5M | ✅ | 3.8M | 🟢 **-93%** |
...
| format.json | idn-email format | 6 | ✅ | 81.3M | ✅ | 119.3M | 🔴 **+47%** |
| format.json | regex format | 6 | ✅ | 81.3M | ✅ | 20.2M | 🟢 **-75%** |
| format.json | ipv4 format | 6 | ✅ | 80.8M | ❌ | - | - |
| format.json | ipv6 format | 6 | ✅ | 80.4M | ❌ | - | - |
| format.json | idn-hostname format | 6 | ✅ | 45.4M | ✅ | 119.9M | 🔴 **+164%** |
| format.json | hostname format | 6 | ✅ | 85.3M | ❌ | - | - |
| format.json | date format | 6 | ✅ | 80.8M | ✅ | 104.1M | 🔴 **+29%** |
| format.json | date-time format | 6 | ✅ | 87.4M | ❌ | - | - |
| format.json | time format | 6 | ✅ | 81.2M | ✅ | 120.2M | 🔴 **+48%** |
| format.json | json-pointer format | 6 | ✅ | 81.4M | ❌ | - | - |
| format.json | relative-json-pointer format | 6 | ✅ | 86.3M | ✅ | 104.4M | 🔴 **+21%** |
| format.json | iri format | 6 | ✅ | 45.6M | ✅ | 119.7M | 🔴 **+163%** |
| format.json | iri-reference format | 6 | ✅ | 85.5M | ✅ | 104.4M | 🔴 **+22%** |
| format.json | uri format | 6 | ✅ | 81.2M | ❌ | - | - |
| format.json | uri-reference format | 6 | ✅ | 81.3M | ❌ | - | - |
| format.json | uri-template format | 6 | ✅ | 80.8M | ❌ | - | - |
| if-then-else.json | ignore if without then or else | 2 | ✅ | 171.2M | ✅ | 113.9M | 🟢 **-33%** |
| if-then-else.json | ignore then without if | 2 | ✅ | 167.9M | ✅ | 112.1M | 🟢 **-33%** |
...
| if-then-else.json | non-interference across combined schemas | 2 | ✅ | 171.4M | ✅ | 113.9M | 🟢 **-34%** |
...
| items.json | a schema given for items | 4 | ✅ | 60.1M | ✅ | 13.0M | 🟢 **-78%** |
| items.json | an array of schemas for items | 6 | ✅ | 65.5M | ✅ | 27.2M | 🟢 **-58%** |
| items.json | items with boolean schema (true) | 2 | ✅ | 171.4M | ✅ | 73.1M | 🟢 **-57%** |
| items.json | items with boolean schema (false) | 2 | ✅ | 62.3M | ✅ | 6.8M | 🟢 **-89%** |
| items.json | items with boolean schemas | 3 | ✅ | 61.8M | ✅ | 15.9M | 🟢 **-74%** |
| items.json | items and subitems | 6 | ✅ | 28.6M | ✅ | 2.1M | 🟢 **-93%** |
| items.json | nested items | 3 | ✅ | 13.4M | ✅ | 3.2M | 🟢 **-76%** |
| items.json | single-form items with null instance ... | 1 | ✅ | 77.1M | ✅ | 88.4M | +15% |
| items.json | array-form items with null instance e... | 1 | ✅ | 83.0M | ✅ | 90.4M | +9% |
| maxItems.json | maxItems validation | 4 | ✅ | 70.9M | ✅ | 20.0M | 🟢 **-72%** |
| maxItems.json | maxItems validation with a decimal | 2 | ✅ | 63.5M | ✅ | 11.1M | 🟢 **-83%** |
| maxLength.json | maxLength validation | 5 | ✅ | 58.5M | ✅ | 21.2M | 🟢 **-64%** |
| maxLength.json | maxLength validation with a decimal | 2 | ✅ | 51.8M | ✅ | 10.3M | 🟢 **-80%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 53.5M | ✅ | 24.2M | 🟢 **-55%** |
| maxProperties.json | maxProperties validation with a decimal | 2 | ✅ | 41.6M | ✅ | 9.8M | 🟢 **-77%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 42.4M | ✅ | 7.1M | 🟢 **-83%** |
| maximum.json | maximum validation | 4 | ✅ | 69.0M | ✅ | 18.5M | 🟢 **-73%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 67.1M | ✅ | 20.4M | 🟢 **-70%** |
| minItems.json | minItems validation | 4 | ✅ | 73.8M | ✅ | 19.9M | 🟢 **-73%** |
| minItems.json | minItems validation with a decimal | 2 | ✅ | 63.4M | ✅ | 11.2M | 🟢 **-82%** |
| minLength.json | minLength validation | 5 | ✅ | 52.2M | ✅ | 11.7M | 🟢 **-78%** |
| minLength.json | minLength validation with a decimal | 2 | ✅ | 52.3M | ✅ | 10.3M | 🟢 **-80%** |
| minProperties.json | minProperties validation | 6 | ✅ | 54.9M | ✅ | 24.2M | 🟢 **-56%** |
| minProperties.json | minProperties validation with a decimal | 2 | ✅ | 40.6M | ✅ | 9.9M | 🟢 **-76%** |
| minimum.json | minimum validation | 4 | ✅ | 69.0M | ✅ | 18.7M | 🟢 **-73%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 64.6M | ✅ | 17.4M | 🟢 **-73%** |
| multipleOf.json | by int | 3 | ✅ | 69.4M | ✅ | 12.8M | 🟢 **-82%** |
| multipleOf.json | by number | 3 | ✅ | 64.0M | ✅ | 13.7M | 🟢 **-79%** |
...
| not.json | not multiple types | 3 | ✅ | 56.1M | ✅ | 6.3M | 🟢 **-89%** |
| not.json | not more complex schema | 3 | ✅ | 59.6M | ✅ | 2.7M | 🟢 **-96%** |
| not.json | forbidden property | 2 | ✅ | 46.1M | ✅ | 2.8M | 🟢 **-94%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 49.1M | ✅ | 7.0M | 🟢 **-86%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 49.2M | ✅ | 7.0M | 🟢 **-86%** |
| not.json | allow everything with boolean schema ... | 9 | ✅ | 171.5M | ✅ | 7.2M | 🟢 **-96%** |
| not.json | double negation | 1 | ✅ | 159.3M | ✅ | 7.0M | 🟢 **-96%** |
| oneOf.json | oneOf | 4 | ✅ | 50.9M | ✅ | 3.9M | 🟢 **-92%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 33.2M | ✅ | 5.5M | 🟢 **-83%** |
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 49.8M | ✅ | 5.8M | 🟢 **-88%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 159.5M | ✅ | 3.4M | 🟢 **-98%** |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 49.9M | ✅ | 3.2M | 🟢 **-93%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 49.9M | ✅ | 1.8M | 🟢 **-96%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 40.2M | ✅ | 1.1M | 🟢 **-97%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 61.7M | ✅ | 6.3M | 🟢 **-90%** |
| oneOf.json | oneOf with required | 4 | ✅ | 44.1M | ✅ | 1.3M | 🟢 **-97%** |
...
| pattern.json | pattern validation | 8 | ✅ | 52.8M | ✅ | 28.8M | 🟢 **-45%** |
...
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 15.2M | ✅ | 4.9M | 🟢 **-67%** |
...
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 11.4M | ✅ | 22.8M | 🔴 **+100%** |
| properties.json | object properties validation | 6 | ✅ | 49.9M | ✅ | 2.0M | 🟢 **-96%** |
...
| properties.json | properties with escaped characters | 2 | ✅ | 44.8M | ✅ | 403K | 🟢 **-99%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 64.8M | ✅ | 3.4M | 🟢 **-95%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 26.2M | ✅ | 897K | 🟢 **-97%** |
| propertyNames.json | propertyNames validation | 6 | ✅ | 44.9M | ✅ | 5.5M | 🟢 **-88%** |
| propertyNames.json | propertyNames validation with pattern | 3 | ✅ | 19.8M | ✅ | 6.4M | 🟢 **-68%** |
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 171.5M | ✅ | 64.5M | 🟢 **-62%** |
| propertyNames.json | propertyNames with boolean schema false | 2 | ✅ | 42.5M | ✅ | 6.1M | 🟢 **-86%** |
| propertyNames.json | propertyNames with const | 3 | ✅ | 42.4M | ✅ | 5.5M | 🟢 **-87%** |
| propertyNames.json | propertyNames with enum | 4 | ✅ | 42.0M | ✅ | 4.2M | 🟢 **-90%** |
| ref.json | root pointer ref | 4 | ✅ | 24.2M | ✅ | 1.6M | 🟢 **-94%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 46.5M | ✅ | 1.6M | 🟢 **-97%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 51.0M | ✅ | 6.5M | 🟢 **-87%** |
| ref.json | escaped pointer ref | 6 | ✅ | 40.4M | ✅ | 1.2M | 🟢 **-97%** |
| ref.json | nested refs | 2 | ✅ | 46.3M | ✅ | 2.9M | 🟢 **-94%** |
...
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 34.4M | ✅ | 2.3M | 🟢 **-93%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 46.5M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | $ref to boolean schema true | 1 | ✅ | 158.6M | ✅ | 103.6M | 🟢 **-35%** |
| ref.json | $ref to boolean schema false | 1 | ✅ | 49.9M | ✅ | 2.5M | 🟢 **-95%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 9.1M | ✅ | 134K | 🟢 **-99%** |
...
| ref.json | naive replacement of $ref with its de... | 3 | ✅ | 43.9M | ✅ | 2.1M | 🟢 **-95%** |
...
| ref.json | URN base URI with r-component | 2 | ✅ | 46.6M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with q-component | 2 | ✅ | 46.6M | ✅ | 2.0M | 🟢 **-96%** |
...
| required.json | required default validation | 1 | ✅ | 159.2M | ✅ | 103.4M | 🟢 **-35%** |
| required.json | required with empty array | 1 | ✅ | 159.3M | ✅ | 86.6M | 🟢 **-46%** |
...
| type.json | number type matches numbers | 9 | ✅ | 55.0M | ✅ | 10.1M | 🟢 **-82%** |
| type.json | string type matches strings | 9 | ✅ | 54.8M | ✅ | 10.1M | 🟢 **-82%** |
| type.json | object type matches objects | 7 | ✅ | 46.2M | ✅ | 8.0M | 🟢 **-83%** |
| type.json | array type matches arrays | 7 | ✅ | 51.4M | ✅ | 8.0M | 🟢 **-84%** |
| type.json | boolean type matches booleans | 10 | ✅ | 51.9M | ✅ | 8.6M | 🟢 **-83%** |
| type.json | null type matches only the null object | 10 | ✅ | 49.0M | ✅ | 7.7M | 🟢 **-84%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 51.2M | ✅ | 9.4M | 🟢 **-82%** |
| type.json | type as array with one item | 2 | ✅ | 62.0M | ✅ | 13.0M | 🟢 **-79%** |
| type.json | type: array or object | 5 | ✅ | 55.6M | ✅ | 11.1M | 🟢 **-80%** |
| type.json | type: array, object or null | 5 | ✅ | 64.5M | ✅ | 15.7M | 🟢 **-76%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 17.0M | ❌ | - | - |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 31.4M | ✅ | 5.2M | 🟢 **-83%** |
| uniqueItems.json | uniqueItems with an array of items an... | 5 | ✅ | 18.5M | ✅ | 5.5M | 🟢 **-70%** |
...
| optional/bignum.json | number | 2 | ✅ | 84.2M | ✅ | 87.2M | +4% |
| optional/bignum.json | string | 1 | ✅ | 47.4M | ✅ | 6.8M | 🟢 **-86%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 77.0M | ✅ | 93.5M | 🔴 **+21%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 45.6M | ✅ | 4.8M | 🟢 **-89%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 77.1M | ✅ | 98.4M | 🔴 **+28%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 45.6M | ✅ | 4.8M | 🟢 **-89%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 25.4M | ✅ | 9.0M | 🟢 **-64%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 25.9M | ✅ | 9.0M | 🟢 **-65%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 25.4M | ✅ | 9.0M | 🟢 **-64%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 26.7M | ✅ | 7.3M | 🟢 **-73%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 25.8M | ✅ | 11.6M | 🟢 **-55%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 27.0M | ✅ | 9.0M | 🟢 **-67%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 25.4M | ✅ | 9.0M | 🟢 **-65%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.1M | ✅ | 16.3M | 🟢 **-37%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 27.7M | ✅ | 6.1M | 🟢 **-78%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 16.6M | ❌ | - | - |
...
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 25.5M | ✅ | 7.1M | 🟢 **-72%** |
...
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 8.1M | ✅ | 3.9M | 🟢 **-52%** |
| optional/ecmascript-regex.json | patternProperties with non-ASCII digits | 3 | ✅ | 9.1M | ❌ | - | - |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 82.2M | ✅ | 118.0M | 🔴 **+44%** |
...
| File | Group | Tests | tjs | tjs ops/s | djv | djv ops/s | Diff |
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 68.9M | ✅ | 7.3M | 🟢 **-89%** |
| additionalItems.json | when items is schema, additionalItems... | 2 | ✅ | 43.7M | ✅ | 6.8M | 🟢 **-84%** |
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 157.7M | ✅ | 86.9M | 🟢 **-45%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 76.7M | ✅ | 18.1M | 🟢 **-76%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 171.9M | ✅ | 114.1M | 🟢 **-34%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 83.0M | ✅ | 93.5M | +13% |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 56.9M | ✅ | 3.5M | 🟢 **-94%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 46.6M | ✅ | 6.8M | 🟢 **-85%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 107.6M | ✅ | 9.3M | 🟢 **-91%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 159.7M | ✅ | 103.8M | 🟢 **-35%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 61.8M | ✅ | 14.1M | 🟢 **-77%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 34.6M | ✅ | 7.4M | 🟢 **-79%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 47.4M | ✅ | 8.2M | 🟢 **-83%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 35.8M | ✅ | 6.8M | 🟢 **-81%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.6M | ✅ | 104.0M | 🟢 **-35%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 28.7M | ✅ | 3.6M | 🟢 **-88%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 66.7M | ✅ | 60.8M | -9% |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 31.2M | ✅ | 6.2M | 🟢 **-80%** |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 37.7M | ✅ | 4.4M | 🟢 **-88%** |
| allOf.json | allOf | 4 | ✅ | 34.8M | ✅ | 1.4M | 🟢 **-96%** |
| allOf.json | allOf with base schema | 5 | ✅ | 36.0M | ✅ | 1.4M | 🟢 **-96%** |
| allOf.json | allOf simple types | 2 | ✅ | 60.6M | ✅ | 6.3M | 🟢 **-90%** |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 159.1M | ✅ | 103.8M | 🟢 **-35%** |
...
| allOf.json | allOf with one empty schema | 1 | ✅ | 159.0M | ✅ | 102.0M | 🟢 **-36%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.2M | ✅ | 73.5M | 🟢 **-54%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 62.3M | ✅ | 7.0M | 🟢 **-89%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 115.7M | ✅ | 6.9M | 🟢 **-94%** |
...
| anyOf.json | anyOf | 4 | ✅ | 66.4M | ✅ | 6.3M | 🟢 **-90%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 34.0M | ✅ | 3.6M | 🟢 **-89%** |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 159.5M | ✅ | 103.6M | 🟢 **-35%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 159.2M | ✅ | 79.6M | 🟢 **-50%** |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 49.7M | ✅ | 2.5M | 🟢 **-95%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 48.1M | ✅ | 1.4M | 🟢 **-97%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 171.5M | ✅ | 12.8M | 🟢 **-93%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 64.8M | ✅ | 4.8M | 🟢 **-93%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 184.2M | ✅ | 112.4M | 🟢 **-39%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 48.8M | ✅ | 7.0M | 🟢 **-86%** |
| const.json | const validation | 3 | ✅ | 55.1M | ✅ | 6.9M | 🟢 **-87%** |
| const.json | const with object | 4 | ✅ | 36.4M | ✅ | 1.6M | 🟢 **-96%** |
| const.json | const with array | 3 | ✅ | 49.5M | ✅ | 2.7M | 🟢 **-95%** |
| const.json | const with null | 2 | ✅ | 74.5M | ✅ | 4.1M | 🟢 **-95%** |
...
| const.json | float and integers are equal up to 64... | 4 | ✅ | 63.0M | ✅ | 3.0M | 🟢 **-95%** |
| const.json | nul characters in strings | 2 | ✅ | 55.4M | ✅ | 4.3M | 🟢 **-92%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 50.6M | ❌ | - | - |
| const.json | characters with the same visual repre... | 2 | ✅ | 48.0M | ❌ | - | - |
| contains.json | contains keyword validation | 6 | ✅ | 58.8M | ✅ | 3.3M | 🟢 **-94%** |
| contains.json | contains keyword with const keyword | 3 | ✅ | 28.8M | ✅ | 1.7M | 🟢 **-94%** |
| contains.json | contains keyword with boolean schema ... | 2 | ✅ | 62.0M | ✅ | 11.0M | 🟢 **-82%** |
| contains.json | contains keyword with boolean schema ... | 3 | ✅ | 57.5M | ✅ | 6.3M | 🟢 **-89%** |
| contains.json | items + contains | 4 | ✅ | 40.0M | ❌ | - | - |
| contains.json | contains with false if subschema | 2 | ✅ | 59.9M | ✅ | 10.7M | 🟢 **-82%** |
| contains.json | contains with null instance elements | 1 | ✅ | 53.8M | ✅ | 92.4M | 🔴 **+72%** |
| content.json | validation of string-encoded content ... | 3 | ✅ | 176.3M | ✅ | 116.5M | 🟢 **-34%** |
| content.json | validation of binary string-encoding | 3 | ✅ | 169.5M | ✅ | 99.2M | 🟢 **-41%** |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 179.0M | ✅ | 118.6M | 🟢 **-34%** |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 177.3M | ✅ | 105.9M | 🟢 **-40%** |
| default.json | invalid type for default | 2 | ✅ | 66.3M | ✅ | 3.6M | 🟢 **-95%** |
| default.json | invalid string value for default | 2 | ✅ | 50.2M | ✅ | 2.8M | 🟢 **-95%** |
...
| dependentRequired.json | empty dependents | 3 | ✅ | 175.2M | ✅ | 117.2M | 🟢 **-33%** |
...
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 53.0M | ✅ | 3.0M | 🟢 **-94%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 57.6M | ❌ | - | - |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 49.2M | ✅ | 3.0M | 🟢 **-94%** |
...
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 58.1M | ✅ | 3.8M | 🟢 **-93%** |
| enum.json | nul characters in strings | 2 | ✅ | 55.4M | ✅ | 4.3M | 🟢 **-92%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 51.1M | ✅ | 8.8M | 🟢 **-83%** |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 55.1M | ✅ | 8.8M | 🟢 **-84%** |
| format.json | email format | 6 | ✅ | 133.3M | ❌ | - | - |
| format.json | idn-email format | 6 | ✅ | 172.7M | ✅ | 119.7M | 🟢 **-31%** |
| format.json | regex format | 6 | ✅ | 95.5M | ✅ | 21.7M | 🟢 **-77%** |
| format.json | ipv4 format | 6 | ✅ | 145.7M | ❌ | - | - |
| format.json | ipv6 format | 6 | ✅ | 182.2M | ❌ | - | - |
| format.json | idn-hostname format | 6 | ✅ | 182.7M | ✅ | 120.7M | 🟢 **-34%** |
| format.json | hostname format | 6 | ✅ | 181.7M | ❌ | - | - |
| format.json | date format | 6 | ✅ | 145.2M | ✅ | 104.3M | 🟢 **-28%** |
| format.json | date-time format | 6 | ✅ | 145.5M | ❌ | - | - |
| format.json | time format | 6 | ✅ | 172.6M | ✅ | 114.5M | 🟢 **-34%** |
| format.json | json-pointer format | 6 | ✅ | 94.9M | ❌ | - | - |
| format.json | relative-json-pointer format | 6 | ✅ | 128.7M | ✅ | 104.6M | -19% |
| format.json | iri format | 6 | ✅ | 181.7M | ✅ | 73.0M | 🟢 **-60%** |
| format.json | iri-reference format | 6 | ✅ | 173.3M | ✅ | 104.2M | 🟢 **-40%** |
| format.json | uri format | 6 | ✅ | 182.9M | ❌ | - | - |
| format.json | uri-reference format | 6 | ✅ | 181.9M | ❌ | - | - |
| format.json | uri-template format | 6 | ✅ | 173.9M | ❌ | - | - |
| format.json | uuid format | 6 | ✅ | 181.4M | ✅ | 120.0M | 🟢 **-34%** |
| format.json | duration format | 6 | ✅ | 99.6M | ✅ | 104.1M | +5% |
| if-then-else.json | ignore if without then or else | 2 | ✅ | 171.6M | ✅ | 104.9M | 🟢 **-39%** |
| if-then-else.json | ignore then without if | 2 | ✅ | 171.6M | ✅ | 113.2M | 🟢 **-34%** |
| if-then-else.json | ignore else without if | 2 | ✅ | 171.6M | ✅ | 113.8M | 🟢 **-34%** |
...
| if-then-else.json | non-interference across combined schemas | 2 | ✅ | 171.6M | ✅ | 113.0M | 🟢 **-34%** |
...
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 39.6M | ✅ | 1.8M | 🟢 **-95%** |
| items.json | a schema given for items | 4 | ✅ | 59.3M | ✅ | 12.9M | 🟢 **-78%** |
| items.json | an array of schemas for items | 6 | ✅ | 65.2M | ✅ | 27.3M | 🟢 **-58%** |
| items.json | items with boolean schema (true) | 2 | ✅ | 171.7M | ✅ | 100.9M | 🟢 **-41%** |
| items.json | items with boolean schema (false) | 2 | ✅ | 62.3M | ✅ | 6.9M | 🟢 **-89%** |
| items.json | items with boolean schemas | 3 | ✅ | 62.2M | ✅ | 15.9M | 🟢 **-74%** |
| items.json | items and subitems | 6 | ✅ | 29.0M | ✅ | 2.2M | 🟢 **-93%** |
| items.json | nested items | 3 | ✅ | 13.5M | ✅ | 3.2M | 🟢 **-76%** |
| items.json | single-form items with null instance ... | 1 | ✅ | 77.1M | ✅ | 84.5M | +10% |
| items.json | array-form items with null instance e... | 1 | ✅ | 83.0M | ✅ | 93.2M | +12% |
| maxContains.json | maxContains without contains is ignored | 2 | ✅ | 171.6M | ✅ | 111.7M | 🟢 **-35%** |
...
| maxProperties.json | maxProperties validation | 6 | ✅ | 54.1M | ✅ | 24.3M | 🟢 **-55%** |
| maxProperties.json | maxProperties validation with a decimal | 2 | ✅ | 40.1M | ✅ | 9.6M | 🟢 **-76%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 42.5M | ✅ | 9.8M | 🟢 **-77%** |
| maximum.json | maximum validation | 4 | ✅ | 69.0M | ✅ | 18.3M | 🟢 **-73%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 67.6M | ✅ | 20.2M | 🟢 **-70%** |
| minContains.json | minContains without contains is ignored | 2 | ✅ | 171.8M | ✅ | 108.3M | 🟢 **-37%** |
| minContains.json | minContains=1 with contains | 5 | ✅ | 60.1M | ✅ | 7.3M | 🟢 **-88%** |
...
| minItems.json | minItems validation | 4 | ✅ | 73.4M | ✅ | 20.1M | 🟢 **-73%** |
...
| minProperties.json | minProperties validation | 6 | ✅ | 55.2M | ✅ | 24.1M | 🟢 **-56%** |
| minProperties.json | minProperties validation with a decimal | 2 | ✅ | 42.2M | ✅ | 9.7M | 🟢 **-77%** |
| minimum.json | minimum validation | 4 | ✅ | 69.1M | ✅ | 18.5M | 🟢 **-73%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 64.9M | ✅ | 17.4M | 🟢 **-73%** |
| multipleOf.json | by int | 3 | ✅ | 69.4M | ✅ | 12.9M | 🟢 **-81%** |
| multipleOf.json | by number | 3 | ✅ | 64.3M | ✅ | 14.2M | 🟢 **-78%** |
| multipleOf.json | by small number | 2 | ✅ | 57.3M | ✅ | 10.0M | 🟢 **-83%** |
| multipleOf.json | float division = inf | 1 | ✅ | 43.2M | ✅ | 5.4M | 🟢 **-88%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 68.9M | ✅ | 20.5M | 🟢 **-70%** |
| not.json | not | 2 | ✅ | 62.9M | ✅ | 6.8M | 🟢 **-89%** |
| not.json | not multiple types | 3 | ✅ | 56.1M | ✅ | 6.8M | 🟢 **-88%** |
| not.json | not more complex schema | 3 | ✅ | 58.1M | ✅ | 2.6M | 🟢 **-96%** |
| not.json | forbidden property | 2 | ✅ | 46.1M | ✅ | 2.9M | 🟢 **-94%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 48.8M | ✅ | 7.1M | 🟢 **-85%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 49.0M | ✅ | 7.1M | 🟢 **-86%** |
| not.json | allow everything with boolean schema ... | 9 | ✅ | 179.4M | ✅ | 7.2M | 🟢 **-96%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 49.7M | ✅ | 5.8M | 🟢 **-88%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 159.5M | ✅ | 3.4M | 🟢 **-98%** |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 49.9M | ✅ | 3.3M | 🟢 **-93%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 49.9M | ✅ | 1.7M | 🟢 **-97%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 39.9M | ✅ | 1.1M | 🟢 **-97%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 53.0M | ✅ | 6.4M | 🟢 **-88%** |
| oneOf.json | oneOf with required | 4 | ✅ | 41.1M | ✅ | 1.2M | 🟢 **-97%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 43.4M | ✅ | 1.6M | 🟢 **-96%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 62.2M | ✅ | 4.6M | 🟢 **-93%** |
| pattern.json | pattern validation | 8 | ✅ | 52.6M | ✅ | 28.5M | 🟢 **-46%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 48.1M | ✅ | 31.9M | 🟢 **-34%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 24.7M | ✅ | 9.3M | 🟢 **-62%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 14.1M | ✅ | 5.1M | 🟢 **-64%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 15.8M | ✅ | 5.2M | 🟢 **-67%** |
...
| properties.json | properties with boolean schema | 4 | ✅ | 42.4M | ✅ | 2.0M | 🟢 **-95%** |
| properties.json | properties with escaped characters | 2 | ✅ | 44.3M | ✅ | 403K | 🟢 **-99%** |
...
| propertyNames.json | propertyNames validation | 6 | ✅ | 44.9M | ✅ | 5.5M | 🟢 **-88%** |
| propertyNames.json | propertyNames validation with pattern | 3 | ✅ | 19.8M | ✅ | 6.4M | 🟢 **-68%** |
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 162.7M | ✅ | 65.6M | 🟢 **-60%** |
| propertyNames.json | propertyNames with boolean schema false | 2 | ✅ | 19.8M | ✅ | 6.2M | 🟢 **-69%** |
| propertyNames.json | propertyNames with const | 3 | ✅ | 37.6M | ✅ | 5.5M | 🟢 **-85%** |
...
| ref.json | naive replacement of $ref with its de... | 3 | ✅ | 46.9M | ✅ | 2.3M | 🟢 **-95%** |
...
| ref.json | URN base URI with q-component | 2 | ✅ | 46.9M | ✅ | 2.1M | 🟢 **-96%** |
...
| required.json | required validation | 5 | ✅ | 56.5M | ✅ | 9.9M | 🟢 **-83%** |
| required.json | required default validation | 1 | ✅ | 159.6M | ✅ | 103.3M | 🟢 **-35%** |
| required.json | required with empty array | 1 | ✅ | 159.3M | ✅ | 94.6M | 🟢 **-41%** |
...
| type.json | null type matches only the null object | 10 | ✅ | 48.5M | ✅ | 7.7M | 🟢 **-84%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 51.3M | ✅ | 9.3M | 🟢 **-82%** |
| type.json | type as array with one item | 2 | ✅ | 62.3M | ✅ | 12.5M | 🟢 **-80%** |
| type.json | type: array or object | 5 | ✅ | 55.7M | ✅ | 10.9M | 🟢 **-80%** |
| type.json | type: array, object or null | 5 | ✅ | 67.1M | ✅ | 15.4M | 🟢 **-77%** |
| unevaluatedItems.json | unevaluatedItems true | 2 | ✅ | 83.8M | ✅ | 98.0M | +17% |
| unevaluatedItems.json | unevaluatedItems false | 2 | ✅ | 53.2M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems as schema | 3 | ✅ | 57.0M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with uniform items | 1 | ✅ | 72.0M | ✅ | 77.9M | +8% |
| unevaluatedItems.json | unevaluatedItems with tuple | 2 | ✅ | 50.0M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with items and addit... | 1 | ✅ | 80.8M | ✅ | 91.6M | +13% |
...
| unevaluatedItems.json | unevaluatedItems with nested items an... | 2 | ✅ | 84.0M | ✅ | 98.3M | +17% |
| unevaluatedItems.json | unevaluatedItems with nested unevalua... | 2 | ✅ | 22.0M | ✅ | 99.2M | 🔴 **+351%** |
...
| unevaluatedItems.json | non-array instances are valid | 6 | ✅ | 84.7M | ✅ | 119.7M | 🔴 **+41%** |
...
| unevaluatedProperties.json | unevaluatedProperties true | 2 | ✅ | 44.4M | ✅ | 86.0M | 🔴 **+94%** |
...
| unevaluatedProperties.json | unevaluatedProperties with adjacent a... | 2 | ✅ | 65.4M | ✅ | 3.5M | 🟢 **-95%** |
...
| unevaluatedProperties.json | unevaluatedProperties with nested add... | 2 | ✅ | 65.3M | ✅ | 3.4M | 🟢 **-95%** |
| unevaluatedProperties.json | unevaluatedProperties with nested une... | 2 | ✅ | 33.0M | ✅ | 3.5M | 🟢 **-90%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer f... | 2 | ✅ | 32.9M | ✅ | 3.5M | 🟢 **-89%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer f... | 2 | ✅ | 30.0M | ✅ | 3.4M | 🟢 **-89%** |
...
| unevaluatedProperties.json | non-object instances are valid | 6 | ✅ | 78.1M | ✅ | 120.0M | 🔴 **+54%** |
| unevaluatedProperties.json | unevaluatedProperties with null value... | 1 | ✅ | 49.5M | ✅ | 76.8M | 🔴 **+55%** |
...
| optional/bignum.json | integer | 2 | ✅ | 79.9M | ✅ | 15.0M | 🟢 **-81%** |
| optional/bignum.json | number | 2 | ✅ | 84.2M | ✅ | 87.3M | +4% |
| optional/bignum.json | string | 1 | ✅ | 47.6M | ✅ | 6.9M | 🟢 **-86%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 77.0M | ✅ | 97.7M | 🔴 **+27%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 45.5M | ✅ | 4.8M | 🟢 **-89%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 77.1M | ✅ | 97.6M | 🔴 **+27%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 45.6M | ✅ | 4.8M | 🟢 **-90%** |
...
| optional/dependencies-compatibility.json | single dependency | 7 | ✅ | 59.2M | ✅ | 4.4M | 🟢 **-93%** |
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 176.5M | ✅ | 7.4M | 🟢 **-96%** |
...
| optional/dependencies-compatibility.json | boolean subschemas | 4 | ✅ | 49.4M | ✅ | 2.7M | 🟢 **-94%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 18.9M | ✅ | 8.7M | 🟢 **-54%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 26.6M | ✅ | 9.1M | 🟢 **-66%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 21.4M | ✅ | 9.2M | 🟢 **-57%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 26.7M | ✅ | 7.3M | 🟢 **-73%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 25.8M | ✅ | 11.9M | 🟢 **-54%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 27.0M | ✅ | 9.1M | 🟢 **-66%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 24.3M | ✅ | 9.1M | 🟢 **-62%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.1M | ✅ | 16.2M | 🟢 **-38%** |
...
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 20.9M | ✅ | 5.5M | 🟢 **-74%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 88.6M | ✅ | 117.7M | 🔴 **+33%** |
| optional/format/uri-reference.json | validation of URI References | 15 | ✅ | 9.6M | ❌ | - | - |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 59.6M | ✅ | 14.7M | 🟢 **-75%** |
| optional/non-bmp-regex.json | Proper UTF-16 surrogate pair handling... | 7 | ✅ | 27.6M | ❌ | - | - |
| optional/non-bmp-regex.json | Proper UTF-16 surrogate pair handling... | 5 | ✅ | 17.7M | ❌ | - | - |
| optional/refOfUnknownKeyword.json | reference of a root arbitrary keyword  | 2 | ✅ | 46.0M | ✅ | 2.0M | 🟢 **-96%** |
| optional/refOfUnknownKeyword.json | reference of a root arbitrary keyword... | 2 | ✅ | 46.3M | ✅ | 2.1M | 🟢 **-96%** |
...
| File | Group | Tests | tjs | tjs ops/s | djv | djv ops/s | Diff |
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 53.6M | ✅ | 15.4M | 🟢 **-71%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 31.0M | ✅ | 7.4M | 🟢 **-76%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 45.1M | ✅ | 8.3M | 🟢 **-82%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 34.5M | ✅ | 6.7M | 🟢 **-81%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 140.4M | ✅ | 100.2M | 🟢 **-29%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 23.2M | ✅ | 3.5M | 🟢 **-85%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 66.6M | ✅ | 60.9M | -9% |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 29.2M | ✅ | 6.1M | 🟢 **-79%** |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 37.5M | ✅ | 4.3M | 🟢 **-88%** |
| allOf.json | allOf | 4 | ✅ | 34.3M | ✅ | 1.5M | 🟢 **-96%** |
| allOf.json | allOf with base schema | 5 | ✅ | 30.6M | ✅ | 1.4M | 🟢 **-95%** |
| allOf.json | allOf simple types | 2 | ✅ | 60.6M | ✅ | 6.3M | 🟢 **-90%** |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 152.8M | ✅ | 101.9M | 🟢 **-33%** |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 49.9M | ✅ | 3.6M | 🟢 **-93%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 3.6M | 🟢 **-96%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 159.3M | ✅ | 94.1M | 🟢 **-41%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.1M | ✅ | 99.7M | 🟢 **-37%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 62.3M | ✅ | 6.8M | 🟢 **-89%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 115.7M | ✅ | 6.9M | 🟢 **-94%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 53.8M | ✅ | 4.7M | 🟢 **-91%** |
...
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 159.6M | ✅ | 102.2M | 🟢 **-36%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 159.5M | ✅ | 102.0M | 🟢 **-36%** |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 49.9M | ✅ | 2.5M | 🟢 **-95%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 50.3M | ✅ | 1.4M | 🟢 **-97%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 171.7M | ✅ | 12.7M | 🟢 **-93%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 64.7M | ✅ | 4.5M | 🟢 **-93%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 183.9M | ✅ | 105.6M | 🟢 **-43%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 49.1M | ✅ | 7.0M | 🟢 **-86%** |
| const.json | const validation | 3 | ✅ | 55.1M | ✅ | 7.0M | 🟢 **-87%** |
| const.json | const with object | 4 | ✅ | 36.2M | ✅ | 1.5M | 🟢 **-96%** |
| const.json | const with array | 3 | ✅ | 49.5M | ✅ | 2.6M | 🟢 **-95%** |
...
| const.json | const with 1 does not match true | 3 | ✅ | 67.3M | ❌ | - | - |
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 55.8M | ✅ | 5.3M | 🟢 **-91%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 63.0M | ✅ | 3.1M | 🟢 **-95%** |
| const.json | nul characters in strings | 2 | ✅ | 53.0M | ✅ | 4.2M | 🟢 **-92%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 50.6M | ❌ | - | - |
| const.json | characters with the same visual repre... | 2 | ✅ | 56.3M | ❌ | - | - |
| contains.json | contains keyword validation | 6 | ✅ | 59.8M | ✅ | 3.3M | 🟢 **-94%** |
| contains.json | contains keyword with const keyword | 3 | ✅ | 53.6M | ✅ | 1.7M | 🟢 **-97%** |
| contains.json | contains keyword with boolean schema ... | 2 | ✅ | 49.0M | ✅ | 10.7M | 🟢 **-78%** |
...
| contains.json | contains with null instance elements | 1 | ✅ | 80.9M | ✅ | 88.9M | +10% |
| content.json | validation of string-encoded content ... | 3 | ✅ | 176.2M | ✅ | 114.5M | 🟢 **-35%** |
| content.json | validation of binary string-encoding | 3 | ✅ | 176.0M | ✅ | 97.7M | 🟢 **-44%** |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 179.5M | ✅ | 117.0M | 🟢 **-35%** |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 182.8M | ✅ | 99.7M | 🟢 **-45%** |
| default.json | invalid type for default | 2 | ✅ | 67.4M | ✅ | 3.5M | 🟢 **-95%** |
...
| dependentRequired.json | empty dependents | 3 | ✅ | 157.2M | ✅ | 111.0M | 🟢 **-29%** |
...
| enum.json | simple enum validation | 2 | ✅ | 56.2M | ✅ | 6.1M | 🟢 **-89%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 39.7M | ✅ | 1.4M | 🟢 **-97%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 66.5M | ✅ | 4.6M | 🟢 **-93%** |
| enum.json | enums in properties | 6 | ✅ | 38.1M | ✅ | 1.6M | 🟢 **-96%** |
| enum.json | enum with escaped characters | 3 | ✅ | 71.1M | ✅ | 3.7M | 🟢 **-95%** |
...
| enum.json | nul characters in strings | 2 | ✅ | 54.3M | ✅ | 4.2M | 🟢 **-92%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 55.5M | ✅ | 8.7M | 🟢 **-84%** |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 59.5M | ✅ | 8.8M | 🟢 **-85%** |
| format.json | email format | 7 | ✅ | 176.3M | ❌ | - | - |
| format.json | idn-email format | 7 | ✅ | 175.8M | ✅ | 116.5M | 🟢 **-34%** |
| format.json | regex format | 7 | ✅ | 183.1M | ✅ | 23.3M | 🟢 **-87%** |
| format.json | ipv4 format | 7 | ✅ | 175.2M | ❌ | - | - |
| format.json | ipv6 format | 7 | ✅ | 182.5M | ❌ | - | - |
| format.json | idn-hostname format | 7 | ✅ | 178.0M | ✅ | 116.9M | 🟢 **-34%** |
| format.json | hostname format | 7 | ✅ | 183.2M | ❌ | - | - |
| format.json | date format | 7 | ✅ | 182.4M | ✅ | 84.4M | 🟢 **-54%** |
| format.json | date-time format | 7 | ✅ | 182.7M | ❌ | - | - |
| format.json | time format | 7 | ✅ | 182.5M | ✅ | 116.5M | 🟢 **-36%** |
| format.json | json-pointer format | 7 | ✅ | 183.5M | ❌ | - | - |
| format.json | relative-json-pointer format | 7 | ✅ | 183.2M | ✅ | 99.7M | 🟢 **-46%** |
| format.json | iri format | 7 | ✅ | 182.1M | ✅ | 116.0M | 🟢 **-36%** |
| format.json | iri-reference format | 7 | ✅ | 182.6M | ✅ | 103.1M | 🟢 **-44%** |
| format.json | uri format | 7 | ✅ | 183.6M | ❌ | - | - |
| format.json | uri-reference format | 7 | ✅ | 184.0M | ❌ | - | - |
| format.json | uri-template format | 7 | ✅ | 176.3M | ❌ | - | - |
| format.json | uuid format | 7 | ✅ | 182.4M | ✅ | 116.8M | 🟢 **-36%** |
| format.json | duration format | 7 | ✅ | 182.0M | ✅ | 103.3M | 🟢 **-43%** |
| if-then-else.json | ignore if without then or else | 2 | ✅ | 171.5M | ✅ | 111.4M | 🟢 **-35%** |
| if-then-else.json | ignore then without if | 2 | ✅ | 171.6M | ✅ | 111.6M | 🟢 **-35%** |
| if-then-else.json | ignore else without if | 2 | ✅ | 170.3M | ✅ | 94.2M | 🟢 **-45%** |
...
| if-then-else.json | non-interference across combined schemas | 2 | ✅ | 171.7M | ✅ | 106.9M | 🟢 **-38%** |
| if-then-else.json | if with boolean schema true | 2 | ✅ | 64.7M | ❌ | - | - |
| if-then-else.json | if with boolean schema false | 2 | ✅ | 64.2M | ❌ | - | - |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 171.4M | ✅ | 99.0M | 🟢 **-42%** |
| items.json | items with boolean schema (false) | 2 | ✅ | 62.3M | ✅ | 6.9M | 🟢 **-89%** |
| items.json | items and subitems | 6 | ✅ | 29.0M | ❌ | - | - |
| items.json | nested items | 3 | ✅ | 13.4M | ✅ | 3.2M | 🟢 **-76%** |
| items.json | prefixItems with no additional items ... | 5 | ✅ | 76.7M | ❌ | - | - |
| items.json | items does not look in applicators, v... | 2 | ✅ | 46.7M | ✅ | 6.8M | 🟢 **-86%** |
| items.json | prefixItems validation adjusts the st... | 2 | ✅ | 45.3M | ❌ | - | - |
| items.json | items with heterogeneous array | 2 | ✅ | 63.5M | ❌ | - | - |
| items.json | items with null instance elements | 1 | ✅ | 77.1M | ✅ | 85.2M | +11% |
| maxContains.json | maxContains without contains is ignored | 2 | ✅ | 164.3M | ✅ | 100.8M | 🟢 **-39%** |
| maxContains.json | maxContains with contains | 5 | ✅ | 51.7M | ❌ | - | - |
| maxContains.json | maxContains with contains, value with... | 2 | ✅ | 57.9M | ❌ | - | - |
| maxContains.json | minContains < maxContains | 3 | ✅ | 50.9M | ❌ | - | - |
| maxItems.json | maxItems validation | 4 | ✅ | 73.8M | ✅ | 19.9M | 🟢 **-73%** |
| maxItems.json | maxItems validation with a decimal | 2 | ✅ | 63.5M | ✅ | 10.9M | 🟢 **-83%** |
| maxLength.json | maxLength validation | 5 | ✅ | 59.1M | ✅ | 21.3M | 🟢 **-64%** |
| maxLength.json | maxLength validation with a decimal | 2 | ✅ | 51.7M | ✅ | 10.3M | 🟢 **-80%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 52.9M | ✅ | 24.0M | 🟢 **-55%** |
| maxProperties.json | maxProperties validation with a decimal | 2 | ✅ | 41.8M | ✅ | 9.3M | 🟢 **-78%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 42.6M | ✅ | 9.7M | 🟢 **-77%** |
| maximum.json | maximum validation | 4 | ✅ | 63.0M | ✅ | 18.2M | 🟢 **-71%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 67.7M | ✅ | 19.5M | 🟢 **-71%** |
| minContains.json | minContains without contains is ignored | 2 | ✅ | 171.4M | ✅ | 111.4M | 🟢 **-35%** |
...
| minItems.json | minItems validation | 4 | ✅ | 73.9M | ✅ | 20.0M | 🟢 **-73%** |
| minItems.json | minItems validation with a decimal | 2 | ✅ | 63.5M | ✅ | 10.9M | 🟢 **-83%** |
| minLength.json | minLength validation | 5 | ✅ | 53.0M | ✅ | 12.5M | 🟢 **-76%** |
| minLength.json | minLength validation with a decimal | 2 | ✅ | 52.3M | ✅ | 9.9M | 🟢 **-81%** |
| minProperties.json | minProperties validation | 6 | ✅ | 54.9M | ✅ | 24.0M | 🟢 **-56%** |
| minProperties.json | minProperties validation with a decimal | 2 | ✅ | 41.0M | ✅ | 9.5M | 🟢 **-77%** |
| minimum.json | minimum validation | 4 | ✅ | 69.0M | ✅ | 18.6M | 🟢 **-73%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 64.4M | ✅ | 17.2M | 🟢 **-73%** |
| multipleOf.json | by int | 3 | ✅ | 65.5M | ✅ | 12.6M | 🟢 **-81%** |
| multipleOf.json | by number | 3 | ✅ | 63.3M | ✅ | 14.1M | 🟢 **-78%** |
| multipleOf.json | by small number | 2 | ✅ | 57.3M | ✅ | 9.8M | 🟢 **-83%** |
| multipleOf.json | float division = inf | 1 | ✅ | 43.2M | ✅ | 5.4M | 🟢 **-88%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 68.9M | ✅ | 21.4M | 🟢 **-69%** |
| not.json | not | 2 | ✅ | 62.9M | ✅ | 6.9M | 🟢 **-89%** |
| not.json | not multiple types | 3 | ✅ | 56.1M | ✅ | 6.9M | 🟢 **-88%** |
| not.json | not more complex schema | 3 | ✅ | 58.1M | ✅ | 2.6M | 🟢 **-95%** |
...
| not.json | double negation | 1 | ✅ | 157.1M | ✅ | 6.9M | 🟢 **-96%** |
| not.json | collect annotations inside a 'not', e... | 2 | ✅ | 31.3M | ❌ | - | - |
| oneOf.json | oneOf | 4 | ✅ | 50.9M | ✅ | 4.0M | 🟢 **-92%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 36.5M | ✅ | 5.6M | 🟢 **-85%** |
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 49.9M | ✅ | 5.8M | 🟢 **-88%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 155.6M | ✅ | 3.3M | 🟢 **-98%** |
...
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 62.3M | ✅ | 4.5M | 🟢 **-93%** |
| pattern.json | pattern validation | 8 | ✅ | 52.8M | ✅ | 28.1M | 🟢 **-47%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 48.1M | ✅ | 32.1M | 🟢 **-33%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 26.8M | ✅ | 9.4M | 🟢 **-65%** |
...
| patternProperties.json | patternProperties with boolean schemas | 5 | ✅ | 21.1M | ✅ | 4.5M | 🟢 **-79%** |
...
| prefixItems.json | additional items are allowed by default | 1 | ✅ | 83.0M | ✅ | 101.7M | 🔴 **+22%** |
| prefixItems.json | prefixItems with null instance elements | 1 | ✅ | 83.0M | ✅ | 102.2M | 🔴 **+23%** |
...
| properties.json | properties with escaped characters | 2 | ✅ | 44.7M | ✅ | 403K | 🟢 **-99%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 64.8M | ✅ | 3.4M | 🟢 **-95%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 26.2M | ✅ | 894K | 🟢 **-97%** |
| propertyNames.json | propertyNames validation | 6 | ✅ | 44.2M | ✅ | 5.6M | 🟢 **-87%** |
| propertyNames.json | propertyNames validation with pattern | 3 | ✅ | 19.8M | ✅ | 5.7M | 🟢 **-71%** |
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 171.8M | ✅ | 66.9M | 🟢 **-61%** |
| propertyNames.json | propertyNames with boolean schema false | 2 | ✅ | 42.7M | ✅ | 6.1M | 🟢 **-86%** |
...
| ref.json | escaped pointer ref | 6 | ✅ | 40.5M | ✅ | 1.2M | 🟢 **-97%** |
| ref.json | nested refs | 2 | ✅ | 47.2M | ✅ | 3.6M | 🟢 **-92%** |
...
| ref.json | $ref to boolean schema true | 1 | ✅ | 159.6M | ✅ | 102.5M | 🟢 **-36%** |
| ref.json | $ref to boolean schema false | 1 | ✅ | 49.9M | ✅ | 3.6M | 🟢 **-93%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 9.1M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 46.7M | ✅ | 1.7M | 🟢 **-96%** |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 27.3M | ❌ | - | - |
| ref.json | naive replacement of $ref with its de... | 3 | ✅ | 47.1M | ✅ | 2.3M | 🟢 **-95%** |
| ref.json | refs with relative uris and defs | 3 | ✅ | 36.8M | ❌ | - | - |
...
| ref.json | simple URN base URI with JSON pointer | 2 | ✅ | 46.2M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with NSS | 2 | ✅ | 46.6M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with r-component | 2 | ✅ | 46.7M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with q-component | 2 | ✅ | 44.8M | ✅ | 2.0M | 🟢 **-96%** |
...
| required.json | required default validation | 1 | ✅ | 159.1M | ✅ | 102.4M | 🟢 **-36%** |
| required.json | required with empty array | 1 | ✅ | 159.6M | ✅ | 93.2M | 🟢 **-42%** |
| required.json | required with escaped characters | 2 | ✅ | 44.0M | ✅ | 1.1M | 🟢 **-98%** |
| required.json | required properties whose names are J... | 7 | ✅ | 25.1M | ✅ | 2.9M | 🟢 **-88%** |
| type.json | integer type matches integers | 9 | ✅ | 52.8M | ✅ | 8.6M | 🟢 **-84%** |
| type.json | number type matches numbers | 9 | ✅ | 55.1M | ✅ | 10.1M | 🟢 **-82%** |
| type.json | string type matches strings | 9 | ✅ | 54.7M | ✅ | 10.1M | 🟢 **-81%** |
| type.json | object type matches objects | 7 | ✅ | 46.2M | ✅ | 8.1M | 🟢 **-83%** |
| type.json | array type matches arrays | 7 | ✅ | 51.4M | ✅ | 8.0M | 🟢 **-84%** |
| type.json | boolean type matches booleans | 10 | ✅ | 51.8M | ✅ | 8.7M | 🟢 **-83%** |
| type.json | null type matches only the null object | 10 | ✅ | 49.1M | ✅ | 7.8M | 🟢 **-84%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 52.1M | ✅ | 9.4M | 🟢 **-82%** |
| type.json | type as array with one item | 2 | ✅ | 62.3M | ✅ | 12.7M | 🟢 **-80%** |
| type.json | type: array or object | 5 | ✅ | 55.7M | ✅ | 10.9M | 🟢 **-80%** |
| type.json | type: array, object or null | 5 | ✅ | 65.5M | ✅ | 15.6M | 🟢 **-76%** |
| unevaluatedItems.json | unevaluatedItems true | 2 | ✅ | 83.0M | ✅ | 110.8M | 🔴 **+33%** |
| unevaluatedItems.json | unevaluatedItems false | 2 | ✅ | 53.4M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems as schema | 3 | ✅ | 57.0M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with uniform items | 1 | ✅ | 72.0M | ✅ | 77.5M | +8% |
| unevaluatedItems.json | unevaluatedItems with tuple | 2 | ✅ | 49.9M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with items and prefi... | 1 | ✅ | 80.9M | ✅ | 92.3M | +14% |
| unevaluatedItems.json | unevaluatedItems with items | 2 | ✅ | 44.0M | ✅ | 6.8M | 🟢 **-85%** |
| unevaluatedItems.json | unevaluatedItems with nested tuple | 2 | ✅ | 48.0M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with nested items | 3 | ✅ | 23.4M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with nested prefixIt... | 2 | ✅ | 84.0M | ✅ | 98.1M | +17% |
| unevaluatedItems.json | unevaluatedItems with nested unevalua... | 2 | ✅ | 21.0M | ✅ | 112.1M | 🔴 **+434%** |
...
| unevaluatedItems.json | non-array instances are valid | 6 | ✅ | 92.8M | ✅ | 117.8M | 🔴 **+27%** |
| unevaluatedItems.json | unevaluatedItems with null instance e... | 1 | ✅ | 77.1M | ✅ | 83.0M | +8% |
| unevaluatedItems.json | unevaluatedItems can see annotations ... | 2 | ✅ | 21.6M | ❌ | - | - |
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 36.0M | ❌ | - | - |
| unevaluatedProperties.json | unevaluatedProperties true | 2 | ✅ | 54.3M | ✅ | 109.4M | 🔴 **+102%** |
...
| unevaluatedProperties.json | unevaluatedProperties with adjacent b... | 2 | ✅ | 171.6M | ✅ | 111.7M | 🟢 **-35%** |
| unevaluatedProperties.json | unevaluatedProperties with adjacent n... | 2 | ✅ | 34.4M | ✅ | 6.6M | 🟢 **-81%** |
...
| unevaluatedProperties.json | unevaluatedProperties with nested add... | 2 | ✅ | 66.6M | ✅ | 3.3M | 🟢 **-95%** |
| unevaluatedProperties.json | unevaluatedProperties with nested une... | 2 | ✅ | 28.9M | ✅ | 3.3M | 🟢 **-89%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.4M | ❌ | - | - |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.5M | ❌ | - | - |
| unevaluatedProperties.json | nested unevaluatedProperties, outer f... | 2 | ✅ | 28.9M | ✅ | 3.2M | 🟢 **-89%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer f... | 2 | ✅ | 30.7M | ✅ | 3.4M | 🟢 **-89%** |
...
| unevaluatedProperties.json | dynamic evalation inside nested refs | 21 | ✅ | 7.2M | ❌ | - | - |
| unevaluatedProperties.json | non-object instances are valid | 6 | ✅ | 71.8M | ✅ | 107.3M | 🔴 **+50%** |
| unevaluatedProperties.json | unevaluatedProperties with null value... | 1 | ✅ | 49.6M | ✅ | 83.2M | 🔴 **+68%** |
| unevaluatedProperties.json | unevaluatedProperties not affected by... | 2 | ✅ | 27.8M | ❌ | - | - |
...
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 29.4M | ✅ | 5.1M | 🟢 **-82%** |
...
| vocabulary.json | ignore unrecognized optional vocabulary | 2 | ✅ | 62.3M | ✅ | 12.4M | 🟢 **-80%** |
| optional/anchor.json | $anchor inside an enum is not a real ... | 4 | ✅ | 52.0M | ❌ | - | - |
| optional/bignum.json | integer | 2 | ✅ | 79.9M | ✅ | 15.1M | 🟢 **-81%** |
| optional/bignum.json | number | 2 | ✅ | 84.2M | ✅ | 86.5M | +3% |
| optional/bignum.json | string | 1 | ✅ | 47.6M | ✅ | 6.7M | 🟢 **-86%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 76.6M | ✅ | 96.5M | 🔴 **+26%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 45.6M | ✅ | 4.8M | 🟢 **-89%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 77.1M | ✅ | 97.1M | 🔴 **+26%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 45.6M | ✅ | 4.8M | 🟢 **-89%** |
| optional/cross-draft.json | refs to historic drafts are processed... | 1 | ✅ | 87.5M | ❌ | - | - |
| optional/dependencies-compatibility.json | single dependency | 7 | ✅ | 59.5M | ✅ | 4.4M | 🟢 **-93%** |
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 176.4M | ✅ | 7.3M | 🟢 **-96%** |
| optional/dependencies-compatibility.json | multiple dependents required | 6 | ✅ | 30.9M | ✅ | 2.4M | 🟢 **-92%** |
| optional/dependencies-compatibility.json | dependencies with escaped characters | 4 | ✅ | 42.1M | ✅ | 1.7M | 🟢 **-96%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 52.2M | ✅ | 9.0M | 🟢 **-83%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 19.0M | ✅ | 9.1M | 🟢 **-52%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 26.3M | ✅ | 8.9M | 🟢 **-66%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 25.4M | ✅ | 8.8M | 🟢 **-65%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 26.7M | ✅ | 7.1M | 🟢 **-73%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 25.8M | ✅ | 11.6M | 🟢 **-55%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 26.5M | ✅ | 8.9M | 🟢 **-66%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 25.4M | ✅ | 9.0M | 🟢 **-64%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.1M | ✅ | 16.2M | 🟢 **-38%** |
...
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 14.3M | ✅ | 5.3M | 🟢 **-63%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 14.8M | ✅ | 5.9M | 🟢 **-60%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 26.3M | ✅ | 7.1M | 🟢 **-73%** |
| optional/ecmascript-regex.json | pattern with non-ASCII digits | 3 | ✅ | 21.4M | ❌ | - | - |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 23.4M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 20.6M | ✅ | 5.3M | 🟢 **-74%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 20.5M | ✅ | 5.9M | 🟢 **-72%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 82.3M | ✅ | 116.7M | 🔴 **+42%** |
...
| optional/format-assertion.json | schema that uses custom metaschema wi... | 2 | ✅ | 17.6M | ✅ | 6.3M | 🟢 **-64%** |
| optional/id.json | $id inside an enum is not a real iden... | 3 | ✅ | 40.1M | ❌ | - | - |
| optional/no-schema.json | validation without $schema | 3 | ✅ | 59.9M | ✅ | 14.4M | 🟢 **-76%** |
...
| optional/refOfUnknownKeyword.json | reference of a root arbitrary keyword  | 2 | ✅ | 46.5M | ✅ | 2.0M | 🟢 **-96%** |
| optional/refOfUnknownKeyword.json | reference of a root arbitrary keyword... | 2 | ✅ | 46.5M | ✅ | 2.0M | 🟢 **-96%** |
| optional/refOfUnknownKeyword.json | reference of an arbitrary keyword of ... | 2 | ✅ | 46.3M | ✅ | 1.6M | 🟢 **-97%** |
| optional/refOfUnknownKeyword.json | reference internals of known non-appl... | 2 | ✅ | 62.2M | ✅ | 6.9M | 🟢 **-89%** |
| optional/refOfUnknownKeyword.json | reference of an arbitrary keyword of ... | 2 | ✅ | 46.3M | ✅ | 1.6M | 🟢 **-97%** |
