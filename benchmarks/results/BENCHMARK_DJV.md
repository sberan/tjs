...
|-------|-------:|---------:|----------:|-----------:|----------:|----------:|-----:|
| draft4 | 199 | 198/199 | 28.2M | 150/199 | 3.5M | 150 | 🟢 **-88%** |
| draft6 | 276 | ✅ 276 | 30.2M | 208/276 | 3.9M | 208 | 🟢 **-87%** |
| draft7 | 313 | ✅ 313 | 16.5M | 219/313 | 4.0M | 219 | 🟢 **-76%** |
| draft2019-09 | 435 | ✅ 435 | 20.2M | 254/435 | 4.7M | 254 | 🟢 **-77%** |
| draft2020-12 | 448 | ✅ 448 | 20.5M | 244/448 | 4.7M | 244 | 🟢 **-77%** |
| **Total** | 1671 | 1670/1671 | 21.1M | 1075/1671 | 4.2M | 1075 | 🟢 **-80%** |

## Head-to-Head Performance

Direct comparison using only test groups where **both** validators pass **all** tests. This ensures a fair comparison by excluding groups where either validator has incomplete or incorrect implementations.

**Result**: 🟢 **tjs** is **10.73x faster** (22 ns vs 241 ns per test, 3717 tests in 1075 groups)
...
| additionalItems.json | when items is schema, additionalItems... | 1 | ✅ | 142.6M | ✅ | 86.2M | 🟢 **-40%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 139.1M | ✅ | 18.0M | 🟢 **-87%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 171.6M | ✅ | 113.6M | 🟢 **-34%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 124.3M | ✅ | 92.8M | 🟢 **-25%** |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 46.5M | ✅ | 3.5M | 🟢 **-92%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 58.9M | ✅ | 6.7M | 🟢 **-89%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 72.8M | ✅ | 9.2M | 🟢 **-87%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 159.6M | ✅ | 102.8M | 🟢 **-36%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 50.6M | ✅ | 14.2M | 🟢 **-72%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 41.9M | ✅ | 7.5M | 🟢 **-82%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 34.1M | ✅ | 8.3M | 🟢 **-76%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 44.5M | ✅ | 6.8M | 🟢 **-85%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.1M | ✅ | 100.8M | 🟢 **-37%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 33.4M | ✅ | 3.5M | 🟢 **-89%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 52.3M | ✅ | 58.8M | +12% |
| allOf.json | allOf | 4 | ✅ | 48.3M | ✅ | 1.5M | 🟢 **-97%** |
| allOf.json | allOf with base schema | 5 | ✅ | 27.4M | ✅ | 1.4M | 🟢 **-95%** |
| allOf.json | allOf simple types | 2 | ✅ | 109.9M | ✅ | 6.4M | 🟢 **-94%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 158.2M | ✅ | 103.3M | 🟢 **-35%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 157.6M | ✅ | 85.3M | 🟢 **-46%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 77.1M | ✅ | 6.6M | 🟢 **-91%** |
...
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 134.1M | ✅ | 3.3M | 🟢 **-98%** |
| anyOf.json | anyOf | 4 | ✅ | 81.5M | ✅ | 6.2M | 🟢 **-92%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 47.7M | ✅ | 3.6M | 🟢 **-93%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 50.9M | ✅ | 1.5M | 🟢 **-97%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 172.0M | ✅ | 12.4M | 🟢 **-93%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 78.5M | ✅ | 4.7M | 🟢 **-94%** |
| default.json | invalid type for default | 2 | ✅ | 107.4M | ✅ | 3.5M | 🟢 **-97%** |
| default.json | invalid string value for default | 2 | ✅ | 55.2M | ✅ | 2.7M | 🟢 **-95%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 77.6M | ✅ | 1.8M | 🟢 **-98%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 12.8M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 90.9M | ✅ | 4.2M | 🟢 **-95%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 34.4M | ✅ | 2.5M | 🟢 **-93%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 58.2M | ✅ | 1.4M | 🟢 **-98%** |
| dependencies.json | dependencies with escaped characters | 7 | ✅ | 11.6M | ✅ | 1.1M | 🟢 **-91%** |
...
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 66.4M | ✅ | 3.0M | 🟢 **-96%** |
...
| items.json | a schema given for items | 4 | ✅ | 81.6M | ✅ | 12.8M | 🟢 **-84%** |
| items.json | an array of schemas for items | 6 | ✅ | 68.1M | ✅ | 27.1M | 🟢 **-60%** |
| items.json | items and subitems | 6 | ✅ | 28.4M | ✅ | 2.2M | 🟢 **-92%** |
| items.json | nested items | 3 | ✅ | 12.2M | ✅ | 3.2M | 🟢 **-73%** |
| items.json | items with null instance elements | 1 | ✅ | 75.3M | ✅ | 88.0M | +17% |
| items.json | array-form items with null instance e... | 1 | ✅ | 80.8M | ✅ | 92.0M | +14% |
| maxItems.json | maxItems validation | 4 | ✅ | 80.9M | ✅ | 19.7M | 🟢 **-76%** |
| maxLength.json | maxLength validation | 5 | ✅ | 62.5M | ✅ | 21.3M | 🟢 **-66%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 58.3M | ✅ | 24.2M | 🟢 **-59%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 50.9M | ✅ | 9.8M | 🟢 **-81%** |
| maximum.json | maximum validation | 4 | ✅ | 76.9M | ✅ | 18.5M | 🟢 **-76%** |
...
| minItems.json | minItems validation | 4 | ✅ | 76.1M | ✅ | 19.8M | 🟢 **-74%** |
| minLength.json | minLength validation | 5 | ✅ | 57.8M | ✅ | 12.4M | 🟢 **-79%** |
| minProperties.json | minProperties validation | 6 | ✅ | 59.7M | ✅ | 24.0M | 🟢 **-60%** |
| minimum.json | minimum validation | 4 | ✅ | 77.0M | ✅ | 18.2M | 🟢 **-76%** |
| minimum.json | minimum validation (explicit false ex... | 4 | ✅ | 77.0M | ✅ | 15.9M | 🟢 **-79%** |
| minimum.json | exclusiveMinimum validation | 2 | ✅ | 70.4M | ❌ | - | - |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 72.3M | ✅ | 17.2M | 🟢 **-76%** |
| multipleOf.json | by int | 3 | ✅ | 66.1M | ✅ | 12.8M | 🟢 **-81%** |
| multipleOf.json | by number | 3 | ✅ | 58.6M | ✅ | 14.2M | 🟢 **-76%** |
| multipleOf.json | by small number | 2 | ✅ | 66.8M | ✅ | 9.9M | 🟢 **-85%** |
| multipleOf.json | float division = inf | 1 | ✅ | 57.8M | ✅ | 5.3M | 🟢 **-91%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 75.3M | ✅ | 20.4M | 🟢 **-73%** |
| not.json | not | 2 | ✅ | 77.0M | ✅ | 6.8M | 🟢 **-91%** |
| not.json | not multiple types | 3 | ✅ | 71.2M | ✅ | 6.9M | 🟢 **-90%** |
| not.json | not more complex schema | 3 | ✅ | 68.3M | ✅ | 2.6M | 🟢 **-96%** |
| not.json | forbidden property | 2 | ✅ | 53.2M | ✅ | 2.8M | 🟢 **-95%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 60.0M | ✅ | 6.9M | 🟢 **-88%** |
| not.json | double negation | 1 | ✅ | 157.2M | ✅ | 6.8M | 🟢 **-96%** |
| oneOf.json | oneOf | 4 | ✅ | 67.1M | ✅ | 4.0M | 🟢 **-94%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 37.1M | ✅ | 5.6M | 🟢 **-85%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 41.8M | ✅ | 1.1M | 🟢 **-97%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 76.0M | ✅ | 6.2M | 🟢 **-92%** |
| oneOf.json | oneOf with required | 4 | ✅ | 47.5M | ✅ | 1.3M | 🟢 **-97%** |
...
| pattern.json | pattern validation | 8 | ✅ | 55.2M | ✅ | 28.6M | 🟢 **-48%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 24.1M | ✅ | 31.7M | 🔴 **+31%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 27.3M | ✅ | 9.3M | 🟢 **-66%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 14.0M | ✅ | 4.9M | 🟢 **-65%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 16.3M | ✅ | 5.1M | 🟢 **-69%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 18.1M | ✅ | 22.5M | 🔴 **+24%** |
| properties.json | object properties validation | 6 | ✅ | 56.3M | ✅ | 2.0M | 🟢 **-97%** |
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 19.1M | ✅ | 1.7M | 🟢 **-91%** |
| properties.json | properties with escaped characters | 2 | ✅ | 48.9M | ✅ | 408K | 🟢 **-99%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 70.2M | ✅ | 3.5M | 🟢 **-95%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 27.9M | ✅ | 896K | 🟢 **-97%** |
| ref.json | root pointer ref | 4 | ✅ | 25.8M | ✅ | 1.6M | 🟢 **-94%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 52.3M | ✅ | 1.6M | 🟢 **-97%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 59.4M | ✅ | 6.3M | 🟢 **-89%** |
| ref.json | escaped pointer ref | 6 | ✅ | 47.5M | ✅ | 1.2M | 🟢 **-97%** |
| ref.json | nested refs | 2 | ✅ | 39.7M | ✅ | 2.9M | 🟢 **-93%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 57.6M | ✅ | 2.4M | 🟢 **-96%** |
...
| ref.json | Recursive references between schemas | 2 | ✅ | 11.3M | ✅ | 134K | 🟢 **-99%** |
...
| ref.json | naive replacement of $ref with its de... | 2 | ✅ | 56.7M | ✅ | 2.3M | 🟢 **-96%** |
...
| required.json | required validation | 5 | ✅ | 64.7M | ✅ | 8.6M | 🟢 **-87%** |
| required.json | required default validation | 1 | ✅ | 159.3M | ✅ | 44.4M | 🟢 **-72%** |
| required.json | required with escaped characters | 2 | ✅ | 53.0M | ✅ | 1.1M | 🟢 **-98%** |
| required.json | required properties whose names are J... | 7 | ✅ | 26.2M | ✅ | 2.8M | 🟢 **-89%** |
| type.json | integer type matches integers | 8 | ✅ | 64.6M | ✅ | 7.1M | 🟢 **-89%** |
| type.json | number type matches numbers | 9 | ✅ | 68.6M | ✅ | 8.9M | 🟢 **-87%** |
| type.json | string type matches strings | 9 | ✅ | 85.9M | ✅ | 9.1M | 🟢 **-89%** |
| type.json | object type matches objects | 7 | ✅ | 58.6M | ✅ | 6.9M | 🟢 **-88%** |
| type.json | array type matches arrays | 7 | ✅ | 59.8M | ✅ | 7.4M | 🟢 **-88%** |
| type.json | boolean type matches booleans | 10 | ✅ | 86.3M | ✅ | 7.8M | 🟢 **-91%** |
| type.json | null type matches only the null object | 10 | ✅ | 65.7M | ✅ | 7.1M | 🟢 **-89%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 66.3M | ✅ | 8.5M | 🟢 **-87%** |
| type.json | type as array with one item | 2 | ✅ | 76.9M | ✅ | 10.7M | 🟢 **-86%** |
| type.json | type: array or object | 5 | ✅ | 66.3M | ✅ | 9.5M | 🟢 **-86%** |
| type.json | type: array, object or null | 5 | ✅ | 77.4M | ✅ | 13.1M | 🟢 **-83%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 16.8M | ❌ | - | - |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 33.1M | ✅ | 4.9M | 🟢 **-85%** |
...
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 71.4M | ❌ | - | - |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 76.8M | ❌ | - | - |
| optional/bignum.json | integer | 2 | ✅ | 88.5M | ✅ | 12.6M | 🟢 **-86%** |
| optional/bignum.json | number | 2 | ✅ | 88.7M | ✅ | 41.4M | 🟢 **-53%** |
| optional/bignum.json | string | 1 | ✅ | 62.9M | ✅ | 6.2M | 🟢 **-90%** |
...
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 78.9M | ✅ | 41.7M | 🟢 **-47%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 60.0M | ✅ | 4.3M | 🟢 **-93%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 63.6M | ✅ | 7.9M | 🟢 **-88%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 29.3M | ✅ | 8.0M | 🟢 **-73%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.4M | ✅ | 8.2M | 🟢 **-72%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.4M | ✅ | 7.8M | 🟢 **-73%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 29.2M | ✅ | 6.5M | 🟢 **-78%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 26.4M | ✅ | 10.2M | 🟢 **-61%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 29.7M | ✅ | 8.0M | 🟢 **-73%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 27.9M | ✅ | 8.2M | 🟢 **-71%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 27.2M | ✅ | 13.8M | 🟢 **-49%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 31.9M | ✅ | 5.5M | 🟢 **-83%** |
...
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 14.9M | ✅ | 5.5M | 🟢 **-63%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 20.8M | ✅ | 4.9M | 🟢 **-76%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 21.1M | ✅ | 5.3M | 🟢 **-75%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 8.1M | ✅ | 3.9M | 🟢 **-51%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 96.1M | ✅ | 46.0M | 🟢 **-52%** |
...
| File | Group | Tests | tjs | tjs ops/s | djv | djv ops/s | Diff |
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 7.3M | ✅ | 7.2M | -1% |
| additionalItems.json | when items is schema, additionalItems... | 2 | ✅ | 37.7M | ✅ | 6.8M | 🟢 **-82%** |
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 159.4M | ✅ | 92.1M | 🟢 **-42%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 38.0M | ✅ | 19.3M | 🟢 **-49%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 170.8M | ✅ | 123.2M | 🟢 **-28%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 76.9M | ✅ | 92.4M | 🔴 **+20%** |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 54.7M | ✅ | 3.6M | 🟢 **-93%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 40.5M | ✅ | 7.0M | 🟢 **-83%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 107.8M | ✅ | 9.5M | 🟢 **-91%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 159.1M | ✅ | 103.9M | 🟢 **-35%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 59.3M | ✅ | 15.3M | 🟢 **-74%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 16.3M | ✅ | 7.4M | 🟢 **-54%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 43.0M | ✅ | 8.8M | 🟢 **-80%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 32.6M | ✅ | 7.2M | 🟢 **-78%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.3M | ✅ | 103.6M | 🟢 **-35%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 25.6M | ✅ | 3.6M | 🟢 **-86%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 68.4M | ✅ | 61.7M | -10% |
| allOf.json | allOf | 4 | ✅ | 38.7M | ✅ | 1.5M | 🟢 **-96%** |
| allOf.json | allOf with base schema | 5 | ✅ | 22.0M | ✅ | 1.6M | 🟢 **-93%** |
| allOf.json | allOf simple types | 2 | ✅ | 69.7M | ✅ | 7.0M | 🟢 **-90%** |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 159.5M | ✅ | 108.5M | 🟢 **-32%** |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 63.4M | ✅ | 3.9M | 🟢 **-94%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.1M | ✅ | 3.9M | 🟢 **-96%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 159.0M | ✅ | 106.6M | 🟢 **-33%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.6M | ✅ | 103.7M | 🟢 **-35%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 73.2M | ✅ | 7.0M | 🟢 **-90%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.8M | ✅ | 7.4M | 🟢 **-94%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 74.8M | ✅ | 4.7M | 🟢 **-94%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 134.0M | ✅ | 3.6M | 🟢 **-97%** |
| anyOf.json | anyOf | 4 | ✅ | 75.9M | ✅ | 6.8M | 🟢 **-91%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 50.3M | ✅ | 3.8M | 🟢 **-92%** |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 159.5M | ✅ | 113.3M | 🟢 **-29%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 159.0M | ✅ | 104.4M | 🟢 **-34%** |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 63.4M | ✅ | 2.6M | 🟢 **-96%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 73.1M | ✅ | 1.6M | 🟢 **-98%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 171.9M | ✅ | 13.8M | 🟢 **-92%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 119.9M | ✅ | 5.1M | 🟢 **-96%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 182.2M | ✅ | 113.1M | 🟢 **-38%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 90.8M | ✅ | 7.0M | 🟢 **-92%** |
| const.json | const validation | 3 | ✅ | 64.2M | ✅ | 7.5M | 🟢 **-88%** |
| const.json | const with object | 4 | ✅ | 50.0M | ✅ | 1.7M | 🟢 **-97%** |
| const.json | const with array | 3 | ✅ | 56.4M | ✅ | 2.8M | 🟢 **-95%** |
...
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 69.3M | ✅ | 5.5M | 🟢 **-92%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 110.7M | ✅ | 3.2M | 🟢 **-97%** |
...
| contains.json | contains keyword validation | 6 | ✅ | 99.3M | ✅ | 3.3M | 🟢 **-97%** |
| contains.json | contains keyword with const keyword | 3 | ✅ | 59.4M | ✅ | 1.9M | 🟢 **-97%** |
| contains.json | contains keyword with boolean schema ... | 2 | ✅ | 105.7M | ✅ | 12.0M | 🟢 **-89%** |
| contains.json | contains keyword with boolean schema ... | 3 | ✅ | 68.8M | ✅ | 6.6M | 🟢 **-90%** |
| contains.json | items + contains | 4 | ✅ | 50.7M | ❌ | - | - |
| contains.json | contains with null instance elements | 1 | ✅ | 73.6M | ✅ | 93.2M | 🔴 **+27%** |
| default.json | invalid type for default | 2 | ✅ | 107.3M | ✅ | 3.7M | 🟢 **-97%** |
| default.json | invalid string value for default | 2 | ✅ | 53.2M | ✅ | 3.0M | 🟢 **-94%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 76.3M | ✅ | 1.9M | 🟢 **-97%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 11.5M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 91.7M | ✅ | 4.8M | 🟢 **-95%** |
| dependencies.json | dependencies with empty array | 3 | ✅ | 175.8M | ✅ | 7.9M | 🟢 **-95%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 39.9M | ✅ | 2.7M | 🟢 **-93%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 46.2M | ✅ | 1.5M | 🟢 **-97%** |
| dependencies.json | dependencies with boolean subschemas | 4 | ✅ | 87.0M | ✅ | 3.0M | 🟢 **-97%** |
| dependencies.json | dependencies with escaped characters | 7 | ✅ | 11.4M | ✅ | 1.2M | 🟢 **-90%** |
...
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 71.4M | ✅ | 4.9M | 🟢 **-93%** |
| enum.json | enums in properties | 6 | ✅ | 15.9M | ✅ | 1.7M | 🟢 **-89%** |
| enum.json | enum with escaped characters | 3 | ✅ | 76.5M | ✅ | 4.1M | 🟢 **-95%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 112.8M | ❌ | - | - |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 63.6M | ✅ | 3.2M | 🟢 **-95%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 112.0M | ❌ | - | - |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 62.1M | ✅ | 3.2M | 🟢 **-95%** |
| enum.json | enum with 0 does not match false | 3 | ✅ | 114.4M | ❌ | - | - |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 65.9M | ✅ | 4.0M | 🟢 **-94%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 111.8M | ❌ | - | - |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 65.0M | ✅ | 4.1M | 🟢 **-94%** |
| enum.json | nul characters in strings | 2 | ✅ | 91.3M | ✅ | 4.6M | 🟢 **-95%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 68.1M | ✅ | 9.5M | 🟢 **-86%** |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 108.8M | ✅ | 9.5M | 🟢 **-91%** |
...
| items.json | a schema given for items | 4 | ✅ | 52.6M | ✅ | 13.0M | 🟢 **-75%** |
| items.json | an array of schemas for items | 6 | ✅ | 106.0M | ✅ | 28.7M | 🟢 **-73%** |
| items.json | items with boolean schema (true) | 2 | ✅ | 171.7M | ✅ | 98.5M | 🟢 **-43%** |
| items.json | items with boolean schema (false) | 2 | ✅ | 104.4M | ✅ | 7.0M | 🟢 **-93%** |
| items.json | items with boolean schemas | 3 | ✅ | 62.1M | ✅ | 16.6M | 🟢 **-73%** |
| items.json | items and subitems | 6 | ✅ | 28.5M | ✅ | 2.3M | 🟢 **-92%** |
| items.json | nested items | 3 | ✅ | 12.2M | ✅ | 3.5M | 🟢 **-71%** |
| items.json | single-form items with null instance ... | 1 | ✅ | 72.0M | ✅ | 94.4M | 🔴 **+31%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 77.0M | ✅ | 100.3M | 🔴 **+30%** |
| maxItems.json | maxItems validation | 4 | ✅ | 75.0M | ✅ | 21.8M | 🟢 **-71%** |
| maxItems.json | maxItems validation with a decimal | 2 | ✅ | 69.5M | ✅ | 11.6M | 🟢 **-83%** |
| maxLength.json | maxLength validation | 5 | ✅ | 60.1M | ✅ | 21.9M | 🟢 **-64%** |
| maxLength.json | maxLength validation with a decimal | 2 | ✅ | 56.5M | ✅ | 11.2M | 🟢 **-80%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 56.2M | ✅ | 24.6M | 🟢 **-56%** |
| maxProperties.json | maxProperties validation with a decimal | 2 | ✅ | 48.3M | ✅ | 10.4M | 🟢 **-78%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 49.4M | ✅ | 10.5M | 🟢 **-79%** |
| maximum.json | maximum validation | 4 | ✅ | 73.3M | ✅ | 20.5M | 🟢 **-72%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 66.0M | ✅ | 20.5M | 🟢 **-69%** |
| minItems.json | minItems validation | 4 | ✅ | 81.7M | ✅ | 20.2M | 🟢 **-75%** |
| minItems.json | minItems validation with a decimal | 2 | ✅ | 69.5M | ✅ | 11.6M | 🟢 **-83%** |
| minLength.json | minLength validation | 5 | ✅ | 55.5M | ✅ | 12.8M | 🟢 **-77%** |
| minLength.json | minLength validation with a decimal | 2 | ✅ | 56.8M | ✅ | 11.0M | 🟢 **-81%** |
| minProperties.json | minProperties validation | 6 | ✅ | 57.3M | ✅ | 26.4M | 🟢 **-54%** |
| minProperties.json | minProperties validation with a decimal | 2 | ✅ | 49.2M | ✅ | 10.6M | 🟢 **-79%** |
| minimum.json | minimum validation | 4 | ✅ | 73.4M | ✅ | 19.0M | 🟢 **-74%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 69.1M | ✅ | 18.4M | 🟢 **-73%** |
| multipleOf.json | by int | 3 | ✅ | 74.1M | ✅ | 14.0M | 🟢 **-81%** |
| multipleOf.json | by number | 3 | ✅ | 70.1M | ✅ | 15.3M | 🟢 **-78%** |
| multipleOf.json | by small number | 2 | ✅ | 64.1M | ✅ | 10.6M | 🟢 **-83%** |
| multipleOf.json | float division = inf | 1 | ✅ | 55.8M | ✅ | 5.8M | 🟢 **-90%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 71.9M | ✅ | 19.9M | 🟢 **-72%** |
| not.json | not | 2 | ✅ | 73.4M | ✅ | 6.9M | 🟢 **-91%** |
| not.json | not multiple types | 3 | ✅ | 53.8M | ✅ | 7.0M | 🟢 **-87%** |
| not.json | not more complex schema | 3 | ✅ | 65.6M | ✅ | 2.8M | 🟢 **-96%** |
| not.json | forbidden property | 2 | ✅ | 45.0M | ✅ | 3.0M | 🟢 **-93%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 61.3M | ✅ | 7.5M | 🟢 **-88%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 61.3M | ✅ | 7.5M | 🟢 **-88%** |
| not.json | allow everything with boolean schema ... | 9 | ✅ | 179.9M | ✅ | 7.6M | 🟢 **-96%** |
| not.json | double negation | 1 | ✅ | 159.5M | ✅ | 7.0M | 🟢 **-96%** |
| oneOf.json | oneOf | 4 | ✅ | 53.8M | ✅ | 4.1M | 🟢 **-92%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 40.6M | ✅ | 5.9M | 🟢 **-85%** |
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 63.4M | ✅ | 6.4M | 🟢 **-90%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 85.0M | ✅ | 3.5M | 🟢 **-96%** |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 63.4M | ✅ | 3.4M | 🟢 **-95%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 63.4M | ✅ | 1.8M | 🟢 **-97%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 43.8M | ✅ | 1.2M | 🟢 **-97%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 72.5M | ✅ | 6.5M | 🟢 **-91%** |
| oneOf.json | oneOf with required | 4 | ✅ | 46.4M | ✅ | 1.3M | 🟢 **-97%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 47.9M | ✅ | 1.7M | 🟢 **-96%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 72.6M | ✅ | 4.6M | 🟢 **-94%** |
| pattern.json | pattern validation | 8 | ✅ | 54.4M | ✅ | 28.6M | 🟢 **-47%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 14.4M | ✅ | 31.8M | 🔴 **+121%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 26.9M | ✅ | 9.7M | 🟢 **-64%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 15.0M | ✅ | 5.3M | 🟢 **-64%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 14.4M | ✅ | 5.5M | 🟢 **-62%** |
| patternProperties.json | patternProperties with boolean schemas | 5 | ✅ | 19.6M | ✅ | 4.8M | 🟢 **-76%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 17.9M | ✅ | 23.5M | 🔴 **+31%** |
| properties.json | object properties validation | 6 | ✅ | 53.1M | ✅ | 2.1M | 🟢 **-96%** |
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 19.8M | ✅ | 1.8M | 🟢 **-91%** |
| properties.json | properties with boolean schema | 4 | ✅ | 48.1M | ✅ | 2.2M | 🟢 **-95%** |
| properties.json | properties with escaped characters | 2 | ✅ | 49.9M | ✅ | 429K | 🟢 **-99%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 67.1M | ✅ | 3.5M | 🟢 **-95%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 27.7M | ✅ | 957K | 🟢 **-97%** |
| propertyNames.json | propertyNames validation | 6 | ✅ | 42.8M | ✅ | 6.0M | 🟢 **-86%** |
| propertyNames.json | propertyNames validation with pattern | 3 | ✅ | 19.2M | ✅ | 6.2M | 🟢 **-68%** |
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 171.8M | ✅ | 65.8M | 🟢 **-62%** |
| propertyNames.json | propertyNames with boolean schema false | 2 | ✅ | 49.6M | ✅ | 6.4M | 🟢 **-87%** |
| propertyNames.json | propertyNames with const | 3 | ✅ | 38.6M | ✅ | 5.5M | 🟢 **-86%** |
| propertyNames.json | propertyNames with enum | 4 | ✅ | 41.1M | ✅ | 4.5M | 🟢 **-89%** |
| ref.json | root pointer ref | 4 | ✅ | 25.4M | ✅ | 1.7M | 🟢 **-93%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 50.8M | ✅ | 1.7M | 🟢 **-97%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 56.9M | ✅ | 6.8M | 🟢 **-88%** |
| ref.json | escaped pointer ref | 6 | ✅ | 46.1M | ✅ | 1.3M | 🟢 **-97%** |
| ref.json | nested refs | 2 | ✅ | 37.1M | ✅ | 2.9M | 🟢 **-92%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 55.1M | ✅ | 2.5M | 🟢 **-95%** |
| ref.json | $ref prevents a sibling $id from chan... | 2 | ✅ | 49.7M | ❌ | - | - |
| ref.json | remote ref, containing refs itself | 2 | ✅ | 24.3M | ❌ | - | - |
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 52.4M | ✅ | 2.5M | 🟢 **-95%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 50.6M | ✅ | 2.2M | 🟢 **-96%** |
| ref.json | $ref to boolean schema true | 1 | ✅ | 159.3M | ✅ | 112.2M | 🟢 **-30%** |
| ref.json | $ref to boolean schema false | 1 | ✅ | 63.4M | ✅ | 2.7M | 🟢 **-96%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.4M | ✅ | 142K | 🟢 **-98%** |
| ref.json | refs with quote | 2 | ✅ | 52.6M | ✅ | 1.8M | 🟢 **-96%** |
...
| ref.json | simple URN base URI with $ref via the... | 2 | ✅ | 40.8M | ✅ | 1.7M | 🟢 **-96%** |
| ref.json | simple URN base URI with JSON pointer | 2 | ✅ | 52.8M | ✅ | 2.2M | 🟢 **-96%** |
| ref.json | URN base URI with NSS | 2 | ✅ | 50.7M | ✅ | 2.2M | 🟢 **-96%** |
| ref.json | URN base URI with r-component | 2 | ✅ | 50.7M | ✅ | 2.2M | 🟢 **-96%** |
| ref.json | URN base URI with q-component | 2 | ✅ | 50.8M | ✅ | 2.2M | 🟢 **-96%** |
| ref.json | URN base URI with URN and JSON pointe... | 2 | ✅ | 52.4M | ✅ | 2.2M | 🟢 **-96%** |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 73.4M | ✅ | 5.0M | 🟢 **-93%** |
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 73.4M | ✅ | 5.1M | 🟢 **-93%** |
...
| required.json | required validation | 5 | ✅ | 62.4M | ✅ | 10.5M | 🟢 **-83%** |
| required.json | required default validation | 1 | ✅ | 159.5M | ✅ | 112.7M | 🟢 **-29%** |
| required.json | required with empty array | 1 | ✅ | 159.5M | ✅ | 95.1M | 🟢 **-40%** |
| required.json | required with escaped characters | 2 | ✅ | 50.1M | ✅ | 1.1M | 🟢 **-98%** |
| required.json | required properties whose names are J... | 7 | ✅ | 27.4M | ✅ | 3.2M | 🟢 **-88%** |
| type.json | integer type matches integers | 9 | ✅ | 62.9M | ✅ | 8.7M | 🟢 **-86%** |
| type.json | number type matches numbers | 9 | ✅ | 66.3M | ✅ | 10.8M | 🟢 **-84%** |
| type.json | string type matches strings | 9 | ✅ | 65.3M | ✅ | 10.2M | 🟢 **-84%** |
| type.json | object type matches objects | 7 | ✅ | 56.7M | ✅ | 8.1M | 🟢 **-86%** |
| type.json | array type matches arrays | 7 | ✅ | 61.3M | ✅ | 8.3M | 🟢 **-86%** |
| type.json | boolean type matches booleans | 10 | ✅ | 63.1M | ✅ | 9.2M | 🟢 **-85%** |
| type.json | null type matches only the null object | 10 | ✅ | 62.0M | ✅ | 8.2M | 🟢 **-87%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 62.8M | ✅ | 9.3M | 🟢 **-85%** |
| type.json | type as array with one item | 2 | ✅ | 73.2M | ✅ | 14.1M | 🟢 **-81%** |
| type.json | type: array or object | 5 | ✅ | 68.6M | ✅ | 11.8M | 🟢 **-83%** |
| type.json | type: array, object or null | 5 | ✅ | 73.0M | ✅ | 16.8M | 🟢 **-77%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 16.6M | ❌ | - | - |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 32.8M | ✅ | 5.5M | 🟢 **-83%** |
| uniqueItems.json | uniqueItems with an array of items an... | 5 | ✅ | 18.3M | ✅ | 5.9M | 🟢 **-68%** |
...
| optional/bignum.json | number | 2 | ✅ | 84.1M | ✅ | 85.2M | +1% |
| optional/bignum.json | string | 1 | ✅ | 60.7M | ✅ | 7.4M | 🟢 **-88%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 75.2M | ✅ | 95.9M | 🔴 **+28%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 57.8M | ✅ | 5.2M | 🟢 **-91%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 75.2M | ✅ | 96.5M | 🔴 **+28%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 57.8M | ✅ | 5.2M | 🟢 **-91%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 69.6M | ✅ | 9.8M | 🟢 **-86%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 28.9M | ✅ | 9.8M | 🟢 **-66%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 28.8M | ✅ | 9.8M | 🟢 **-66%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 28.9M | ✅ | 9.8M | 🟢 **-66%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 29.4M | ✅ | 7.9M | 🟢 **-73%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 27.0M | ✅ | 12.8M | 🟢 **-52%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 29.1M | ✅ | 9.9M | 🟢 **-66%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 28.9M | ✅ | 9.5M | 🟢 **-67%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.7M | ✅ | 16.6M | 🟢 **-38%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 31.4M | ✅ | 6.6M | 🟢 **-79%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 17.0M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 14.9M | ✅ | 6.0M | 🟢 **-59%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 15.5M | ✅ | 6.1M | 🟢 **-60%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 28.9M | ✅ | 7.7M | 🟢 **-73%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 18.5M | ✅ | 5.5M | 🟢 **-70%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 19.2M | ✅ | 6.1M | 🟢 **-68%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 8.4M | ✅ | 4.5M | 🟢 **-46%** |
| optional/ecmascript-regex.json | patternProperties with non-ASCII digits | 3 | ✅ | 8.7M | ❌ | - | - |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 83.3M | ✅ | 119.3M | 🔴 **+43%** |
...
| optional/id.json | non-schema object containing a plain-... | 2 | ✅ | 46.3M | ✅ | 876K | 🟢 **-98%** |
| optional/id.json | non-schema object containing an $id p... | 2 | ✅ | 45.9M | ✅ | 885K | 🟢 **-98%** |
...
| File | Group | Tests | tjs | tjs ops/s | djv | djv ops/s | Diff |
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 25.9M | ✅ | 7.2M | 🟢 **-72%** |
| additionalItems.json | when items is schema, additionalItems... | 2 | ✅ | 37.2M | ✅ | 6.8M | 🟢 **-82%** |
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 159.4M | ✅ | 86.0M | 🟢 **-46%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 36.8M | ✅ | 19.4M | 🟢 **-47%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 161.3M | ✅ | 112.1M | 🟢 **-31%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 80.8M | ✅ | 87.6M | +8% |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 56.1M | ✅ | 3.6M | 🟢 **-94%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 42.7M | ✅ | 6.7M | 🟢 **-84%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 107.8M | ✅ | 9.3M | 🟢 **-91%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 159.5M | ✅ | 100.7M | 🟢 **-37%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 42.1M | ✅ | 14.1M | 🟢 **-66%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 16.5M | ✅ | 7.3M | 🟢 **-56%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 43.7M | ✅ | 8.0M | 🟢 **-82%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 33.1M | ✅ | 6.7M | 🟢 **-80%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.5M | ✅ | 102.6M | 🟢 **-36%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 13.8M | ✅ | 3.5M | 🟢 **-74%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 35.0M | ✅ | 61.3M | 🔴 **+75%** |
| allOf.json | allOf | 4 | ✅ | 40.6M | ✅ | 1.4M | 🟢 **-96%** |
| allOf.json | allOf with base schema | 5 | ✅ | 30.5M | ✅ | 1.5M | 🟢 **-95%** |
| allOf.json | allOf simple types | 2 | ✅ | 59.4M | ✅ | 6.4M | 🟢 **-89%** |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 159.6M | ✅ | 101.6M | 🟢 **-36%** |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 65.6M | ✅ | 3.5M | 🟢 **-95%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 3.7M | 🟢 **-96%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 159.0M | ✅ | 102.8M | 🟢 **-35%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.4M | ✅ | 101.0M | 🟢 **-37%** |
...
| anyOf.json | anyOf with base schema | 3 | ✅ | 50.6M | ✅ | 3.7M | 🟢 **-93%** |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 159.4M | ✅ | 100.8M | 🟢 **-37%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 159.0M | ✅ | 100.0M | 🟢 **-37%** |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 2.5M | 🟢 **-96%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 72.5M | ✅ | 1.5M | 🟢 **-98%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 171.6M | ✅ | 12.6M | 🟢 **-93%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 119.9M | ✅ | 4.7M | 🟢 **-96%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 179.1M | ✅ | 105.6M | 🟢 **-41%** |
...
| const.json | const with array | 3 | ✅ | 58.5M | ✅ | 2.6M | 🟢 **-95%** |
| const.json | const with null | 2 | ✅ | 118.8M | ✅ | 4.0M | 🟢 **-97%** |
...
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 71.1M | ✅ | 5.3M | 🟢 **-93%** |
...
| contains.json | contains keyword validation | 6 | ✅ | 99.4M | ✅ | 3.2M | 🟢 **-97%** |
| contains.json | contains keyword with const keyword | 3 | ✅ | 69.0M | ✅ | 1.7M | 🟢 **-97%** |
...
| contains.json | contains with false if subschema | 2 | ✅ | 68.8M | ✅ | 11.1M | 🟢 **-84%** |
| contains.json | contains with null instance elements | 1 | ✅ | 124.3M | ✅ | 51.2M | 🟢 **-59%** |
| default.json | invalid type for default | 2 | ✅ | 71.4M | ✅ | 3.4M | 🟢 **-95%** |
| default.json | invalid string value for default | 2 | ✅ | 74.5M | ✅ | 2.8M | 🟢 **-96%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 57.3M | ✅ | 1.8M | 🟢 **-97%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 12.3M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 65.1M | ✅ | 4.5M | 🟢 **-93%** |
| dependencies.json | dependencies with empty array | 3 | ✅ | 176.1M | ✅ | 7.2M | 🟢 **-96%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 34.3M | ✅ | 2.5M | 🟢 **-93%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 46.7M | ✅ | 1.4M | 🟢 **-97%** |
| dependencies.json | dependencies with boolean subschemas | 4 | ✅ | 61.3M | ✅ | 2.8M | 🟢 **-96%** |
...
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 68.2M | ✅ | 3.9M | 🟢 **-94%** |
| enum.json | nul characters in strings | 2 | ✅ | 64.8M | ✅ | 4.3M | 🟢 **-93%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 71.1M | ✅ | 8.7M | 🟢 **-88%** |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 70.9M | ✅ | 8.6M | 🟢 **-88%** |
| format.json | email format | 6 | ✅ | 92.1M | ❌ | - | - |
| format.json | idn-email format | 6 | ✅ | 92.5M | ✅ | 113.6M | 🔴 **+23%** |
| format.json | regex format | 6 | ✅ | 92.5M | ✅ | 22.7M | 🟢 **-75%** |
| format.json | ipv4 format | 6 | ✅ | 92.6M | ❌ | - | - |
| format.json | ipv6 format | 6 | ✅ | 92.8M | ❌ | - | - |
| format.json | idn-hostname format | 6 | ✅ | 93.2M | ✅ | 117.5M | 🔴 **+26%** |
| format.json | hostname format | 6 | ✅ | 92.6M | ❌ | - | - |
| format.json | date format | 6 | ✅ | 92.5M | ✅ | 101.0M | +9% |
| format.json | date-time format | 6 | ✅ | 92.7M | ❌ | - | - |
| format.json | time format | 6 | ✅ | 92.6M | ✅ | 108.8M | +17% |
| format.json | json-pointer format | 6 | ✅ | 92.4M | ❌ | - | - |
| format.json | relative-json-pointer format | 6 | ✅ | 92.5M | ✅ | 102.9M | +11% |
| format.json | iri format | 6 | ✅ | 92.7M | ✅ | 118.5M | 🔴 **+28%** |
| format.json | iri-reference format | 6 | ✅ | 92.6M | ✅ | 103.7M | +12% |
| format.json | uri format | 6 | ✅ | 91.9M | ❌ | - | - |
| format.json | uri-reference format | 6 | ✅ | 92.4M | ❌ | - | - |
| format.json | uri-template format | 6 | ✅ | 92.9M | ❌ | - | - |
| if-then-else.json | ignore if without then or else | 2 | ✅ | 166.8M | ✅ | 110.9M | 🟢 **-34%** |
| if-then-else.json | ignore then without if | 2 | ✅ | 171.1M | ✅ | 112.6M | 🟢 **-34%** |
| if-then-else.json | ignore else without if | 2 | ✅ | 171.7M | ✅ | 112.4M | 🟢 **-35%** |
...
| if-then-else.json | non-interference across combined schemas | 2 | ✅ | 171.3M | ✅ | 112.5M | 🟢 **-34%** |
...
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 39.9M | ✅ | 1.7M | 🟢 **-96%** |
| items.json | a schema given for items | 4 | ✅ | 54.4M | ✅ | 13.0M | 🟢 **-76%** |
| items.json | an array of schemas for items | 6 | ✅ | 67.5M | ✅ | 27.1M | 🟢 **-60%** |
| items.json | items with boolean schema (true) | 2 | ✅ | 171.5M | ✅ | 100.2M | 🟢 **-42%** |
| items.json | items with boolean schema (false) | 2 | ✅ | 71.5M | ✅ | 7.0M | 🟢 **-90%** |
| items.json | items with boolean schemas | 3 | ✅ | 65.6M | ✅ | 15.8M | 🟢 **-76%** |
| items.json | items and subitems | 6 | ✅ | 27.7M | ✅ | 2.1M | 🟢 **-92%** |
| items.json | nested items | 3 | ✅ | 11.9M | ✅ | 3.3M | 🟢 **-72%** |
| items.json | single-form items with null instance ... | 1 | ✅ | 60.9M | ✅ | 88.3M | 🔴 **+45%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 80.8M | ✅ | 93.1M | +15% |
| maxItems.json | maxItems validation | 4 | ✅ | 80.6M | ✅ | 19.8M | 🟢 **-75%** |
| maxItems.json | maxItems validation with a decimal | 2 | ✅ | 72.6M | ✅ | 11.2M | 🟢 **-85%** |
| maxLength.json | maxLength validation | 5 | ✅ | 61.4M | ✅ | 21.3M | 🟢 **-65%** |
| maxLength.json | maxLength validation with a decimal | 2 | ✅ | 54.4M | ✅ | 10.4M | 🟢 **-81%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 57.4M | ✅ | 24.2M | 🟢 **-58%** |
| maxProperties.json | maxProperties validation with a decimal | 2 | ✅ | 48.9M | ✅ | 9.9M | 🟢 **-80%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 50.3M | ✅ | 10.0M | 🟢 **-80%** |
| maximum.json | maximum validation | 4 | ✅ | 76.9M | ✅ | 18.7M | 🟢 **-76%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 75.1M | ✅ | 20.5M | 🟢 **-73%** |
| minItems.json | minItems validation | 4 | ✅ | 78.5M | ✅ | 20.1M | 🟢 **-74%** |
| minItems.json | minItems validation with a decimal | 2 | ✅ | 69.1M | ✅ | 10.3M | 🟢 **-85%** |
| minLength.json | minLength validation | 5 | ✅ | 57.4M | ✅ | 12.4M | 🟢 **-78%** |
| minLength.json | minLength validation with a decimal | 2 | ✅ | 58.9M | ✅ | 10.3M | 🟢 **-83%** |
| minProperties.json | minProperties validation | 6 | ✅ | 59.5M | ✅ | 23.6M | 🟢 **-60%** |
| minProperties.json | minProperties validation with a decimal | 2 | ✅ | 50.5M | ✅ | 9.3M | 🟢 **-82%** |
...
| multipleOf.json | by number | 3 | ✅ | 71.1M | ✅ | 14.4M | 🟢 **-80%** |
...
| not.json | forbid everything with boolean schema... | 9 | ✅ | 65.2M | ✅ | 7.1M | 🟢 **-89%** |
| not.json | allow everything with boolean schema ... | 9 | ✅ | 182.7M | ✅ | 6.3M | 🟢 **-97%** |
| not.json | double negation | 1 | ✅ | 159.4M | ✅ | 6.6M | 🟢 **-96%** |
| oneOf.json | oneOf | 4 | ✅ | 67.1M | ✅ | 3.9M | 🟢 **-94%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 37.2M | ✅ | 5.8M | 🟢 **-85%** |
...
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 1.6M | 🟢 **-98%** |
...
| pattern.json | pattern validation | 8 | ✅ | 55.6M | ✅ | 28.9M | 🟢 **-48%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 14.5M | ✅ | 32.1M | 🔴 **+122%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 27.3M | ✅ | 9.0M | 🟢 **-67%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 15.4M | ✅ | 5.1M | 🟢 **-67%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 16.9M | ✅ | 5.2M | 🟢 **-69%** |
...
| properties.json | object properties validation | 6 | ✅ | 55.5M | ✅ | 2.0M | 🟢 **-96%** |
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 20.0M | ✅ | 1.7M | 🟢 **-92%** |
| properties.json | properties with boolean schema | 4 | ✅ | 49.7M | ✅ | 2.0M | 🟢 **-96%** |
...
| properties.json | properties whose names are Javascript... | 7 | ✅ | 27.8M | ✅ | 903K | 🟢 **-97%** |
| propertyNames.json | propertyNames validation | 6 | ✅ | 46.2M | ✅ | 5.7M | 🟢 **-88%** |
| propertyNames.json | propertyNames validation with pattern | 3 | ✅ | 19.9M | ✅ | 6.3M | 🟢 **-68%** |
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 171.5M | ✅ | 65.8M | 🟢 **-62%** |
| propertyNames.json | propertyNames with boolean schema false | 2 | ✅ | 51.2M | ✅ | 6.2M | 🟢 **-88%** |
| propertyNames.json | propertyNames with const | 3 | ✅ | 40.3M | ✅ | 5.5M | 🟢 **-86%** |
| propertyNames.json | propertyNames with enum | 4 | ✅ | 42.9M | ✅ | 4.2M | 🟢 **-90%** |
| ref.json | root pointer ref | 4 | ✅ | 26.2M | ✅ | 1.5M | 🟢 **-94%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 55.2M | ✅ | 1.6M | 🟢 **-97%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 58.9M | ✅ | 6.4M | 🟢 **-89%** |
| ref.json | escaped pointer ref | 6 | ✅ | 46.0M | ✅ | 1.2M | 🟢 **-97%** |
| ref.json | nested refs | 2 | ✅ | 40.0M | ✅ | 2.9M | 🟢 **-93%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 57.7M | ✅ | 2.3M | 🟢 **-96%** |
| ref.json | $ref prevents a sibling $id from chan... | 2 | ✅ | 53.8M | ❌ | - | - |
| ref.json | remote ref, containing refs itself | 2 | ✅ | 24.2M | ❌ | - | - |
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 55.4M | ✅ | 2.3M | 🟢 **-96%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 55.0M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | $ref to boolean schema true | 1 | ✅ | 158.8M | ✅ | 103.0M | 🟢 **-35%** |
| ref.json | $ref to boolean schema false | 1 | ✅ | 65.3M | ✅ | 2.5M | 🟢 **-96%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.7M | ✅ | 131K | 🟢 **-99%** |
| ref.json | refs with quote | 2 | ✅ | 55.3M | ✅ | 1.7M | 🟢 **-97%** |
...
| ref.json | naive replacement of $ref with its de... | 3 | ✅ | 56.9M | ✅ | 2.2M | 🟢 **-96%** |
...
| ref.json | URN base URI with r-component | 2 | ✅ | 54.8M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with q-component | 2 | ✅ | 53.9M | ✅ | 2.1M | 🟢 **-96%** |
| ref.json | URN base URI with URN and JSON pointe... | 2 | ✅ | 54.4M | ✅ | 2.0M | 🟢 **-96%** |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 75.3M | ✅ | 4.8M | 🟢 **-94%** |
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 77.1M | ✅ | 4.9M | 🟢 **-94%** |
...
| required.json | required default validation | 1 | ✅ | 159.2M | ✅ | 102.6M | 🟢 **-36%** |
| required.json | required with empty array | 1 | ✅ | 159.2M | ✅ | 95.1M | 🟢 **-40%** |
...
| type.json | integer type matches integers | 9 | ✅ | 86.2M | ✅ | 8.7M | 🟢 **-90%** |
...
| optional/bignum.json | integer | 2 | ✅ | 88.5M | ✅ | 15.2M | 🟢 **-83%** |
| optional/bignum.json | number | 2 | ✅ | 88.7M | ✅ | 87.1M | -2% |
| optional/bignum.json | string | 1 | ✅ | 63.5M | ✅ | 6.6M | 🟢 **-90%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 64.7M | ✅ | 9.0M | 🟢 **-86%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 29.4M | ✅ | 9.1M | 🟢 **-69%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.4M | ✅ | 8.7M | 🟢 **-70%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.4M | ✅ | 9.1M | 🟢 **-69%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 29.9M | ✅ | 7.0M | 🟢 **-77%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 27.5M | ✅ | 11.7M | 🟢 **-58%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 29.7M | ✅ | 8.9M | 🟢 **-70%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 29.3M | ✅ | 8.7M | 🟢 **-70%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 27.2M | ✅ | 16.2M | 🟢 **-40%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 32.0M | ✅ | 6.2M | 🟢 **-80%** |
...
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 15.9M | ✅ | 5.7M | 🟢 **-64%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 29.6M | ✅ | 7.1M | 🟢 **-76%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 88.3M | ✅ | 116.9M | 🔴 **+32%** |
...
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 7.3M | ✅ | 7.2M | -1% |
| additionalItems.json | when items is schema, additionalItems... | 2 | ✅ | 35.2M | ✅ | 6.6M | 🟢 **-81%** |
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 159.6M | ✅ | 86.9M | 🟢 **-46%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 80.8M | ✅ | 18.1M | 🟢 **-78%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 170.5M | ✅ | 113.1M | 🟢 **-34%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 80.8M | ✅ | 93.0M | +15% |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 54.9M | ✅ | 3.5M | 🟢 **-94%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 43.1M | ✅ | 6.8M | 🟢 **-84%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 107.8M | ✅ | 9.3M | 🟢 **-91%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 159.7M | ✅ | 103.3M | 🟢 **-35%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 63.9M | ✅ | 14.2M | 🟢 **-78%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 32.1M | ✅ | 7.2M | 🟢 **-78%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 43.0M | ✅ | 8.0M | 🟢 **-81%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 36.6M | ✅ | 6.6M | 🟢 **-82%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.1M | ✅ | 103.9M | 🟢 **-35%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 29.4M | ✅ | 3.5M | 🟢 **-88%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 69.3M | ✅ | 60.7M | -12% |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 29.6M | ✅ | 6.1M | 🟢 **-79%** |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 31.4M | ✅ | 4.3M | 🟢 **-86%** |
| allOf.json | allOf | 4 | ✅ | 40.9M | ✅ | 1.5M | 🟢 **-96%** |
| allOf.json | allOf with base schema | 5 | ✅ | 30.5M | ✅ | 1.5M | 🟢 **-95%** |
| allOf.json | allOf simple types | 2 | ✅ | 72.8M | ✅ | 6.4M | 🟢 **-91%** |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 159.1M | ✅ | 103.1M | 🟢 **-35%** |
...
| allOf.json | allOf with one empty schema | 1 | ✅ | 147.2M | ✅ | 100.6M | 🟢 **-32%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 158.8M | ✅ | 98.8M | 🟢 **-38%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 77.1M | ✅ | 7.0M | 🟢 **-91%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.8M | ✅ | 7.0M | 🟢 **-94%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 78.7M | ✅ | 4.7M | 🟢 **-94%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 84.7M | ✅ | 3.4M | 🟢 **-96%** |
...
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 158.7M | ✅ | 96.2M | 🟢 **-39%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 159.0M | ✅ | 104.1M | 🟢 **-35%** |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 78.4M | ✅ | 2.5M | 🟢 **-97%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 50.9M | ✅ | 1.5M | 🟢 **-97%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 170.0M | ✅ | 12.8M | 🟢 **-92%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 78.7M | ✅ | 4.8M | 🟢 **-94%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 177.2M | ✅ | 118.9M | 🟢 **-33%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 60.8M | ✅ | 7.0M | 🟢 **-89%** |
| const.json | const validation | 3 | ✅ | 67.2M | ✅ | 7.0M | 🟢 **-90%** |
...
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 73.1M | ✅ | 5.4M | 🟢 **-93%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 73.3M | ✅ | 3.1M | 🟢 **-96%** |
| const.json | nul characters in strings | 2 | ✅ | 64.4M | ✅ | 4.3M | 🟢 **-93%** |
...
| contains.json | contains keyword with const keyword | 3 | ✅ | 63.4M | ✅ | 1.8M | 🟢 **-97%** |
| contains.json | contains keyword with boolean schema ... | 2 | ✅ | 71.5M | ✅ | 11.1M | 🟢 **-84%** |
...
| contains.json | contains with null instance elements | 1 | ✅ | 76.6M | ✅ | 93.3M | 🔴 **+22%** |
| content.json | validation of string-encoded content ... | 3 | ✅ | 174.8M | ✅ | 117.1M | 🟢 **-33%** |
| content.json | validation of binary string-encoding | 3 | ✅ | 175.1M | ✅ | 99.8M | 🟢 **-43%** |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 95.5M | ✅ | 117.8M | 🔴 **+23%** |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 181.7M | ✅ | 106.1M | 🟢 **-42%** |
| default.json | invalid type for default | 2 | ✅ | 50.4M | ✅ | 3.6M | 🟢 **-93%** |
| default.json | invalid string value for default | 2 | ✅ | 49.4M | ✅ | 2.9M | 🟢 **-94%** |
...
| dependentRequired.json | empty dependents | 3 | ✅ | 174.8M | ✅ | 116.9M | 🟢 **-33%** |
...
| enum.json | simple enum validation | 2 | ✅ | 69.6M | ✅ | 6.1M | 🟢 **-91%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 47.6M | ✅ | 1.3M | 🟢 **-97%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 71.7M | ✅ | 4.6M | 🟢 **-94%** |
| enum.json | enums in properties | 6 | ✅ | 14.5M | ✅ | 1.6M | 🟢 **-89%** |
| enum.json | enum with escaped characters | 3 | ✅ | 40.8M | ✅ | 3.8M | 🟢 **-91%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 73.2M | ❌ | - | - |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 64.4M | ✅ | 3.0M | 🟢 **-95%** |
...
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 59.8M | ✅ | 3.8M | 🟢 **-94%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 70.6M | ❌ | - | - |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 66.1M | ✅ | 3.8M | 🟢 **-94%** |
| enum.json | nul characters in strings | 2 | ✅ | 64.4M | ✅ | 4.3M | 🟢 **-93%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 64.9M | ✅ | 8.9M | 🟢 **-86%** |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 62.3M | ✅ | 9.0M | 🟢 **-86%** |
| format.json | email format | 6 | ✅ | 144.9M | ❌ | - | - |
| format.json | idn-email format | 6 | ✅ | 179.1M | ✅ | 120.4M | 🟢 **-33%** |
| format.json | regex format | 6 | ✅ | 180.5M | ✅ | 22.0M | 🟢 **-88%** |
| format.json | ipv4 format | 6 | ✅ | 179.5M | ❌ | - | - |
| format.json | ipv6 format | 6 | ✅ | 179.5M | ❌ | - | - |
| format.json | idn-hostname format | 6 | ✅ | 180.5M | ✅ | 114.1M | 🟢 **-37%** |
| format.json | hostname format | 6 | ✅ | 180.5M | ❌ | - | - |
| format.json | date format | 6 | ✅ | 176.7M | ✅ | 104.1M | 🟢 **-41%** |
| format.json | date-time format | 6 | ✅ | 170.5M | ❌ | - | - |
| format.json | time format | 6 | ✅ | 179.4M | ✅ | 109.4M | 🟢 **-39%** |
| format.json | json-pointer format | 6 | ✅ | 180.8M | ❌ | - | - |
| format.json | relative-json-pointer format | 6 | ✅ | 180.9M | ✅ | 103.5M | 🟢 **-43%** |
| format.json | iri format | 6 | ✅ | 173.6M | ✅ | 120.7M | 🟢 **-30%** |
| format.json | iri-reference format | 6 | ✅ | 179.0M | ✅ | 104.4M | 🟢 **-42%** |
| format.json | uri format | 6 | ✅ | 180.6M | ❌ | - | - |
| format.json | uri-reference format | 6 | ✅ | 172.1M | ❌ | - | - |
| format.json | uri-template format | 6 | ✅ | 180.6M | ❌ | - | - |
| format.json | uuid format | 6 | ✅ | 179.4M | ✅ | 119.3M | 🟢 **-34%** |
| format.json | duration format | 6 | ✅ | 179.9M | ✅ | 118.8M | 🟢 **-34%** |
| if-then-else.json | ignore if without then or else | 2 | ✅ | 170.0M | ✅ | 112.7M | 🟢 **-34%** |
| if-then-else.json | ignore then without if | 2 | ✅ | 170.3M | ✅ | 114.3M | 🟢 **-33%** |
| if-then-else.json | ignore else without if | 2 | ✅ | 170.2M | ✅ | 114.2M | 🟢 **-33%** |
| if-then-else.json | if and then without else | 3 | ✅ | 77.7M | ❌ | - | - |
| if-then-else.json | if and else without then | 3 | ✅ | 76.5M | ❌ | - | - |
| if-then-else.json | validate against correct branch, then... | 4 | ✅ | 71.8M | ❌ | - | - |
| if-then-else.json | non-interference across combined schemas | 2 | ✅ | 170.5M | ✅ | 114.1M | 🟢 **-33%** |
...
| items.json | a schema given for items | 4 | ✅ | 53.3M | ✅ | 12.9M | 🟢 **-76%** |
| items.json | an array of schemas for items | 6 | ✅ | 68.2M | ✅ | 27.6M | 🟢 **-59%** |
| items.json | items with boolean schema (true) | 2 | ✅ | 170.5M | ✅ | 101.7M | 🟢 **-40%** |
| items.json | items with boolean schema (false) | 2 | ✅ | 71.9M | ✅ | 7.0M | 🟢 **-90%** |
| items.json | items with boolean schemas | 3 | ✅ | 59.2M | ✅ | 15.9M | 🟢 **-73%** |
| items.json | items and subitems | 6 | ✅ | 27.4M | ✅ | 2.1M | 🟢 **-92%** |
| items.json | nested items | 3 | ✅ | 7.7M | ✅ | 3.2M | 🟢 **-58%** |
| items.json | single-form items with null instance ... | 1 | ✅ | 75.3M | ✅ | 88.4M | +17% |
| items.json | array-form items with null instance e... | 1 | ✅ | 80.9M | ✅ | 92.9M | +15% |
| maxContains.json | maxContains without contains is ignored | 2 | ✅ | 168.1M | ✅ | 114.4M | 🟢 **-32%** |
...
| maxItems.json | maxItems validation | 4 | ✅ | 80.8M | ✅ | 20.0M | 🟢 **-75%** |
| maxItems.json | maxItems validation with a decimal | 2 | ✅ | 72.6M | ✅ | 11.1M | 🟢 **-85%** |
| maxLength.json | maxLength validation | 5 | ✅ | 62.0M | ✅ | 20.7M | 🟢 **-67%** |
| maxLength.json | maxLength validation with a decimal | 2 | ✅ | 59.4M | ✅ | 10.2M | 🟢 **-83%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 55.5M | ✅ | 24.3M | 🟢 **-56%** |
| maxProperties.json | maxProperties validation with a decimal | 2 | ✅ | 49.8M | ✅ | 9.8M | 🟢 **-80%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 51.3M | ✅ | 9.8M | 🟢 **-81%** |
| maximum.json | maximum validation | 4 | ✅ | 76.9M | ✅ | 19.0M | 🟢 **-75%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 75.6M | ✅ | 20.5M | 🟢 **-73%** |
| minContains.json | minContains without contains is ignored | 2 | ✅ | 170.6M | ✅ | 114.2M | 🟢 **-33%** |
| minContains.json | minContains=1 with contains | 5 | ✅ | 72.1M | ✅ | 7.2M | 🟢 **-90%** |
...
| minItems.json | minItems validation | 4 | ✅ | 80.4M | ✅ | 20.0M | 🟢 **-75%** |
| minItems.json | minItems validation with a decimal | 2 | ✅ | 72.6M | ✅ | 11.2M | 🟢 **-85%** |
| minLength.json | minLength validation | 5 | ✅ | 58.1M | ✅ | 12.6M | 🟢 **-78%** |
| minLength.json | minLength validation with a decimal | 2 | ✅ | 58.9M | ✅ | 10.3M | 🟢 **-83%** |
| minProperties.json | minProperties validation | 6 | ✅ | 59.2M | ✅ | 24.1M | 🟢 **-59%** |
| minProperties.json | minProperties validation with a decimal | 2 | ✅ | 50.5M | ✅ | 9.8M | 🟢 **-81%** |
| minimum.json | minimum validation | 4 | ✅ | 76.9M | ✅ | 18.6M | 🟢 **-76%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 72.4M | ✅ | 17.6M | 🟢 **-76%** |
| multipleOf.json | by int | 3 | ✅ | 77.6M | ✅ | 12.8M | 🟢 **-84%** |
| multipleOf.json | by number | 3 | ✅ | 73.4M | ✅ | 14.5M | 🟢 **-80%** |
| multipleOf.json | by small number | 2 | ✅ | 66.8M | ✅ | 9.9M | 🟢 **-85%** |
| multipleOf.json | float division = inf | 1 | ✅ | 57.8M | ✅ | 5.4M | 🟢 **-91%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 75.2M | ✅ | 19.9M | 🟢 **-74%** |
| not.json | not | 2 | ✅ | 77.0M | ✅ | 6.9M | 🟢 **-91%** |
| not.json | not multiple types | 3 | ✅ | 71.1M | ✅ | 7.0M | 🟢 **-90%** |
| not.json | not more complex schema | 3 | ✅ | 69.0M | ✅ | 2.7M | 🟢 **-96%** |
| not.json | forbidden property | 2 | ✅ | 53.7M | ✅ | 2.9M | 🟢 **-95%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 60.8M | ✅ | 6.9M | 🟢 **-89%** |
...
| oneOf.json | oneOf complex types | 4 | ✅ | 44.9M | ✅ | 1.2M | 🟢 **-97%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 76.0M | ✅ | 6.4M | 🟢 **-92%** |
| oneOf.json | oneOf with required | 4 | ✅ | 48.3M | ✅ | 1.3M | 🟢 **-97%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 49.6M | ✅ | 1.6M | 🟢 **-97%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 76.2M | ✅ | 4.6M | 🟢 **-94%** |
| pattern.json | pattern validation | 8 | ✅ | 56.6M | ✅ | 28.8M | 🟢 **-49%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 25.2M | ✅ | 31.9M | 🔴 **+27%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 27.3M | ✅ | 9.3M | 🟢 **-66%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 14.8M | ✅ | 5.1M | 🟢 **-65%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 17.3M | ✅ | 5.3M | 🟢 **-70%** |
| patternProperties.json | patternProperties with boolean schemas | 5 | ✅ | 21.3M | ✅ | 4.6M | 🟢 **-78%** |
...
| properties.json | properties with escaped characters | 2 | ✅ | 51.9M | ✅ | 407K | 🟢 **-99%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 69.9M | ✅ | 3.5M | 🟢 **-95%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 28.1M | ✅ | 901K | 🟢 **-97%** |
| propertyNames.json | propertyNames validation | 6 | ✅ | 45.8M | ✅ | 5.6M | 🟢 **-88%** |
| propertyNames.json | propertyNames validation with pattern | 3 | ✅ | 19.7M | ✅ | 6.2M | 🟢 **-68%** |
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 170.3M | ✅ | 65.7M | 🟢 **-61%** |
| propertyNames.json | propertyNames with boolean schema false | 2 | ✅ | 51.0M | ✅ | 6.1M | 🟢 **-88%** |
| propertyNames.json | propertyNames with const | 3 | ✅ | 40.4M | ✅ | 5.5M | 🟢 **-86%** |
| propertyNames.json | propertyNames with enum | 4 | ✅ | 42.8M | ✅ | 4.3M | 🟢 **-90%** |
...
| ref.json | URN base URI with NSS | 2 | ✅ | 50.4M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with r-component | 2 | ✅ | 52.3M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with q-component | 2 | ✅ | 52.5M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with URN and JSON pointe... | 2 | ✅ | 51.5M | ✅ | 2.1M | 🟢 **-96%** |
...
| required.json | required validation | 5 | ✅ | 65.0M | ✅ | 10.1M | 🟢 **-84%** |
| required.json | required default validation | 1 | ✅ | 159.0M | ✅ | 102.2M | 🟢 **-36%** |
| required.json | required with empty array | 1 | ✅ | 157.8M | ✅ | 93.5M | 🟢 **-41%** |
| required.json | required with escaped characters | 2 | ✅ | 54.1M | ✅ | 1.1M | 🟢 **-98%** |
| required.json | required properties whose names are J... | 7 | ✅ | 27.9M | ✅ | 2.9M | 🟢 **-89%** |
| type.json | integer type matches integers | 9 | ✅ | 66.7M | ✅ | 8.6M | 🟢 **-87%** |
| type.json | number type matches numbers | 9 | ✅ | 69.6M | ✅ | 10.1M | 🟢 **-86%** |
| type.json | string type matches strings | 9 | ✅ | 69.3M | ✅ | 10.1M | 🟢 **-85%** |
| type.json | object type matches objects | 7 | ✅ | 59.3M | ✅ | 8.1M | 🟢 **-86%** |
| type.json | array type matches arrays | 7 | ✅ | 64.7M | ✅ | 8.0M | 🟢 **-88%** |
| type.json | boolean type matches booleans | 10 | ✅ | 66.8M | ✅ | 8.6M | 🟢 **-87%** |
| type.json | null type matches only the null object | 10 | ✅ | 66.7M | ✅ | 7.8M | 🟢 **-88%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 67.2M | ✅ | 9.4M | 🟢 **-86%** |
| type.json | type as array with one item | 2 | ✅ | 76.9M | ✅ | 13.1M | 🟢 **-83%** |
| type.json | type: array or object | 5 | ✅ | 72.1M | ✅ | 11.2M | 🟢 **-85%** |
| type.json | type: array, object or null | 5 | ✅ | 77.1M | ✅ | 15.8M | 🟢 **-80%** |
| unevaluatedItems.json | unevaluatedItems true | 2 | ✅ | 83.0M | ✅ | 109.9M | 🔴 **+32%** |
| unevaluatedItems.json | unevaluatedItems false | 2 | ✅ | 61.0M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems as schema | 3 | ✅ | 52.7M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with uniform items | 1 | ✅ | 70.4M | ✅ | 77.6M | +10% |
| unevaluatedItems.json | unevaluatedItems with tuple | 2 | ✅ | 56.0M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with items and addit... | 1 | ✅ | 78.9M | ✅ | 89.1M | +13% |
...
| unevaluatedItems.json | unevaluatedItems with nested items an... | 2 | ✅ | 81.8M | ✅ | 99.3M | 🔴 **+21%** |
| unevaluatedItems.json | unevaluatedItems with nested unevalua... | 2 | ✅ | 21.4M | ✅ | 84.1M | 🔴 **+294%** |
...
| unevaluatedItems.json | non-array instances are valid | 6 | ✅ | 91.7M | ✅ | 117.0M | 🔴 **+28%** |
| unevaluatedItems.json | unevaluatedItems with null instance e... | 1 | ✅ | 75.3M | ✅ | 78.3M | +4% |
...
| unevaluatedProperties.json | unevaluatedProperties true | 2 | ✅ | 58.2M | ✅ | 89.4M | 🔴 **+54%** |
...
| unevaluatedProperties.json | unevaluatedProperties with adjacent a... | 2 | ✅ | 69.6M | ✅ | 3.6M | 🟢 **-95%** |
...
| unevaluatedProperties.json | unevaluatedProperties with nested add... | 2 | ✅ | 69.6M | ✅ | 3.6M | 🟢 **-95%** |
| unevaluatedProperties.json | unevaluatedProperties with nested une... | 2 | ✅ | 33.8M | ✅ | 3.6M | 🟢 **-89%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer f... | 2 | ✅ | 32.6M | ✅ | 3.5M | 🟢 **-89%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer f... | 2 | ✅ | 30.7M | ✅ | 3.6M | 🟢 **-88%** |
...
| unevaluatedProperties.json | non-object instances are valid | 6 | ✅ | 80.6M | ✅ | 118.9M | 🔴 **+47%** |
| unevaluatedProperties.json | unevaluatedProperties with null value... | 1 | ✅ | 52.5M | ✅ | 84.5M | 🔴 **+61%** |
...
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 17.4M | ❌ | - | - |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 33.5M | ✅ | 5.2M | 🟢 **-85%** |
...
| optional/bignum.json | number | 2 | ✅ | 88.7M | ✅ | 103.9M | +17% |
| optional/bignum.json | string | 1 | ✅ | 63.5M | ✅ | 6.9M | 🟢 **-89%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 78.9M | ✅ | 99.0M | 🔴 **+25%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 60.0M | ✅ | 4.8M | 🟢 **-92%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 78.9M | ✅ | 96.0M | 🔴 **+22%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 60.0M | ✅ | 4.8M | 🟢 **-92%** |
...
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 175.2M | ✅ | 7.5M | 🟢 **-96%** |
| optional/dependencies-compatibility.json | multiple dependents required | 6 | ✅ | 34.2M | ✅ | 2.6M | 🟢 **-92%** |
| optional/dependencies-compatibility.json | dependencies with escaped characters | 4 | ✅ | 48.9M | ✅ | 1.7M | 🟢 **-97%** |
...
| optional/dependencies-compatibility.json | schema dependencies with escaped char... | 4 | ✅ | 40.2M | ✅ | 1.8M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 56.3M | ✅ | 9.1M | 🟢 **-84%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 25.9M | ✅ | 9.1M | 🟢 **-65%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.2M | ✅ | 9.1M | 🟢 **-69%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.3M | ✅ | 9.1M | 🟢 **-69%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 29.9M | ✅ | 7.2M | 🟢 **-76%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 27.4M | ✅ | 12.0M | 🟢 **-56%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 29.1M | ✅ | 9.1M | 🟢 **-69%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 24.0M | ✅ | 8.8M | 🟢 **-63%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.7M | ✅ | 16.1M | 🟢 **-40%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 31.7M | ✅ | 6.3M | 🟢 **-80%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 17.3M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 15.1M | ✅ | 5.5M | 🟢 **-64%** |
...
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 21.1M | ✅ | 5.9M | 🟢 **-72%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 95.2M | ✅ | 104.3M | +10% |
| optional/format/uri-reference.json | validation of URI References | 15 | ✅ | 9.7M | ❌ | - | - |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 68.0M | ✅ | 14.9M | 🟢 **-78%** |
| optional/non-bmp-regex.json | Proper UTF-16 surrogate pair handling... | 7 | ✅ | 30.8M | ❌ | - | - |
| optional/non-bmp-regex.json | Proper UTF-16 surrogate pair handling... | 5 | ✅ | 17.7M | ❌ | - | - |
| optional/refOfUnknownKeyword.json | reference of a root arbitrary keyword  | 2 | ✅ | 54.7M | ✅ | 2.0M | 🟢 **-96%** |
| optional/refOfUnknownKeyword.json | reference of a root arbitrary keyword... | 2 | ✅ | 52.7M | ✅ | 2.1M | 🟢 **-96%** |
| optional/refOfUnknownKeyword.json | reference of an arbitrary keyword of ... | 2 | ✅ | 54.1M | ✅ | 1.6M | 🟢 **-97%** |
...
| File | Group | Tests | tjs | tjs ops/s | djv | djv ops/s | Diff |
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 25.2M | ✅ | 15.8M | 🟢 **-37%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 32.0M | ✅ | 7.4M | 🟢 **-77%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 42.8M | ✅ | 8.3M | 🟢 **-81%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 17.9M | ✅ | 6.8M | 🟢 **-62%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 158.3M | ✅ | 102.7M | 🟢 **-35%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 24.4M | ✅ | 3.6M | 🟢 **-85%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 69.4M | ✅ | 61.2M | -12% |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 29.6M | ✅ | 6.2M | 🟢 **-79%** |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 31.5M | ✅ | 4.2M | 🟢 **-87%** |
| allOf.json | allOf | 4 | ✅ | 40.8M | ✅ | 1.5M | 🟢 **-96%** |
| allOf.json | allOf with base schema | 5 | ✅ | 28.9M | ✅ | 1.5M | 🟢 **-95%** |
| allOf.json | allOf simple types | 2 | ✅ | 85.3M | ✅ | 6.3M | 🟢 **-93%** |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 151.1M | ✅ | 103.2M | 🟢 **-32%** |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 66.1M | ✅ | 3.7M | 🟢 **-94%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 68.6M | ✅ | 3.7M | 🟢 **-95%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 159.1M | ✅ | 103.9M | 🟢 **-35%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 158.7M | ✅ | 104.0M | 🟢 **-34%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 77.1M | ✅ | 7.0M | 🟢 **-91%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.8M | ✅ | 7.0M | 🟢 **-94%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 77.4M | ✅ | 4.8M | 🟢 **-94%** |
...
| anyOf.json | anyOf with base schema | 3 | ✅ | 37.8M | ✅ | 3.6M | 🟢 **-90%** |
...
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 171.9M | ✅ | 12.6M | 🟢 **-93%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 78.1M | ✅ | 4.8M | 🟢 **-94%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 184.6M | ✅ | 64.8M | 🟢 **-65%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 64.0M | ✅ | 7.0M | 🟢 **-89%** |
...
| const.json | const with 0 does not match other zer... | 6 | ✅ | 63.1M | ❌ | - | - |
| const.json | const with 1 does not match true | 3 | ✅ | 73.7M | ❌ | - | - |
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 73.1M | ✅ | 5.3M | 🟢 **-93%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 73.3M | ✅ | 3.0M | 🟢 **-96%** |
| const.json | nul characters in strings | 2 | ✅ | 64.8M | ✅ | 4.3M | 🟢 **-93%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 58.4M | ❌ | - | - |
| const.json | characters with the same visual repre... | 2 | ✅ | 66.1M | ❌ | - | - |
| contains.json | contains keyword validation | 6 | ✅ | 64.3M | ✅ | 3.3M | 🟢 **-95%** |
| contains.json | contains keyword with const keyword | 3 | ✅ | 61.9M | ✅ | 1.7M | 🟢 **-97%** |
| contains.json | contains keyword with boolean schema ... | 2 | ✅ | 71.7M | ✅ | 11.1M | 🟢 **-85%** |
| contains.json | contains keyword with boolean schema ... | 3 | ✅ | 72.1M | ✅ | 6.1M | 🟢 **-92%** |
| contains.json | items + contains | 4 | ✅ | 42.4M | ❌ | - | - |
| contains.json | contains with false if subschema | 2 | ✅ | 68.9M | ✅ | 10.9M | 🟢 **-84%** |
| contains.json | contains with null instance elements | 1 | ✅ | 77.1M | ✅ | 92.6M | 🔴 **+20%** |
| content.json | validation of string-encoded content ... | 3 | ✅ | 176.8M | ✅ | 116.4M | 🟢 **-34%** |
| content.json | validation of binary string-encoding | 3 | ✅ | 176.6M | ✅ | 99.6M | 🟢 **-44%** |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 160.2M | ✅ | 118.4M | 🟢 **-26%** |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 184.5M | ✅ | 104.8M | 🟢 **-43%** |
| default.json | invalid type for default | 2 | ✅ | 71.6M | ✅ | 3.6M | 🟢 **-95%** |
| default.json | invalid string value for default | 2 | ✅ | 55.2M | ✅ | 2.8M | 🟢 **-95%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 57.5M | ✅ | 1.8M | 🟢 **-97%** |
| defs.json | validate definition against metaschema | 2 | ✅ | 2.2M | ❌ | - | - |
| dependentRequired.json | single dependency | 7 | ✅ | 65.3M | ❌ | - | - |
| dependentRequired.json | empty dependents | 3 | ✅ | 176.6M | ✅ | 114.3M | 🟢 **-35%** |
...
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 66.2M | ✅ | 3.1M | 🟢 **-95%** |
...
| format.json | idn-email format | 7 | ✅ | 180.7M | ✅ | 118.0M | 🟢 **-35%** |
| format.json | regex format | 7 | ✅ | 182.0M | ✅ | 23.0M | 🟢 **-87%** |
| format.json | ipv4 format | 7 | ✅ | 182.7M | ❌ | - | - |
| format.json | ipv6 format | 7 | ✅ | 175.6M | ❌ | - | - |
| format.json | idn-hostname format | 7 | ✅ | 153.3M | ✅ | 119.2M | 🟢 **-22%** |
| format.json | hostname format | 7 | ✅ | 153.1M | ❌ | - | - |
| format.json | date format | 7 | ✅ | 182.9M | ✅ | 104.8M | 🟢 **-43%** |
| format.json | date-time format | 7 | ✅ | 183.7M | ❌ | - | - |
| format.json | time format | 7 | ✅ | 182.9M | ✅ | 118.9M | 🟢 **-35%** |
| format.json | json-pointer format | 7 | ✅ | 183.3M | ❌ | - | - |
| format.json | relative-json-pointer format | 7 | ✅ | 183.9M | ✅ | 118.8M | 🟢 **-35%** |
| format.json | iri format | 7 | ✅ | 183.1M | ✅ | 98.0M | 🟢 **-46%** |
| format.json | iri-reference format | 7 | ✅ | 183.5M | ✅ | 118.6M | 🟢 **-35%** |
| format.json | uri format | 7 | ✅ | 182.7M | ❌ | - | - |
| format.json | uri-reference format | 7 | ✅ | 183.7M | ❌ | - | - |
| format.json | uri-template format | 7 | ✅ | 182.7M | ❌ | - | - |
| format.json | uuid format | 7 | ✅ | 183.1M | ✅ | 117.6M | 🟢 **-36%** |
| format.json | duration format | 7 | ✅ | 176.1M | ✅ | 105.1M | 🟢 **-40%** |
| if-then-else.json | ignore if without then or else | 2 | ✅ | 171.8M | ✅ | 112.7M | 🟢 **-34%** |
| if-then-else.json | ignore then without if | 2 | ✅ | 170.9M | ✅ | 107.6M | 🟢 **-37%** |
| if-then-else.json | ignore else without if | 2 | ✅ | 170.7M | ✅ | 95.5M | 🟢 **-44%** |
| if-then-else.json | if and then without else | 3 | ✅ | 77.3M | ❌ | - | - |
| if-then-else.json | if and else without then | 3 | ✅ | 76.4M | ❌ | - | - |
| if-then-else.json | validate against correct branch, then... | 4 | ✅ | 71.8M | ❌ | - | - |
| if-then-else.json | non-interference across combined schemas | 2 | ✅ | 163.6M | ✅ | 114.0M | 🟢 **-30%** |
| if-then-else.json | if with boolean schema true | 2 | ✅ | 76.1M | ❌ | - | - |
| if-then-else.json | if with boolean schema false | 2 | ✅ | 75.3M | ❌ | - | - |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 171.5M | ✅ | 98.3M | 🟢 **-43%** |
| items.json | items with boolean schema (false) | 2 | ✅ | 71.9M | ✅ | 7.0M | 🟢 **-90%** |
...
| items.json | items does not look in applicators, v... | 2 | ✅ | 47.9M | ✅ | 6.8M | 🟢 **-86%** |
| items.json | prefixItems validation adjusts the st... | 2 | ✅ | 44.9M | ❌ | - | - |
| items.json | items with heterogeneous array | 2 | ✅ | 72.8M | ❌ | - | - |
| items.json | items with null instance elements | 1 | ✅ | 74.9M | ✅ | 85.9M | +15% |
| maxContains.json | maxContains without contains is ignored | 2 | ✅ | 171.3M | ✅ | 105.2M | 🟢 **-39%** |
| maxContains.json | maxContains with contains | 5 | ✅ | 59.1M | ❌ | - | - |
| maxContains.json | maxContains with contains, value with... | 2 | ✅ | 66.1M | ❌ | - | - |
| maxContains.json | minContains < maxContains | 3 | ✅ | 59.4M | ❌ | - | - |
| maxItems.json | maxItems validation | 4 | ✅ | 79.4M | ✅ | 19.6M | 🟢 **-75%** |
| maxItems.json | maxItems validation with a decimal | 2 | ✅ | 72.6M | ✅ | 11.2M | 🟢 **-85%** |
| maxLength.json | maxLength validation | 5 | ✅ | 62.7M | ✅ | 21.4M | 🟢 **-66%** |
| maxLength.json | maxLength validation with a decimal | 2 | ✅ | 59.2M | ✅ | 10.3M | 🟢 **-83%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 58.6M | ✅ | 24.3M | 🟢 **-58%** |
| maxProperties.json | maxProperties validation with a decimal | 2 | ✅ | 50.3M | ✅ | 9.8M | 🟢 **-80%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 50.3M | ✅ | 9.7M | 🟢 **-81%** |
| maximum.json | maximum validation | 4 | ✅ | 78.2M | ✅ | 18.9M | 🟢 **-76%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 75.6M | ✅ | 19.7M | 🟢 **-74%** |
| minContains.json | minContains without contains is ignored | 2 | ✅ | 157.8M | ✅ | 114.2M | 🟢 **-28%** |
| minContains.json | minContains=1 with contains | 5 | ✅ | 65.4M | ✅ | 7.1M | 🟢 **-89%** |
...
| minContains.json | minContains = 0 with maxContains | 3 | ✅ | 72.0M | ❌ | - | - |
| minItems.json | minItems validation | 4 | ✅ | 79.0M | ✅ | 19.9M | 🟢 **-75%** |
...
| minProperties.json | minProperties validation | 6 | ✅ | 59.9M | ✅ | 24.4M | 🟢 **-59%** |
| minProperties.json | minProperties validation with a decimal | 2 | ✅ | 48.6M | ✅ | 9.8M | 🟢 **-80%** |
| minimum.json | minimum validation | 4 | ✅ | 78.7M | ✅ | 18.5M | 🟢 **-76%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 69.5M | ✅ | 17.4M | 🟢 **-75%** |
| multipleOf.json | by int | 3 | ✅ | 77.1M | ✅ | 12.8M | 🟢 **-83%** |
| multipleOf.json | by number | 3 | ✅ | 73.3M | ✅ | 14.4M | 🟢 **-80%** |
| multipleOf.json | by small number | 2 | ✅ | 66.8M | ✅ | 9.8M | 🟢 **-85%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 60.7M | ✅ | 6.9M | 🟢 **-89%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 64.9M | ✅ | 7.0M | 🟢 **-89%** |
| not.json | allow everything with boolean schema ... | 9 | ✅ | 183.7M | ✅ | 7.2M | 🟢 **-96%** |
| not.json | double negation | 1 | ✅ | 159.2M | ✅ | 6.8M | 🟢 **-96%** |
| not.json | collect annotations inside a 'not', e... | 2 | ✅ | 33.4M | ❌ | - | - |
| oneOf.json | oneOf | 4 | ✅ | 67.2M | ✅ | 4.0M | 🟢 **-94%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 36.4M | ✅ | 5.6M | 🟢 **-85%** |
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 65.9M | ✅ | 5.9M | 🟢 **-91%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 90.0M | ✅ | 3.4M | 🟢 **-96%** |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 65.9M | ✅ | 3.3M | 🟢 **-95%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 1.7M | 🟢 **-97%** |
...
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 49.6M | ✅ | 1.6M | 🟢 **-97%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 76.2M | ✅ | 4.6M | 🟢 **-94%** |
| pattern.json | pattern validation | 8 | ✅ | 56.6M | ✅ | 28.1M | 🟢 **-50%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 19.9M | ✅ | 27.5M | 🔴 **+38%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 27.3M | ✅ | 9.2M | 🟢 **-66%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 14.5M | ✅ | 5.0M | 🟢 **-65%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 15.6M | ✅ | 5.2M | 🟢 **-67%** |
| patternProperties.json | patternProperties with boolean schemas | 5 | ✅ | 21.2M | ✅ | 4.5M | 🟢 **-79%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 18.1M | ✅ | 21.3M | +17% |
...
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 20.2M | ✅ | 1.7M | 🟢 **-92%** |
| properties.json | properties with boolean schema | 4 | ✅ | 49.6M | ✅ | 2.0M | 🟢 **-96%** |
| properties.json | properties with escaped characters | 2 | ✅ | 50.9M | ✅ | 396K | 🟢 **-99%** |
...
| propertyNames.json | propertyNames validation | 6 | ✅ | 45.8M | ✅ | 5.5M | 🟢 **-88%** |
| propertyNames.json | propertyNames validation with pattern | 3 | ✅ | 20.0M | ✅ | 6.3M | 🟢 **-68%** |
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 171.3M | ✅ | 66.4M | 🟢 **-61%** |
| propertyNames.json | propertyNames with boolean schema false | 2 | ✅ | 50.4M | ✅ | 6.2M | 🟢 **-88%** |
| propertyNames.json | propertyNames with const | 3 | ✅ | 40.6M | ✅ | 5.5M | 🟢 **-87%** |
| propertyNames.json | propertyNames with enum | 4 | ✅ | 43.1M | ✅ | 4.0M | 🟢 **-91%** |
...
| ref.json | nested refs | 2 | ✅ | 39.0M | ✅ | 3.7M | 🟢 **-91%** |
...
| ref.json | refs with quote | 2 | ✅ | 53.9M | ✅ | 1.7M | 🟢 **-97%** |
...
| ref.json | URN base URI with NSS | 2 | ✅ | 52.6M | ✅ | 2.1M | 🟢 **-96%** |
| ref.json | URN base URI with r-component | 2 | ✅ | 54.1M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with q-component | 2 | ✅ | 54.3M | ✅ | 2.0M | 🟢 **-96%** |
| ref.json | URN base URI with URN and JSON pointe... | 2 | ✅ | 54.8M | ✅ | 2.1M | 🟢 **-96%** |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 76.4M | ✅ | 7.1M | 🟢 **-91%** |
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 77.1M | ✅ | 4.8M | 🟢 **-94%** |
...
| required.json | required validation | 5 | ✅ | 65.0M | ✅ | 10.1M | 🟢 **-84%** |
| required.json | required default validation | 1 | ✅ | 158.7M | ✅ | 103.5M | 🟢 **-35%** |
| required.json | required with empty array | 1 | ✅ | 159.6M | ✅ | 93.2M | 🟢 **-42%** |
...
| type.json | integer type matches integers | 9 | ✅ | 65.6M | ✅ | 8.7M | 🟢 **-87%** |
| type.json | number type matches numbers | 9 | ✅ | 66.3M | ✅ | 10.2M | 🟢 **-85%** |
| type.json | string type matches strings | 9 | ✅ | 69.2M | ✅ | 10.0M | 🟢 **-86%** |
| type.json | object type matches objects | 7 | ✅ | 58.9M | ✅ | 8.1M | 🟢 **-86%** |
| type.json | array type matches arrays | 7 | ✅ | 63.9M | ✅ | 8.0M | 🟢 **-87%** |
| type.json | boolean type matches booleans | 10 | ✅ | 66.6M | ✅ | 8.7M | 🟢 **-87%** |
| type.json | null type matches only the null object | 10 | ✅ | 62.7M | ✅ | 7.8M | 🟢 **-88%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 61.5M | ✅ | 9.4M | 🟢 **-85%** |
| type.json | type as array with one item | 2 | ✅ | 72.9M | ✅ | 13.0M | 🟢 **-82%** |
| type.json | type: array or object | 5 | ✅ | 72.3M | ✅ | 11.1M | 🟢 **-85%** |
| type.json | type: array, object or null | 5 | ✅ | 77.2M | ✅ | 15.7M | 🟢 **-80%** |
| unevaluatedItems.json | unevaluatedItems true | 2 | ✅ | 83.0M | ✅ | 114.6M | 🔴 **+38%** |
| unevaluatedItems.json | unevaluatedItems false | 2 | ✅ | 61.1M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems as schema | 3 | ✅ | 52.2M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with uniform items | 1 | ✅ | 70.4M | ✅ | 76.3M | +8% |
| unevaluatedItems.json | unevaluatedItems with tuple | 2 | ✅ | 55.6M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with items and prefi... | 1 | ✅ | 78.9M | ✅ | 91.5M | +16% |
| unevaluatedItems.json | unevaluatedItems with items | 2 | ✅ | 45.8M | ✅ | 6.4M | 🟢 **-86%** |
...
| unevaluatedItems.json | unevaluatedItems with nested prefixIt... | 2 | ✅ | 81.9M | ✅ | 99.2M | 🔴 **+21%** |
| unevaluatedItems.json | unevaluatedItems with nested unevalua... | 2 | ✅ | 21.2M | ✅ | 113.3M | 🔴 **+435%** |
| unevaluatedItems.json | unevaluatedItems with anyOf | 4 | ✅ | 12.3M | ❌ | - | - |
...
| unevaluatedItems.json | non-array instances are valid | 6 | ✅ | 79.7M | ✅ | 118.7M | 🔴 **+49%** |
| unevaluatedItems.json | unevaluatedItems with null instance e... | 1 | ✅ | 75.3M | ✅ | 83.0M | +10% |
...
| unevaluatedProperties.json | unevaluatedProperties true | 2 | ✅ | 58.2M | ✅ | 113.8M | 🔴 **+95%** |
...
| unevaluatedProperties.json | unevaluatedProperties with adjacent b... | 2 | ✅ | 171.9M | ✅ | 114.1M | 🟢 **-34%** |
| unevaluatedProperties.json | unevaluatedProperties with adjacent n... | 2 | ✅ | 35.7M | ✅ | 6.7M | 🟢 **-81%** |
...
| unevaluatedProperties.json | unevaluatedProperties with nested une... | 2 | ✅ | 29.7M | ✅ | 3.5M | 🟢 **-88%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 30.0M | ❌ | - | - |
| unevaluatedProperties.json | nested unevaluatedProperties, outer f... | 2 | ✅ | 28.4M | ✅ | 3.5M | 🟢 **-88%** |
...
| unevaluatedProperties.json | non-object instances are valid | 6 | ✅ | 82.4M | ✅ | 119.7M | 🔴 **+45%** |
...
| optional/dependencies-compatibility.json | single dependency | 7 | ✅ | 64.9M | ✅ | 4.3M | 🟢 **-93%** |
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 176.6M | ✅ | 7.4M | 🟢 **-96%** |
...
| optional/dependencies-compatibility.json | single schema dependency | 8 | ✅ | 55.5M | ✅ | 1.9M | 🟢 **-97%** |
| optional/dependencies-compatibility.json | boolean subschemas | 4 | ✅ | 61.5M | ✅ | 2.7M | 🟢 **-96%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 64.6M | ✅ | 8.9M | 🟢 **-86%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 20.2M | ✅ | 9.1M | 🟢 **-55%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.4M | ✅ | 8.9M | 🟢 **-70%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.2M | ✅ | 9.1M | 🟢 **-69%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 29.6M | ✅ | 7.1M | 🟢 **-76%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 27.5M | ✅ | 11.7M | 🟢 **-57%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 29.6M | ✅ | 9.1M | 🟢 **-69%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 29.3M | ✅ | 8.9M | 🟢 **-70%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 27.2M | ✅ | 16.4M | 🟢 **-40%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 32.1M | ✅ | 6.2M | 🟢 **-81%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 17.2M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 15.6M | ✅ | 5.4M | 🟢 **-65%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 15.3M | ✅ | 6.0M | 🟢 **-61%** |
...
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 21.0M | ✅ | 5.7M | 🟢 **-73%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 95.0M | ✅ | 103.3M | +9% |
...
| optional/format-assertion.json | schema that uses custom metaschema wi... | 2 | ✅ | 24.7M | ✅ | 6.6M | 🟢 **-73%** |
| optional/format-assertion.json | schema that uses custom metaschema wi... | 2 | ✅ | 17.7M | ✅ | 6.5M | 🟢 **-63%** |
| optional/id.json | $id inside an enum is not a real iden... | 3 | ✅ | 37.2M | ❌ | - | - |
| optional/no-schema.json | validation without $schema | 3 | ✅ | 67.1M | ✅ | 14.7M | 🟢 **-78%** |
| optional/non-bmp-regex.json | Proper UTF-16 surrogate pair handling... | 7 | ✅ | 30.8M | ❌ | - | - |
...
| optional/refOfUnknownKeyword.json | reference of a root arbitrary keyword... | 2 | ✅ | 54.9M | ✅ | 2.1M | 🟢 **-96%** |
