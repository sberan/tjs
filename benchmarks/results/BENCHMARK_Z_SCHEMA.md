...
|-------|-------:|---------:|----------:|-----------:|----------:|----------:|-----:|
| draft4 | 199 | 198/199 | 24.8M | 169/199 | 848K | 169 | 🟢 **-97%** |
| draft6 | 276 | ✅ 276 | 29.7M | 0/276 | - | 0 | - |
| draft7 | 313 | ✅ 313 | 15.6M | 0/313 | - | 0 | - |
| draft2019-09 | 435 | ✅ 435 | 18.2M | 28/435 | 667K | 28 | 🟢 **-96%** |
| draft2020-12 | 448 | ✅ 448 | 19.2M | 28/448 | 693K | 28 | 🟢 **-96%** |
| **Total** | 1671 | 1670/1671 | 19.6M | 225/1671 | 821K | 225 | 🟢 **-96%** |

## Head-to-Head Performance

Direct comparison using only test groups where **both** validators pass **all** tests. This ensures a fair comparison by excluding groups where either validator has incomplete or incorrect implementations.

**Result**: 🟢 **tjs** is **40.61x faster** (30 ns vs 1218 ns per test, 803 tests in 225 groups)
...
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 7.4M | ✅ | 700K | 🟢 **-91%** |
| additionalItems.json | when items is schema, additionalItems... | 1 | ✅ | 69.8M | ✅ | 1.7M | 🟢 **-98%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 146.4M | ✅ | 1.8M | 🟢 **-99%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 71.2M | ✅ | 2.8M | 🟢 **-96%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 124.4M | ✅ | 2.2M | 🟢 **-98%** |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 39.7M | ✅ | 367K | 🟢 **-99%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 59.3M | ✅ | 656K | 🟢 **-99%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 58.8M | ✅ | 1.1M | 🟢 **-98%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 153.0M | ✅ | 3.9M | 🟢 **-97%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 35.0M | ✅ | 1.1M | 🟢 **-97%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 24.9M | ✅ | 754K | 🟢 **-97%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 32.1M | ✅ | 787K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 44.2M | ✅ | 770K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 69.8M | ✅ | 1.3M | 🟢 **-98%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 33.9M | ✅ | 391K | 🟢 **-99%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 44.2M | ✅ | 1.9M | 🟢 **-96%** |
| allOf.json | allOf | 4 | ✅ | 47.7M | ✅ | 465K | 🟢 **-99%** |
| allOf.json | allOf with base schema | 5 | ✅ | 25.1M | ✅ | 392K | 🟢 **-98%** |
| allOf.json | allOf simple types | 2 | ✅ | 109.9M | ✅ | 1000K | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 69.7M | ✅ | 3.2M | 🟢 **-95%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 151.7M | ✅ | 2.6M | 🟢 **-98%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 61.1M | ✅ | 931K | 🟢 **-98%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.7M | ✅ | 956K | 🟢 **-99%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 61.6M | ✅ | 891K | 🟢 **-99%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 84.0M | ✅ | 335K | 🟢 **-100%** |
| anyOf.json | anyOf | 4 | ✅ | 62.3M | ✅ | 643K | 🟢 **-99%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 45.9M | ✅ | 575K | 🟢 **-99%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 43.5M | ✅ | 405K | 🟢 **-99%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 164.3M | ✅ | 2.7M | 🟢 **-98%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 60.5M | ✅ | 641K | 🟢 **-99%** |
| default.json | invalid type for default | 2 | ✅ | 107.6M | ✅ | 2.0M | 🟢 **-98%** |
| default.json | invalid string value for default | 2 | ✅ | 45.4M | ✅ | 1.9M | 🟢 **-96%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 77.4M | ✅ | 910K | 🟢 **-99%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 12.3M | ✅ | 124K | 🟢 **-99%** |
| dependencies.json | dependencies | 7 | ✅ | 90.9M | ✅ | 1.7M | 🟢 **-98%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 30.8M | ✅ | 842K | 🟢 **-97%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 58.6M | ✅ | 470K | 🟢 **-99%** |
| dependencies.json | dependencies with escaped characters | 7 | ✅ | 11.2M | ✅ | 733K | 🟢 **-93%** |
| dependencies.json | dependent subschema incompatible with... | 4 | ✅ | 33.2M | ✅ | 768K | 🟢 **-98%** |
| enum.json | simple enum validation | 2 | ✅ | 68.5M | ✅ | 1.6M | 🟢 **-98%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 60.8M | ✅ | 802K | 🟢 **-99%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 57.8M | ✅ | 2.3M | 🟢 **-96%** |
| enum.json | enums in properties | 6 | ✅ | 15.0M | ✅ | 663K | 🟢 **-96%** |
| enum.json | enum with escaped characters | 3 | ✅ | 48.6M | ✅ | 2.2M | 🟢 **-95%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 113.1M | ✅ | 1.1M | 🟢 **-99%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 52.9M | ✅ | 965K | 🟢 **-98%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 112.0M | ✅ | 1.2M | 🟢 **-99%** |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 53.0M | ✅ | 995K | 🟢 **-98%** |
| enum.json | enum with 0 does not match false | 3 | ✅ | 114.4M | ✅ | 2.3M | 🟢 **-98%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 52.7M | ✅ | 1.8M | 🟢 **-97%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 103.2M | ✅ | 2.1M | 🟢 **-98%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 52.3M | ✅ | 1.7M | 🟢 **-97%** |
| enum.json | nul characters in strings | 2 | ✅ | 91.3M | ✅ | 2.0M | 🟢 **-98%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 49.1M | ✅ | 1.8M | 🟢 **-96%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 93.9M | ✅ | 1.8M | 🟢 **-98%** |
| format.json | email format | 6 | ✅ | 65.7M | ✅ | 3.4M | 🟢 **-95%** |
| format.json | ipv4 format | 6 | ✅ | 162.3M | ✅ | 3.4M | 🟢 **-98%** |
| format.json | ipv6 format | 6 | ✅ | 65.8M | ✅ | 3.4M | 🟢 **-95%** |
| format.json | hostname format | 6 | ✅ | 163.1M | ✅ | 3.3M | 🟢 **-98%** |
| format.json | date-time format | 6 | ✅ | 64.2M | ✅ | 3.4M | 🟢 **-95%** |
| format.json | uri format | 6 | ✅ | 162.0M | ✅ | 3.3M | 🟢 **-98%** |
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 38.6M | ✅ | 373K | 🟢 **-99%** |
| items.json | a schema given for items | 4 | ✅ | 81.9M | ✅ | 970K | 🟢 **-99%** |
| items.json | an array of schemas for items | 6 | ✅ | 55.5M | ✅ | 927K | 🟢 **-98%** |
| items.json | items and subitems | 6 | ✅ | 28.1M | ✅ | 256K | 🟢 **-99%** |
| items.json | nested items | 3 | ✅ | 11.7M | ✅ | 136K | 🟢 **-99%** |
| items.json | items with null instance elements | 1 | ✅ | 60.8M | ✅ | 2.2M | 🟢 **-96%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 64.3M | ✅ | 2.3M | 🟢 **-96%** |
| maxItems.json | maxItems validation | 4 | ✅ | 58.3M | ✅ | 1.8M | 🟢 **-97%** |
| maxLength.json | maxLength validation | 5 | ✅ | 49.4M | ✅ | 1.9M | 🟢 **-96%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 48.1M | ✅ | 1.6M | 🟢 **-97%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 41.8M | ✅ | 956K | 🟢 **-98%** |
| maximum.json | maximum validation | 4 | ✅ | 34.3M | ✅ | 1.5M | 🟢 **-96%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 56.3M | ✅ | 1.5M | 🟢 **-97%** |
| maximum.json | maximum validation (explicit false ex... | 4 | ✅ | 57.0M | ✅ | 1.4M | 🟢 **-98%** |
| maximum.json | exclusiveMaximum validation | 2 | ✅ | 57.2M | ✅ | 1.3M | 🟢 **-98%** |
| minItems.json | minItems validation | 4 | ✅ | 52.4M | ✅ | 1.6M | 🟢 **-97%** |
| minLength.json | minLength validation | 5 | ✅ | 48.5M | ✅ | 1.5M | 🟢 **-97%** |
| minProperties.json | minProperties validation | 6 | ✅ | 48.3M | ✅ | 1.8M | 🟢 **-96%** |
| minimum.json | minimum validation | 4 | ✅ | 57.0M | ✅ | 1.5M | 🟢 **-97%** |
| minimum.json | minimum validation (explicit false ex... | 4 | ✅ | 56.6M | ✅ | 1.4M | 🟢 **-98%** |
| minimum.json | exclusiveMinimum validation | 2 | ✅ | 57.1M | ✅ | 1.3M | 🟢 **-98%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 57.2M | ✅ | 1.7M | 🟢 **-97%** |
| multipleOf.json | by int | 3 | ✅ | 59.8M | ✅ | 1.2M | 🟢 **-98%** |
| multipleOf.json | by number | 3 | ✅ | 57.0M | ✅ | 1.1M | 🟢 **-98%** |
| multipleOf.json | by small number | 2 | ✅ | 46.4M | ✅ | 1.1M | 🟢 **-98%** |
| multipleOf.json | float division = inf | 1 | ✅ | 24.8M | ✅ | 717K | 🟢 **-97%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 60.0M | ✅ | 2.1M | 🟢 **-97%** |
| not.json | not | 2 | ✅ | 61.2M | ✅ | 766K | 🟢 **-99%** |
| not.json | not multiple types | 3 | ✅ | 50.7M | ✅ | 884K | 🟢 **-98%** |
| not.json | not more complex schema | 3 | ✅ | 49.5M | ✅ | 546K | 🟢 **-99%** |
| not.json | forbidden property | 2 | ✅ | 42.1M | ✅ | 859K | 🟢 **-98%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 50.5M | ✅ | 1.2M | 🟢 **-98%** |
| not.json | double negation | 1 | ✅ | 69.7M | ✅ | 1.3M | 🟢 **-98%** |
| oneOf.json | oneOf | 4 | ✅ | 53.3M | ✅ | 479K | 🟢 **-99%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 30.1M | ✅ | 564K | 🟢 **-98%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 38.7M | ✅ | 318K | 🟢 **-99%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 60.0M | ✅ | 736K | 🟢 **-99%** |
| oneOf.json | oneOf with required | 4 | ✅ | 41.9M | ✅ | 375K | 🟢 **-99%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 39.8M | ✅ | 391K | 🟢 **-99%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 60.0M | ✅ | 635K | 🟢 **-99%** |
| pattern.json | pattern validation | 8 | ✅ | 46.3M | ✅ | 2.1M | 🟢 **-95%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 20.6M | ✅ | 2.6M | 🟢 **-87%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 24.8M | ✅ | 750K | 🟢 **-97%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 14.4M | ✅ | 444K | 🟢 **-97%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 15.7M | ✅ | 619K | 🟢 **-96%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 16.1M | ✅ | 1.3M | 🟢 **-92%** |
| properties.json | object properties validation | 6 | ✅ | 45.8M | ✅ | 771K | 🟢 **-98%** |
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 18.4M | ✅ | 574K | 🟢 **-97%** |
| properties.json | properties with escaped characters | 2 | ✅ | 38.7M | ✅ | 195K | 🟢 **-99%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 57.2M | ✅ | 1.8M | 🟢 **-97%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 25.8M | ❌ | - | - |
| ref.json | root pointer ref | 4 | ✅ | 22.6M | ✅ | 768K | 🟢 **-97%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 23.5M | ✅ | 715K | 🟢 **-97%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 46.5M | ✅ | 665K | 🟢 **-99%** |
| ref.json | escaped pointer ref | 6 | ✅ | 39.3M | ✅ | 701K | 🟢 **-98%** |
| ref.json | nested refs | 2 | ✅ | 35.0M | ✅ | 857K | 🟢 **-98%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 44.2M | ✅ | 829K | 🟢 **-98%** |
| ref.json | $ref prevents a sibling id from chang... | 2 | ✅ | 50.5M | ❌ | - | - |
| ref.json | remote ref, containing refs itself | 2 | ✅ | 12.0M | ✅ | 321K | 🟢 **-97%** |
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 44.3M | ✅ | 757K | 🟢 **-98%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 21.5M | ✅ | 726K | 🟢 **-97%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 5.4M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 44.2M | ✅ | 723K | 🟢 **-98%** |
| ref.json | Location-independent identifier | 2 | ✅ | 61.1M | ✅ | 904K | 🟢 **-99%** |
...
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 54.1M | ✅ | 904K | 🟢 **-98%** |
...
| required.json | required validation | 5 | ✅ | 53.2M | ✅ | 1.6M | 🟢 **-97%** |
| required.json | required default validation | 1 | ✅ | 66.8M | ✅ | 3.0M | 🟢 **-95%** |
| required.json | required with escaped characters | 2 | ✅ | 43.3M | ✅ | 594K | 🟢 **-99%** |
| required.json | required properties whose names are J... | 7 | ✅ | 25.3M | ❌ | - | - |
| type.json | integer type matches integers | 8 | ✅ | 48.9M | ✅ | 935K | 🟢 **-98%** |
| type.json | number type matches numbers | 9 | ✅ | 55.1M | ✅ | 1.1M | 🟢 **-98%** |
| type.json | string type matches strings | 9 | ✅ | 55.2M | ✅ | 1.1M | 🟢 **-98%** |
| type.json | object type matches objects | 7 | ✅ | 49.0M | ✅ | 952K | 🟢 **-98%** |
| type.json | array type matches arrays | 7 | ✅ | 52.2M | ✅ | 993K | 🟢 **-98%** |
| type.json | boolean type matches booleans | 10 | ✅ | 53.6M | ✅ | 1.0M | 🟢 **-98%** |
| type.json | null type matches only the null object | 10 | ✅ | 49.7M | ✅ | 916K | 🟢 **-98%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 53.4M | ✅ | 911K | 🟢 **-98%** |
| type.json | type as array with one item | 2 | ✅ | 60.6M | ✅ | 1.5M | 🟢 **-98%** |
| type.json | type: array or object | 5 | ✅ | 54.2M | ✅ | 898K | 🟢 **-98%** |
| type.json | type: array, object or null | 5 | ✅ | 57.3M | ✅ | 1.2M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 16.8M | ✅ | 1.1M | 🟢 **-93%** |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 29.8M | ✅ | 716K | 🟢 **-98%** |
| uniqueItems.json | uniqueItems with an array of items an... | 5 | ✅ | 17.9M | ✅ | 736K | 🟢 **-96%** |
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 63.9M | ✅ | 3.8M | 🟢 **-94%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 57.1M | ✅ | 1.3M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 53.9M | ✅ | 1.2M | 🟢 **-98%** |
| optional/bignum.json | integer | 2 | ✅ | 67.7M | ✅ | 2.3M | 🟢 **-97%** |
| optional/bignum.json | number | 2 | ✅ | 68.7M | ✅ | 2.3M | 🟢 **-97%** |
| optional/bignum.json | string | 1 | ✅ | 52.2M | ✅ | 1.1M | 🟢 **-98%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 63.3M | ✅ | 3.2M | 🟢 **-95%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 50.1M | ✅ | 852K | 🟢 **-98%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 63.3M | ✅ | 3.2M | 🟢 **-95%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 50.1M | ✅ | 806K | 🟢 **-98%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 25.7M | ✅ | 793K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 26.7M | ✅ | 849K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 24.5M | ✅ | 795K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 25.0M | ✅ | 789K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 25.6M | ✅ | 747K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 24.3M | ✅ | 1.0M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 23.7M | ✅ | 800K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 24.3M | ✅ | 796K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 30.3M | ✅ | 1.4M | 🟢 **-95%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 27.4M | ✅ | 691K | 🟢 **-97%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 16.3M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 14.4M | ✅ | 802K | 🟢 **-94%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 14.7M | ✅ | 880K | 🟢 **-94%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 25.3M | ✅ | 799K | 🟢 **-97%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 19.2M | ✅ | 646K | 🟢 **-97%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 18.7M | ✅ | 643K | 🟢 **-97%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 7.6M | ✅ | 631K | 🟢 **-92%** |
...
| optional/format/email.json | validation of e-mail addresses | 17 | ✅ | 17.8M | ✅ | 411K | 🟢 **-98%** |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 157.5M | ❌ | - | - |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 83.8M | ❌ | - | - |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 172.5M | ❌ | - | - |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 84.6M | ❌ | - | - |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 86.4M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 73.1M | ❌ | - | - |
| allOf.json | allOf | 4 | ✅ | 32.0M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 26.6M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 77.9M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 158.3M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 72.0M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 90.1M | ❌ | - | - |
| allOf.json | allOf with one empty schema | 1 | ✅ | 86.1M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.1M | ❌ | - | - |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 80.0M | ❌ | - | - |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 126.2M | ❌ | - | - |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 80.6M | ❌ | - | - |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 86.3M | ❌ | - | - |
| anyOf.json | anyOf | 4 | ✅ | 71.1M | ❌ | - | - |
| anyOf.json | anyOf with base schema | 3 | ✅ | 46.6M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 94.1M | ❌ | - | - |
...
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 87.0M | ❌ | - | - |
...
| contains.json | contains with null instance elements | 1 | ✅ | 32.9M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 111.0M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 55.5M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 61.3M | ❌ | - | - |
| definitions.json | validate definition against metaschema | 2 | ✅ | 9.9M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 58.4M | ❌ | - | - |
| dependencies.json | dependencies with empty array | 3 | ✅ | 96.8M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 115.8M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 46.2M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 123.1M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 14.3M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 124.2M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 68.5M | ❌ | - | - |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 160.5M | ❌ | - | - |
...
| items.json | single-form items with null instance ... | 1 | ✅ | 80.7M | ❌ | - | - |
| items.json | array-form items with null instance e... | 1 | ✅ | 128.2M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 67.2M | ❌ | - | - |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 69.8M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 158.4M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 64.5M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 101.6M | ❌ | - | - |
| oneOf.json | oneOf complex types | 4 | ✅ | 44.5M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 123.7M | ❌ | - | - |
| oneOf.json | oneOf with required | 4 | ✅ | 53.7M | ❌ | - | - |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 72.8M | ❌ | - | - |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 78.4M | ❌ | - | - |
...
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 19.8M | ❌ | - | - |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 110.9M | ❌ | - | - |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 172.3M | ❌ | - | - |
...
| required.json | required default validation | 1 | ✅ | 93.7M | ❌ | - | - |
| required.json | required with empty array | 1 | ✅ | 94.7M | ❌ | - | - |
...
| type.json | string type matches strings | 9 | ✅ | 70.0M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 59.9M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 64.3M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 67.4M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 66.2M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 65.4M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 78.8M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 73.8M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 79.2M | ❌ | - | - |
...
| optional/bignum.json | string | 1 | ✅ | 68.1M | ❌ | - | - |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 83.1M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 64.1M | ❌ | - | - |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 84.0M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 64.0M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 35.7M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 32.1M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.5M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 30.0M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 29.8M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 28.2M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 30.7M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 30.0M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 29.3M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 32.6M | ❌ | - | - |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 139.7M | ❌ | - | - |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 63.4M | ❌ | - | - |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 150.8M | ❌ | - | - |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 69.4M | ❌ | - | - |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 73.3M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 139.7M | ❌ | - | - |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 28.6M | ❌ | - | - |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 68.0M | ❌ | - | - |
| allOf.json | allOf | 4 | ✅ | 36.3M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 28.8M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 67.7M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 139.7M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 59.5M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 88.1M | ❌ | - | - |
| allOf.json | allOf with one empty schema | 1 | ✅ | 73.3M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 139.6M | ❌ | - | - |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 69.7M | ❌ | - | - |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 112.2M | ❌ | - | - |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 70.0M | ❌ | - | - |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 79.8M | ❌ | - | - |
| anyOf.json | anyOf | 4 | ✅ | 70.3M | ❌ | - | - |
| anyOf.json | anyOf with base schema | 3 | ✅ | 41.8M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 79.6M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 139.6M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 59.6M | ❌ | - | - |
| anyOf.json | anyOf complex types | 4 | ✅ | 67.0M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 75.6M | ❌ | - | - |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 112.3M | ❌ | - | - |
...
| contains.json | contains with null instance elements | 1 | ✅ | 116.8M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 33.1M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 36.2M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 49.5M | ❌ | - | - |
| definitions.json | validate definition against metaschema | 2 | ✅ | 11.0M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 57.6M | ❌ | - | - |
| dependencies.json | dependencies with empty array | 3 | ✅ | 83.8M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 67.7M | ❌ | - | - |
...
| enum.json | enum with escaped characters | 3 | ✅ | 32.3M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 59.2M | ❌ | - | - |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 82.3M | ❌ | - | - |
...
| items.json | single-form items with null instance ... | 1 | ✅ | 70.2M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 55.8M | ❌ | - | - |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 59.0M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 79.6M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 59.2M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 59.3M | ❌ | - | - |
| oneOf.json | oneOf complex types | 4 | ✅ | 39.1M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 68.0M | ❌ | - | - |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 24.7M | ❌ | - | - |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 82.5M | ❌ | - | - |
...
| required.json | required default validation | 1 | ✅ | 79.7M | ❌ | - | - |
| required.json | required with empty array | 1 | ✅ | 79.7M | ❌ | - | - |
...
| type.json | object type matches objects | 7 | ✅ | 50.5M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 56.1M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 57.4M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 57.0M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 57.6M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 68.4M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 57.9M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 61.6M | ❌ | - | - |
...
| optional/bignum.json | string | 1 | ✅ | 57.4M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 27.4M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 28.5M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 28.3M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 25.0M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 28.3M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 28.0M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 24.9M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 28.8M | ❌ | - | - |
...
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 164.0M | ❌ | - | - |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 70.1M | ❌ | - | - |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 56.0M | ✅ | 512K | 🟢 **-99%** |
...
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 27.7M | ✅ | 568K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 58.5M | ❌ | - | - |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 24.6M | ❌ | - | - |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 31.6M | ✅ | 533K | 🟢 **-98%** |
| allOf.json | allOf | 4 | ✅ | 37.4M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 31.0M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 63.2M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 153.0M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 58.2M | ✅ | 723K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 717K | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 76.7M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 136.8M | ❌ | - | - |
...
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 76.8M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 58.2M | ✅ | 685K | 🟢 **-99%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 46.0M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 72.0M | ❌ | - | - |
...
| contains.json | contains with null instance elements | 1 | ✅ | 67.4M | ❌ | - | - |
| content.json | validation of string-encoded content ... | 3 | ✅ | 79.9M | ❌ | - | - |
| content.json | validation of binary string-encoding | 3 | ✅ | 79.1M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 70.1M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 66.8M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 59.6M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 49.8M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 39.3M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 75.9M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 42.9M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 62.7M | ❌ | - | - |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 65.6M | ❌ | - | - |
...
| items.json | single-form items with null instance ... | 1 | ✅ | 65.9M | ❌ | - | - |
| items.json | array-form items with null instance e... | 1 | ✅ | 70.2M | ❌ | - | - |
| maxContains.json | maxContains without contains is ignored | 2 | ✅ | 78.8M | ❌ | - | - |
...
| minContains.json | minContains without contains is ignored | 2 | ✅ | 79.1M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 49.2M | ✅ | 639K | 🟢 **-99%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 52.1M | ✅ | 687K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 52.0M | ✅ | 710K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 55.2M | ✅ | 742K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 57.9M | ✅ | 676K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 76.7M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 58.3M | ✅ | 671K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 58.3M | ✅ | 670K | 🟢 **-99%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 41.0M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 66.0M | ❌ | - | - |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 24.1M | ❌ | - | - |
...
| ref.json | $ref to boolean schema false | 1 | ✅ | 58.2M | ✅ | 637K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.2M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 47.5M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 25.4M | ✅ | 538K | 🟢 **-98%** |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 66.2M | ❌ | - | - |
...
| required.json | required default validation | 1 | ✅ | 76.8M | ❌ | - | - |
| required.json | required with empty array | 1 | ✅ | 76.4M | ❌ | - | - |
...
| type.json | string type matches strings | 9 | ✅ | 59.3M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 52.8M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 55.3M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 58.1M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 54.2M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 57.0M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 66.7M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 58.0M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 61.9M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 37.7M | ✅ | 527K | 🟢 **-99%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 42.1M | ✅ | 588K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 39.2M | ✅ | 565K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 24.8M | ✅ | 477K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 26.8M | ✅ | 584K | 🟢 **-98%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 26.3M | ✅ | 585K | 🟢 **-98%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 24.8M | ✅ | 546K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 26.3M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 20.2M | ✅ | 520K | 🟢 **-97%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 24.0M | ✅ | 559K | 🟢 **-98%** |
...
| optional/bignum.json | string | 1 | ✅ | 56.5M | ✅ | 731K | 🟢 **-99%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 68.8M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 53.9M | ✅ | 724K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 68.8M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 53.9M | ✅ | 723K | 🟢 **-99%** |
...
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 80.0M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 27.7M | ❌ | - | - |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 55.0M | ✅ | 2.6M | 🟢 **-95%** |
| optional/non-bmp-regex.json | Proper UTF-16 surrogate pair handling... | 7 | ✅ | 29.0M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 29.8M | ✅ | 587K | 🟢 **-98%** |
...
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 31.3M | ✅ | 551K | 🟢 **-98%** |
...
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 66.1M | ✅ | 729K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 726K | 🟢 **-99%** |
...
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.8M | ❌ | - | - |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 62.1M | ❌ | - | - |
...
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 89.7M | ❌ | - | - |
...
| content.json | validation of binary string-encoding | 3 | ✅ | 78.9M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 83.4M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 77.5M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 71.5M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 54.9M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 56.1M | ❌ | - | - |
...
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 67.6M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 57.5M | ✅ | 663K | 🟢 **-99%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 57.8M | ✅ | 701K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 65.2M | ✅ | 733K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 64.1M | ✅ | 764K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 66.1M | ✅ | 698K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 90.0M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 66.1M | ✅ | 693K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 695K | 🟢 **-99%** |
...
| ref.json | $ref to boolean schema false | 1 | ✅ | 66.1M | ✅ | 664K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.6M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 54.0M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 28.1M | ✅ | 560K | 🟢 **-98%** |
...
| type.json | object type matches objects | 7 | ✅ | 59.1M | ❌ | - | - |
...
| type.json | type: array or object | 5 | ✅ | 70.8M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 40.9M | ✅ | 526K | 🟢 **-99%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 46.4M | ✅ | 605K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 42.1M | ✅ | 575K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 23.8M | ✅ | 504K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 30.3M | ✅ | 600K | 🟢 **-98%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 30.5M | ✅ | 599K | 🟢 **-98%** |
...
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 20.3M | ✅ | 562K | 🟢 **-97%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 24.4M | ✅ | 567K | 🟢 **-98%** |
...
| optional/bignum.json | string | 1 | ✅ | 63.5M | ✅ | 730K | 🟢 **-99%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 78.9M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 59.9M | ✅ | 726K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 78.9M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 60.0M | ✅ | 738K | 🟢 **-99%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 28.6M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 35.1M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 30.4M | ❌ | - | - |
...
| optional/format/ecmascript-regex.json | \a is not an ECMA 262 control escape | 1 | ✅ | 51.3M | ✅ | 737K | 🟢 **-99%** |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 65.8M | ✅ | 2.6M | 🟢 **-96%** |
