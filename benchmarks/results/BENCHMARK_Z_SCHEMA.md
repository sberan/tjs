...
|-------|-------:|---------:|----------:|-----------:|----------:|----------:|-----:|
| draft4 | 199 | 198/199 | 27.1M | 169/199 | 849K | 169 | 🟢 **-97%** |
| draft6 | 276 | ✅ 276 | 28.9M | 0/276 | - | 0 | - |
| draft7 | 313 | ✅ 313 | 16.0M | 0/313 | - | 0 | - |
| draft2019-09 | 435 | ✅ 435 | 19.3M | 28/435 | 676K | 28 | 🟢 **-97%** |
| draft2020-12 | 448 | ✅ 448 | 20.0M | 28/448 | 696K | 28 | 🟢 **-97%** |
| **Total** | 1671 | 1670/1671 | 20.4M | 225/1671 | 823K | 225 | 🟢 **-96%** |

## Head-to-Head Performance

Direct comparison using only test groups where **both** validators pass **all** tests. This ensures a fair comparison by excluding groups where either validator has incomplete or incorrect implementations.

**Result**: 🟢 **tjs** is **43.30x faster** (28 ns vs 1215 ns per test, 803 tests in 225 groups)
...
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 58.1M | ✅ | 678K | 🟢 **-99%** |
| additionalItems.json | when items is schema, additionalItems... | 1 | ✅ | 159.0M | ✅ | 1.6M | 🟢 **-99%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 132.6M | ✅ | 1.8M | 🟢 **-99%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 165.6M | ✅ | 3.2M | 🟢 **-98%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 129.0M | ✅ | 2.2M | 🟢 **-98%** |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 38.1M | ✅ | 384K | 🟢 **-99%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 53.4M | ✅ | 651K | 🟢 **-99%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 63.2M | ✅ | 1.3M | 🟢 **-98%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 147.4M | ✅ | 3.7M | 🟢 **-97%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 49.8M | ✅ | 1.1M | 🟢 **-98%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 46.1M | ✅ | 786K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 35.3M | ✅ | 766K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 50.1M | ✅ | 761K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.1M | ✅ | 1.4M | 🟢 **-99%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 39.3M | ✅ | 383K | 🟢 **-99%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 49.5M | ✅ | 1.8M | 🟢 **-96%** |
| allOf.json | allOf | 4 | ✅ | 70.1M | ✅ | 459K | 🟢 **-99%** |
| allOf.json | allOf with base schema | 5 | ✅ | 24.4M | ✅ | 389K | 🟢 **-98%** |
| allOf.json | allOf simple types | 2 | ✅ | 113.7M | ✅ | 891K | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 159.4M | ✅ | 3.4M | 🟢 **-98%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.4M | ✅ | 2.7M | 🟢 **-98%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 62.3M | ✅ | 915K | 🟢 **-99%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 115.7M | ✅ | 968K | 🟢 **-99%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 64.8M | ✅ | 938K | 🟢 **-99%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 82.7M | ✅ | 340K | 🟢 **-100%** |
| anyOf.json | anyOf | 4 | ✅ | 66.6M | ✅ | 661K | 🟢 **-99%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 50.5M | ✅ | 580K | 🟢 **-99%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 48.1M | ✅ | 391K | 🟢 **-99%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 171.4M | ✅ | 2.8M | 🟢 **-98%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 64.8M | ✅ | 643K | 🟢 **-99%** |
| default.json | invalid type for default | 2 | ✅ | 101.3M | ✅ | 2.1M | 🟢 **-98%** |
| default.json | invalid string value for default | 2 | ✅ | 52.6M | ✅ | 1.7M | 🟢 **-97%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 79.0M | ✅ | 863K | 🟢 **-99%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 12.0M | ✅ | 127K | 🟢 **-99%** |
| dependencies.json | dependencies | 7 | ✅ | 94.1M | ✅ | 1.8M | 🟢 **-98%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 30.9M | ✅ | 863K | 🟢 **-97%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 59.0M | ✅ | 468K | 🟢 **-99%** |
| dependencies.json | dependencies with escaped characters | 7 | ✅ | 18.3M | ✅ | 716K | 🟢 **-96%** |
| dependencies.json | dependent subschema incompatible with... | 4 | ✅ | 53.3M | ✅ | 797K | 🟢 **-99%** |
| enum.json | simple enum validation | 2 | ✅ | 63.5M | ✅ | 1.7M | 🟢 **-97%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 61.1M | ✅ | 846K | 🟢 **-99%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 66.8M | ✅ | 2.3M | 🟢 **-97%** |
| enum.json | enums in properties | 6 | ✅ | 50.0M | ✅ | 675K | 🟢 **-99%** |
| enum.json | enum with escaped characters | 3 | ✅ | 52.3M | ✅ | 2.2M | 🟢 **-96%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 110.9M | ✅ | 1.3M | 🟢 **-99%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 53.8M | ✅ | 1.1M | 🟢 **-98%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 100.5M | ✅ | 1.3M | 🟢 **-99%** |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 51.1M | ✅ | 1.1M | 🟢 **-98%** |
| enum.json | enum with 0 does not match false | 3 | ✅ | 114.4M | ✅ | 2.3M | 🟢 **-98%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 59.1M | ✅ | 1.5M | 🟢 **-97%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 112.4M | ✅ | 2.2M | 🟢 **-98%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 54.5M | ✅ | 1.9M | 🟢 **-97%** |
| enum.json | nul characters in strings | 2 | ✅ | 88.8M | ✅ | 2.0M | 🟢 **-98%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 50.4M | ✅ | 1.9M | 🟢 **-96%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 91.3M | ✅ | 1.9M | 🟢 **-98%** |
| format.json | email format | 6 | ✅ | 81.3M | ✅ | 3.4M | 🟢 **-96%** |
| format.json | ipv4 format | 6 | ✅ | 82.1M | ✅ | 3.3M | 🟢 **-96%** |
| format.json | ipv6 format | 6 | ✅ | 81.1M | ✅ | 3.2M | 🟢 **-96%** |
| format.json | hostname format | 6 | ✅ | 163.7M | ✅ | 3.2M | 🟢 **-98%** |
| format.json | date-time format | 6 | ✅ | 80.1M | ✅ | 3.2M | 🟢 **-96%** |
| format.json | uri format | 6 | ✅ | 161.4M | ✅ | 3.3M | 🟢 **-98%** |
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 45.7M | ✅ | 370K | 🟢 **-99%** |
| items.json | a schema given for items | 4 | ✅ | 89.1M | ✅ | 1.0M | 🟢 **-99%** |
| items.json | an array of schemas for items | 6 | ✅ | 63.8M | ✅ | 954K | 🟢 **-99%** |
| items.json | items and subitems | 6 | ✅ | 34.4M | ✅ | 244K | 🟢 **-99%** |
| items.json | nested items | 3 | ✅ | 13.3M | ✅ | 136K | 🟢 **-99%** |
| items.json | items with null instance elements | 1 | ✅ | 68.0M | ✅ | 2.2M | 🟢 **-97%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 82.9M | ✅ | 2.2M | 🟢 **-97%** |
| maxItems.json | maxItems validation | 4 | ✅ | 73.8M | ✅ | 1.9M | 🟢 **-97%** |
| maxLength.json | maxLength validation | 5 | ✅ | 59.0M | ✅ | 2.1M | 🟢 **-96%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 53.6M | ✅ | 1.7M | 🟢 **-97%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 42.6M | ✅ | 1.1M | 🟢 **-97%** |
| maximum.json | maximum validation | 4 | ✅ | 31.6M | ✅ | 1.6M | 🟢 **-95%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 62.2M | ✅ | 1.7M | 🟢 **-97%** |
| maximum.json | maximum validation (explicit false ex... | 4 | ✅ | 68.5M | ✅ | 1.5M | 🟢 **-98%** |
| maximum.json | exclusiveMaximum validation | 2 | ✅ | 59.4M | ✅ | 1.6M | 🟢 **-97%** |
| minItems.json | minItems validation | 4 | ✅ | 66.0M | ✅ | 1.9M | 🟢 **-97%** |
| minLength.json | minLength validation | 5 | ✅ | 51.8M | ✅ | 1.6M | 🟢 **-97%** |
| minProperties.json | minProperties validation | 6 | ✅ | 54.1M | ✅ | 2.0M | 🟢 **-96%** |
| minimum.json | minimum validation | 4 | ✅ | 66.4M | ✅ | 1.6M | 🟢 **-98%** |
| minimum.json | minimum validation (explicit false ex... | 4 | ✅ | 66.6M | ✅ | 1.5M | 🟢 **-98%** |
| minimum.json | exclusiveMinimum validation | 2 | ✅ | 28.9M | ✅ | 1.3M | 🟢 **-95%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 64.9M | ✅ | 1.8M | 🟢 **-97%** |
| multipleOf.json | by int | 3 | ✅ | 69.1M | ✅ | 1.4M | 🟢 **-98%** |
| multipleOf.json | by number | 3 | ✅ | 60.4M | ✅ | 1.3M | 🟢 **-98%** |
| multipleOf.json | by small number | 2 | ✅ | 48.7M | ✅ | 1.2M | 🟢 **-97%** |
| multipleOf.json | float division = inf | 1 | ✅ | 37.5M | ✅ | 773K | 🟢 **-98%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 68.9M | ✅ | 1.9M | 🟢 **-97%** |
| not.json | not | 2 | ✅ | 62.9M | ✅ | 845K | 🟢 **-99%** |
| not.json | not multiple types | 3 | ✅ | 51.4M | ✅ | 900K | 🟢 **-98%** |
| not.json | not more complex schema | 3 | ✅ | 58.2M | ✅ | 550K | 🟢 **-99%** |
| not.json | forbidden property | 2 | ✅ | 44.6M | ✅ | 902K | 🟢 **-98%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 49.1M | ✅ | 1.2M | 🟢 **-98%** |
| not.json | double negation | 1 | ✅ | 159.4M | ✅ | 1.3M | 🟢 **-99%** |
| oneOf.json | oneOf | 4 | ✅ | 50.6M | ✅ | 491K | 🟢 **-99%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 31.9M | ✅ | 601K | 🟢 **-98%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 40.0M | ✅ | 317K | 🟢 **-99%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 60.2M | ✅ | 777K | 🟢 **-99%** |
| oneOf.json | oneOf with required | 4 | ✅ | 41.2M | ✅ | 392K | 🟢 **-99%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 43.6M | ✅ | 379K | 🟢 **-99%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 62.3M | ✅ | 656K | 🟢 **-99%** |
| pattern.json | pattern validation | 8 | ✅ | 51.1M | ✅ | 2.1M | 🟢 **-96%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 48.1M | ✅ | 2.6M | 🟢 **-95%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 25.3M | ✅ | 765K | 🟢 **-97%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 15.2M | ✅ | 456K | 🟢 **-97%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 17.4M | ✅ | 653K | 🟢 **-96%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 16.2M | ✅ | 1.3M | 🟢 **-92%** |
| properties.json | object properties validation | 6 | ✅ | 49.9M | ✅ | 770K | 🟢 **-98%** |
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 19.9M | ✅ | 593K | 🟢 **-97%** |
| properties.json | properties with escaped characters | 2 | ✅ | 45.0M | ✅ | 188K | 🟢 **-100%** |
...
| ref.json | root pointer ref | 4 | ✅ | 24.0M | ✅ | 790K | 🟢 **-97%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 57.2M | ✅ | 751K | 🟢 **-99%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 47.1M | ✅ | 688K | 🟢 **-99%** |
| ref.json | escaped pointer ref | 6 | ✅ | 34.3M | ✅ | 732K | 🟢 **-98%** |
| ref.json | nested refs | 2 | ✅ | 47.7M | ✅ | 937K | 🟢 **-98%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 45.8M | ✅ | 882K | 🟢 **-98%** |
| ref.json | $ref prevents a sibling id from chang... | 2 | ✅ | 62.3M | ❌ | - | - |
| ref.json | remote ref, containing refs itself | 2 | ✅ | 26.5M | ✅ | 338K | 🟢 **-99%** |
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 46.9M | ✅ | 767K | 🟢 **-98%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 46.7M | ✅ | 720K | 🟢 **-98%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 11.1M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 46.8M | ✅ | 720K | 🟢 **-98%** |
| ref.json | Location-independent identifier | 2 | ✅ | 62.9M | ✅ | 929K | 🟢 **-99%** |
...
| ref.json | id with file URI still resolves point... | 2 | ✅ | 62.3M | ❌ | - | - |
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 62.3M | ✅ | 939K | 🟢 **-98%** |
...
| required.json | required validation | 5 | ✅ | 58.1M | ✅ | 1.7M | 🟢 **-97%** |
| required.json | required default validation | 1 | ✅ | 159.3M | ✅ | 3.0M | 🟢 **-98%** |
| required.json | required with escaped characters | 2 | ✅ | 44.5M | ✅ | 600K | 🟢 **-99%** |
| required.json | required properties whose names are J... | 7 | ✅ | 25.3M | ❌ | - | - |
| type.json | integer type matches integers | 8 | ✅ | 50.2M | ✅ | 906K | 🟢 **-98%** |
| type.json | number type matches numbers | 9 | ✅ | 55.0M | ✅ | 1.1M | 🟢 **-98%** |
| type.json | string type matches strings | 9 | ✅ | 54.7M | ✅ | 1.1M | 🟢 **-98%** |
| type.json | object type matches objects | 7 | ✅ | 46.1M | ✅ | 901K | 🟢 **-98%** |
| type.json | array type matches arrays | 7 | ✅ | 51.5M | ✅ | 900K | 🟢 **-98%** |
| type.json | boolean type matches booleans | 10 | ✅ | 51.7M | ✅ | 956K | 🟢 **-98%** |
| type.json | null type matches only the null object | 10 | ✅ | 48.8M | ✅ | 869K | 🟢 **-98%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 51.9M | ✅ | 863K | 🟢 **-98%** |
| type.json | type as array with one item | 2 | ✅ | 62.3M | ✅ | 1.4M | 🟢 **-98%** |
| type.json | type: array or object | 5 | ✅ | 55.7M | ✅ | 887K | 🟢 **-98%** |
| type.json | type: array, object or null | 5 | ✅ | 62.3M | ✅ | 1.2M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 17.4M | ✅ | 1.2M | 🟢 **-93%** |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 30.3M | ✅ | 717K | 🟢 **-98%** |
| uniqueItems.json | uniqueItems with an array of items an... | 5 | ✅ | 18.2M | ✅ | 704K | 🟢 **-96%** |
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 161.5M | ✅ | 3.7M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 76.2M | ✅ | 1.3M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 64.1M | ✅ | 1.1M | 🟢 **-98%** |
| optional/bignum.json | integer | 2 | ✅ | 79.9M | ✅ | 2.6M | 🟢 **-97%** |
| optional/bignum.json | number | 2 | ✅ | 84.1M | ✅ | 2.6M | 🟢 **-97%** |
| optional/bignum.json | string | 1 | ✅ | 47.7M | ✅ | 1.0M | 🟢 **-98%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 77.0M | ✅ | 3.4M | 🟢 **-96%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 45.6M | ✅ | 851K | 🟢 **-98%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 77.0M | ✅ | 3.5M | 🟢 **-95%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 45.6M | ✅ | 871K | 🟢 **-98%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 52.8M | ✅ | 788K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 25.2M | ✅ | 785K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 26.7M | ✅ | 821K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 24.9M | ✅ | 813K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 15.8M | ✅ | 721K | 🟢 **-95%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 25.3M | ✅ | 1.0M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 26.7M | ✅ | 785K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 26.4M | ✅ | 801K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.1M | ✅ | 1.3M | 🟢 **-95%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 24.3M | ✅ | 637K | 🟢 **-97%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 16.6M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 14.6M | ✅ | 788K | 🟢 **-95%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 14.5M | ✅ | 876K | 🟢 **-94%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 26.2M | ✅ | 775K | 🟢 **-97%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 20.6M | ✅ | 645K | 🟢 **-97%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 20.1M | ✅ | 686K | 🟢 **-97%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 8.0M | ✅ | 650K | 🟢 **-92%** |
...
| optional/format/email.json | validation of e-mail addresses | 17 | ✅ | 18.2M | ✅ | 411K | 🟢 **-98%** |
| optional/format/hostname.json | validation of host names | 27 | ✅ | 10.8M | ✅ | 1.0M | 🟢 **-91%** |
| optional/format/ipv4.json | validation of IP addresses | 16 | ✅ | 34.4M | ✅ | 1.1M | 🟢 **-97%** |
...
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 147.4M | ❌ | - | - |
...
| default.json | invalid string value for default | 2 | ✅ | 50.9M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 59.9M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 61.3M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 63.2M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 56.6M | ❌ | - | - |
...
| items.json | single-form items with null instance ... | 1 | ✅ | 44.3M | ❌ | - | - |
| items.json | array-form items with null instance e... | 1 | ✅ | 78.8M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 42.9M | ❌ | - | - |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 46.9M | ❌ | - | - |
...
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 58.6M | ❌ | - | - |
| pattern.json | pattern validation | 8 | ✅ | 49.2M | ❌ | - | - |
| pattern.json | pattern is not anchored | 1 | ✅ | 45.8M | ❌ | - | - |
...
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 17.2M | ❌ | - | - |
...
| type.json | array type matches arrays | 7 | ✅ | 48.3M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 48.6M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 45.7M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 48.6M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 58.9M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 52.6M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 58.9M | ❌ | - | - |
...
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 73.4M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 43.1M | ❌ | - | - |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 73.5M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 43.1M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 50.8M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 24.5M | ❌ | - | - |
...
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 171.2M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 157.9M | ❌ | - | - |
...
| allOf.json | allOf with the first empty schema | 2 | ✅ | 115.7M | ❌ | - | - |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 62.3M | ❌ | - | - |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 85.0M | ❌ | - | - |
...
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 64.5M | ❌ | - | - |
...
| dependencies.json | dependencies with empty array | 3 | ✅ | 175.7M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 62.3M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 60.8M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 67.1M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 55.1M | ❌ | - | - |
...
| type.json | array type matches arrays | 7 | ✅ | 51.1M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 47.7M | ❌ | - | - |
...
| type.json | type: array, object or null | 5 | ✅ | 63.0M | ❌ | - | - |
...
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 66.6M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 25.8M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 25.0M | ❌ | - | - |
...
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 171.9M | ❌ | - | - |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 68.5M | ❌ | - | - |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 56.8M | ✅ | 506K | 🟢 **-99%** |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.1M | ❌ | - | - |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 27.1M | ✅ | 566K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 66.7M | ❌ | - | - |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 13.7M | ❌ | - | - |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 19.1M | ✅ | 536K | 🟢 **-97%** |
...
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 49.2M | ✅ | 705K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 707K | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 146.5M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 147.0M | ❌ | - | - |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 60.4M | ❌ | - | - |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 115.7M | ❌ | - | - |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 59.4M | ❌ | - | - |
...
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 49.3M | ✅ | 690K | 🟢 **-99%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 47.5M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 162.1M | ❌ | - | - |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 59.5M | ❌ | - | - |
...
| contains.json | contains with null instance elements | 1 | ✅ | 80.8M | ❌ | - | - |
| content.json | validation of string-encoded content ... | 3 | ✅ | 176.6M | ❌ | - | - |
| content.json | validation of binary string-encoding | 3 | ✅ | 175.6M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 178.5M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 184.0M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 68.0M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 47.4M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 47.9M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 54.5M | ❌ | - | - |
...
| items.json | single-form items with null instance ... | 1 | ✅ | 76.2M | ❌ | - | - |
| items.json | array-form items with null instance e... | 1 | ✅ | 83.0M | ❌ | - | - |
...
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 67.6M | ❌ | - | - |
| minContains.json | minContains without contains is ignored | 2 | ✅ | 165.0M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 43.5M | ✅ | 651K | 🟢 **-99%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 42.7M | ✅ | 706K | 🟢 **-98%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 49.0M | ✅ | 724K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 49.2M | ✅ | 752K | 🟢 **-98%** |
| not.json | allow everything with boolean schema ... | 9 | ✅ | 178.0M | ❌ | - | - |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 49.3M | ✅ | 685K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 159.1M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 49.8M | ✅ | 686K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 49.9M | ✅ | 687K | 🟢 **-99%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 40.3M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 60.2M | ❌ | - | - |
| oneOf.json | oneOf with required | 4 | ✅ | 40.5M | ❌ | - | - |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 43.5M | ❌ | - | - |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 56.9M | ❌ | - | - |
...
| ref.json | $ref to boolean schema false | 1 | ✅ | 49.0M | ✅ | 654K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 9.1M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 41.4M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 26.9M | ✅ | 566K | 🟢 **-98%** |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 62.3M | ❌ | - | - |
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 60.5M | ❌ | - | - |
...
| type.json | string type matches strings | 9 | ✅ | 54.6M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 45.4M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 51.0M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 51.8M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 48.7M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 35.2M | ✅ | 530K | 🟢 **-98%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 39.0M | ✅ | 597K | 🟢 **-98%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 36.0M | ✅ | 567K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 27.0M | ✅ | 479K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 27.2M | ✅ | 588K | 🟢 **-98%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 28.9M | ✅ | 592K | 🟢 **-98%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 26.2M | ✅ | 559K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 28.1M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 21.1M | ✅ | 527K | 🟢 **-97%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 23.6M | ✅ | 569K | 🟢 **-98%** |
...
| optional/bignum.json | integer | 2 | ✅ | 79.9M | ❌ | - | - |
| optional/bignum.json | number | 2 | ✅ | 84.2M | ❌ | - | - |
| optional/bignum.json | string | 1 | ✅ | 47.7M | ✅ | 737K | 🟢 **-98%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 76.8M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 53.3M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 25.2M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 27.6M | ❌ | - | - |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 58.4M | ✅ | 2.5M | 🟢 **-96%** |
...
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 33.1M | ❌ | - | - |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 154.5M | ❌ | - | - |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 28.7M | ✅ | 586K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 66.7M | ❌ | - | - |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 31.0M | ❌ | - | - |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 37.2M | ✅ | 547K | 🟢 **-99%** |
| allOf.json | allOf | 4 | ✅ | 34.8M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 28.3M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 68.9M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 153.4M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 49.8M | ✅ | 725K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.1M | ✅ | 720K | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 153.6M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 141.9M | ❌ | - | - |
...
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 153.9M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 153.8M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 46.5M | ✅ | 697K | 🟢 **-99%** |
...
| contains.json | contains with null instance elements | 1 | ✅ | 80.9M | ❌ | - | - |
| content.json | validation of string-encoded content ... | 3 | ✅ | 169.8M | ❌ | - | - |
| content.json | validation of binary string-encoding | 3 | ✅ | 170.0M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 173.4M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 178.4M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 68.0M | ❌ | - | - |
...
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 73.3M | ❌ | - | - |
...
| maxContains.json | maxContains without contains is ignored | 2 | ✅ | 163.4M | ❌ | - | - |
...
| maximum.json | maximum validation | 4 | ✅ | 68.9M | ❌ | - | - |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 67.6M | ❌ | - | - |
| minContains.json | minContains without contains is ignored | 2 | ✅ | 151.1M | ❌ | - | - |
| minContains.json | minContains=1 with contains | 5 | ✅ | 58.2M | ❌ | - | - |
| minContains.json | minContains=2 with contains | 6 | ✅ | 55.1M | ❌ | - | - |
| minContains.json | minContains=2 with contains with a de... | 2 | ✅ | 58.4M | ❌ | - | - |
| minContains.json | maxContains = minContains | 4 | ✅ | 47.4M | ❌ | - | - |
| minContains.json | maxContains < minContains | 4 | ✅ | 43.4M | ✅ | 671K | 🟢 **-98%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 43.2M | ✅ | 718K | 🟢 **-98%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 68.9M | ❌ | - | - |
| not.json | not | 2 | ✅ | 62.9M | ❌ | - | - |
| not.json | not multiple types | 3 | ✅ | 51.7M | ❌ | - | - |
| not.json | not more complex schema | 3 | ✅ | 57.7M | ❌ | - | - |
| not.json | forbidden property | 2 | ✅ | 46.1M | ❌ | - | - |
| not.json | forbid everything with empty schema | 9 | ✅ | 48.6M | ✅ | 733K | 🟢 **-98%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 48.5M | ✅ | 760K | 🟢 **-98%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 49.8M | ✅ | 697K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 153.1M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 49.8M | ✅ | 698K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 49.3M | ✅ | 699K | 🟢 **-99%** |
...
| prefixItems.json | prefixItems with null instance elements | 1 | ✅ | 82.8M | ❌ | - | - |
...
| propertyNames.json | propertyNames validation with pattern | 3 | ✅ | 19.5M | ❌ | - | - |
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 165.4M | ❌ | - | - |
...
| ref.json | $ref to boolean schema false | 1 | ✅ | 49.8M | ✅ | 659K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 9.2M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 46.6M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 27.5M | ✅ | 560K | 🟢 **-98%** |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 62.3M | ❌ | - | - |
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 61.0M | ❌ | - | - |
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 62.3M | ❌ | - | - |
...
| required.json | required default validation | 1 | ✅ | 153.3M | ❌ | - | - |
| required.json | required with empty array | 1 | ✅ | 152.7M | ❌ | - | - |
| required.json | required with escaped characters | 2 | ✅ | 44.5M | ❌ | - | - |
...
| type.json | type as array with one item | 2 | ✅ | 62.3M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 55.5M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 67.2M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with oneOf | 2 | ✅ | 15.9M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 35.2M | ✅ | 537K | 🟢 **-98%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 39.0M | ✅ | 609K | 🟢 **-98%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 35.9M | ✅ | 583K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 25.1M | ✅ | 510K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.3M | ✅ | 606K | 🟢 **-98%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.3M | ✅ | 605K | 🟢 **-98%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 25.9M | ✅ | 583K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 27.7M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 20.6M | ✅ | 570K | 🟢 **-97%** |
...
| unevaluatedProperties.json | dependentSchemas with unevaluatedProp... | 3 | ✅ | 22.1M | ❌ | - | - |
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 24.8M | ✅ | 574K | 🟢 **-98%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 17.1M | ❌ | - | - |
...
| optional/bignum.json | integer | 2 | ✅ | 79.9M | ❌ | - | - |
| optional/bignum.json | number | 2 | ✅ | 84.2M | ❌ | - | - |
| optional/bignum.json | string | 1 | ✅ | 47.7M | ✅ | 747K | 🟢 **-98%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 77.0M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 45.6M | ✅ | 747K | 🟢 **-98%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 77.0M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 45.6M | ✅ | 747K | 🟢 **-98%** |
...
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 169.7M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 24.1M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 26.4M | ❌ | - | - |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 16.5M | ❌ | - | - |
...
| optional/format/ecmascript-regex.json | \a is not an ECMA 262 control escape | 1 | ✅ | 38.4M | ✅ | 755K | 🟢 **-98%** |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 59.9M | ✅ | 2.5M | 🟢 **-96%** |
