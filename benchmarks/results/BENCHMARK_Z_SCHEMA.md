...
|-------|-------:|---------:|----------:|-----------:|----------:|----------:|-----:|
| draft4 | 199 | 198/199 | 29.3M | 169/199 | 838K | 169 | 🟢 **-97%** |
| draft6 | 276 | ✅ 276 | 33.2M | 0/276 | - | 0 | - |
| draft7 | 313 | ✅ 313 | 16.5M | 0/313 | - | 0 | - |
| draft2019-09 | 435 | ✅ 435 | 20.7M | 28/435 | 670K | 28 | 🟢 **-97%** |
| draft2020-12 | 448 | ✅ 448 | 20.9M | 28/448 | 534K | 28 | 🟢 **-97%** |
| **Total** | 1671 | 1670/1671 | 21.6M | 225/1671 | 795K | 225 | 🟢 **-96%** |

## Head-to-Head Performance

Direct comparison using only test groups where **both** validators pass **all** tests. This ensures a fair comparison by excluding groups where either validator has incomplete or incorrect implementations.

**Result**: 🟢 **tjs** is **49.70x faster** (25 ns vs 1258 ns per test, 803 tests in 225 groups)
...
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 60.9M | ✅ | 613K | 🟢 **-99%** |
| additionalItems.json | when items is schema, additionalItems... | 1 | ✅ | 146.8M | ✅ | 1.7M | 🟢 **-99%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 123.0M | ✅ | 1.7M | 🟢 **-99%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 171.4M | ✅ | 3.2M | 🟢 **-98%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 124.5M | ✅ | 2.2M | 🟢 **-98%** |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 46.3M | ✅ | 341K | 🟢 **-99%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 54.3M | ✅ | 632K | 🟢 **-99%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 72.8M | ✅ | 1.2M | 🟢 **-98%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 159.3M | ✅ | 3.4M | 🟢 **-98%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 53.0M | ✅ | 1.1M | 🟢 **-98%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 50.0M | ✅ | 821K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 38.2M | ✅ | 825K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 51.5M | ✅ | 789K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 158.7M | ✅ | 1.5M | 🟢 **-99%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 39.8M | ✅ | 386K | 🟢 **-99%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 51.7M | ✅ | 1.7M | 🟢 **-97%** |
| allOf.json | allOf | 4 | ✅ | 49.3M | ✅ | 455K | 🟢 **-99%** |
| allOf.json | allOf with base schema | 5 | ✅ | 27.3M | ✅ | 387K | 🟢 **-99%** |
| allOf.json | allOf simple types | 2 | ✅ | 109.9M | ✅ | 1.1M | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 158.2M | ✅ | 3.0M | 🟢 **-98%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.3M | ✅ | 2.6M | 🟢 **-98%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 77.1M | ✅ | 963K | 🟢 **-99%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.8M | ✅ | 920K | 🟢 **-99%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 78.6M | ✅ | 939K | 🟢 **-99%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 84.1M | ✅ | 346K | 🟢 **-100%** |
| anyOf.json | anyOf | 4 | ✅ | 81.9M | ✅ | 658K | 🟢 **-99%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 50.9M | ✅ | 558K | 🟢 **-99%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 51.4M | ✅ | 381K | 🟢 **-99%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 171.7M | ✅ | 2.7M | 🟢 **-98%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 78.7M | ✅ | 642K | 🟢 **-99%** |
| default.json | invalid type for default | 2 | ✅ | 107.7M | ✅ | 2.1M | 🟢 **-98%** |
| default.json | invalid string value for default | 2 | ✅ | 55.0M | ✅ | 1.6M | 🟢 **-97%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 79.9M | ✅ | 881K | 🟢 **-99%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 13.1M | ✅ | 127K | 🟢 **-99%** |
| dependencies.json | dependencies | 7 | ✅ | 100.1M | ✅ | 1.8M | 🟢 **-98%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 34.1M | ✅ | 838K | 🟢 **-98%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 59.8M | ✅ | 454K | 🟢 **-99%** |
| dependencies.json | dependencies with escaped characters | 7 | ✅ | 19.6M | ✅ | 721K | 🟢 **-96%** |
| dependencies.json | dependent subschema incompatible with... | 4 | ✅ | 54.0M | ✅ | 789K | 🟢 **-99%** |
| enum.json | simple enum validation | 2 | ✅ | 88.8M | ✅ | 1.5M | 🟢 **-98%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 60.9M | ✅ | 785K | 🟢 **-99%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 74.7M | ✅ | 2.2M | 🟢 **-97%** |
| enum.json | enums in properties | 6 | ✅ | 48.5M | ✅ | 641K | 🟢 **-99%** |
| enum.json | enum with escaped characters | 3 | ✅ | 60.9M | ✅ | 2.0M | 🟢 **-97%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 113.1M | ✅ | 1.2M | 🟢 **-99%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 66.4M | ✅ | 1.0M | 🟢 **-98%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 111.0M | ✅ | 1.2M | 🟢 **-99%** |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 65.5M | ✅ | 1.0M | 🟢 **-98%** |
| enum.json | enum with 0 does not match false | 3 | ✅ | 114.4M | ✅ | 2.1M | 🟢 **-98%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 68.7M | ✅ | 1.4M | 🟢 **-98%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 111.8M | ✅ | 1.8M | 🟢 **-98%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 68.2M | ✅ | 1.4M | 🟢 **-98%** |
| enum.json | nul characters in strings | 2 | ✅ | 91.3M | ✅ | 1.9M | 🟢 **-98%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 58.4M | ✅ | 1.7M | 🟢 **-97%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 94.0M | ✅ | 1.8M | 🟢 **-98%** |
| format.json | email format | 6 | ✅ | 91.8M | ✅ | 3.3M | 🟢 **-96%** |
| format.json | ipv4 format | 6 | ✅ | 163.1M | ✅ | 3.0M | 🟢 **-98%** |
| format.json | ipv6 format | 6 | ✅ | 92.5M | ✅ | 3.0M | 🟢 **-97%** |
| format.json | hostname format | 6 | ✅ | 134.0M | ✅ | 3.0M | 🟢 **-98%** |
| format.json | date-time format | 6 | ✅ | 92.9M | ✅ | 3.0M | 🟢 **-97%** |
| format.json | uri format | 6 | ✅ | 162.7M | ✅ | 3.0M | 🟢 **-98%** |
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 46.6M | ✅ | 359K | 🟢 **-99%** |
| items.json | a schema given for items | 4 | ✅ | 94.2M | ✅ | 999K | 🟢 **-99%** |
| items.json | an array of schemas for items | 6 | ✅ | 66.8M | ✅ | 933K | 🟢 **-99%** |
| items.json | items and subitems | 6 | ✅ | 35.4M | ✅ | 239K | 🟢 **-99%** |
| items.json | nested items | 3 | ✅ | 13.9M | ✅ | 133K | 🟢 **-99%** |
| items.json | items with null instance elements | 1 | ✅ | 75.3M | ✅ | 2.1M | 🟢 **-97%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 79.0M | ✅ | 2.1M | 🟢 **-97%** |
| maxItems.json | maxItems validation | 4 | ✅ | 81.0M | ✅ | 1.8M | 🟢 **-98%** |
| maxLength.json | maxLength validation | 5 | ✅ | 66.9M | ✅ | 2.0M | 🟢 **-97%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 58.1M | ✅ | 1.6M | 🟢 **-97%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 51.4M | ✅ | 1.0M | 🟢 **-98%** |
| maximum.json | maximum validation | 4 | ✅ | 76.9M | ✅ | 1.5M | 🟢 **-98%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 75.7M | ✅ | 1.6M | 🟢 **-98%** |
| maximum.json | maximum validation (explicit false ex... | 4 | ✅ | 76.9M | ✅ | 1.4M | 🟢 **-98%** |
| maximum.json | exclusiveMaximum validation | 2 | ✅ | 70.4M | ✅ | 1.6M | 🟢 **-98%** |
| minItems.json | minItems validation | 4 | ✅ | 81.2M | ✅ | 1.8M | 🟢 **-98%** |
| minLength.json | minLength validation | 5 | ✅ | 57.9M | ✅ | 1.5M | 🟢 **-97%** |
| minProperties.json | minProperties validation | 6 | ✅ | 59.7M | ✅ | 1.9M | 🟢 **-97%** |
| minimum.json | minimum validation | 4 | ✅ | 78.7M | ✅ | 1.5M | 🟢 **-98%** |
| minimum.json | minimum validation (explicit false ex... | 4 | ✅ | 76.9M | ✅ | 1.4M | 🟢 **-98%** |
| minimum.json | exclusiveMinimum validation | 2 | ✅ | 61.3M | ✅ | 1.4M | 🟢 **-98%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 71.8M | ✅ | 1.7M | 🟢 **-98%** |
| multipleOf.json | by int | 3 | ✅ | 77.4M | ✅ | 1.4M | 🟢 **-98%** |
| multipleOf.json | by number | 3 | ✅ | 73.3M | ✅ | 1.2M | 🟢 **-98%** |
| multipleOf.json | by small number | 2 | ✅ | 66.8M | ✅ | 829K | 🟢 **-99%** |
| multipleOf.json | float division = inf | 1 | ✅ | 57.8M | ✅ | 760K | 🟢 **-99%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 75.2M | ✅ | 1.9M | 🟢 **-97%** |
| not.json | not | 2 | ✅ | 91.3M | ✅ | 799K | 🟢 **-99%** |
| not.json | not multiple types | 3 | ✅ | 69.6M | ✅ | 875K | 🟢 **-99%** |
| not.json | not more complex schema | 3 | ✅ | 68.9M | ✅ | 530K | 🟢 **-99%** |
| not.json | forbidden property | 2 | ✅ | 54.4M | ✅ | 853K | 🟢 **-98%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 60.3M | ✅ | 1.1M | 🟢 **-98%** |
| not.json | double negation | 1 | ✅ | 159.3M | ✅ | 1.4M | 🟢 **-99%** |
| oneOf.json | oneOf | 4 | ✅ | 77.1M | ✅ | 458K | 🟢 **-99%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 37.2M | ✅ | 559K | 🟢 **-98%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 44.9M | ✅ | 299K | 🟢 **-99%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 76.1M | ✅ | 732K | 🟢 **-99%** |
| oneOf.json | oneOf with required | 4 | ✅ | 48.6M | ✅ | 369K | 🟢 **-99%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 49.6M | ✅ | 373K | 🟢 **-99%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 76.2M | ✅ | 656K | 🟢 **-99%** |
| pattern.json | pattern validation | 8 | ✅ | 56.5M | ✅ | 2.1M | 🟢 **-96%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 25.3M | ✅ | 2.5M | 🟢 **-90%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 26.1M | ✅ | 739K | 🟢 **-97%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 14.7M | ✅ | 445K | 🟢 **-97%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 18.7M | ✅ | 635K | 🟢 **-97%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 18.1M | ✅ | 1.3M | 🟢 **-93%** |
| properties.json | object properties validation | 6 | ✅ | 56.1M | ✅ | 741K | 🟢 **-99%** |
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 21.5M | ✅ | 576K | 🟢 **-97%** |
| properties.json | properties with escaped characters | 2 | ✅ | 52.1M | ✅ | 186K | 🟢 **-100%** |
...
| ref.json | root pointer ref | 4 | ✅ | 28.1M | ✅ | 766K | 🟢 **-97%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 54.6M | ✅ | 718K | 🟢 **-99%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 59.4M | ✅ | 675K | 🟢 **-99%** |
| ref.json | escaped pointer ref | 6 | ✅ | 47.4M | ✅ | 696K | 🟢 **-99%** |
| ref.json | nested refs | 2 | ✅ | 57.0M | ✅ | 889K | 🟢 **-98%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 55.1M | ✅ | 856K | 🟢 **-98%** |
| ref.json | $ref prevents a sibling id from chang... | 2 | ✅ | 77.1M | ❌ | - | - |
| ref.json | remote ref, containing refs itself | 2 | ✅ | 27.9M | ✅ | 330K | 🟢 **-99%** |
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 54.7M | ✅ | 731K | 🟢 **-99%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 54.7M | ✅ | 686K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 11.9M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 54.4M | ✅ | 708K | 🟢 **-99%** |
| ref.json | Location-independent identifier | 2 | ✅ | 77.1M | ✅ | 900K | 🟢 **-99%** |
...
| ref.json | id with file URI still resolves point... | 2 | ✅ | 77.1M | ❌ | - | - |
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 77.1M | ✅ | 906K | 🟢 **-99%** |
...
| required.json | required validation | 5 | ✅ | 64.9M | ✅ | 1.6M | 🟢 **-98%** |
| required.json | required default validation | 1 | ✅ | 159.3M | ✅ | 3.1M | 🟢 **-98%** |
| required.json | required with escaped characters | 2 | ✅ | 54.4M | ✅ | 489K | 🟢 **-99%** |
| required.json | required properties whose names are J... | 7 | ✅ | 27.0M | ❌ | - | - |
| type.json | integer type matches integers | 8 | ✅ | 64.6M | ✅ | 869K | 🟢 **-99%** |
| type.json | number type matches numbers | 9 | ✅ | 69.5M | ✅ | 1.0M | 🟢 **-99%** |
| type.json | string type matches strings | 9 | ✅ | 69.3M | ✅ | 1.0M | 🟢 **-99%** |
| type.json | object type matches objects | 7 | ✅ | 58.9M | ✅ | 864K | 🟢 **-99%** |
| type.json | array type matches arrays | 7 | ✅ | 64.6M | ✅ | 862K | 🟢 **-99%** |
| type.json | boolean type matches booleans | 10 | ✅ | 67.0M | ✅ | 929K | 🟢 **-99%** |
| type.json | null type matches only the null object | 10 | ✅ | 65.9M | ✅ | 838K | 🟢 **-99%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 66.3M | ✅ | 855K | 🟢 **-99%** |
| type.json | type as array with one item | 2 | ✅ | 76.9M | ✅ | 1.1M | 🟢 **-99%** |
| type.json | type: array or object | 5 | ✅ | 66.6M | ✅ | 877K | 🟢 **-99%** |
| type.json | type: array, object or null | 5 | ✅ | 74.3M | ✅ | 1.2M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 17.6M | ✅ | 1.2M | 🟢 **-93%** |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 33.8M | ✅ | 688K | 🟢 **-98%** |
| uniqueItems.json | uniqueItems with an array of items an... | 5 | ✅ | 19.0M | ✅ | 709K | 🟢 **-96%** |
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 161.2M | ✅ | 4.0M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 73.2M | ✅ | 1.3M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 72.3M | ✅ | 1.1M | 🟢 **-98%** |
| optional/bignum.json | integer | 2 | ✅ | 88.2M | ✅ | 2.6M | 🟢 **-97%** |
| optional/bignum.json | number | 2 | ✅ | 88.7M | ✅ | 2.6M | 🟢 **-97%** |
| optional/bignum.json | string | 1 | ✅ | 63.5M | ✅ | 1.0M | 🟢 **-98%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 78.8M | ✅ | 3.8M | 🟢 **-95%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 59.9M | ✅ | 838K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 78.9M | ✅ | 3.6M | 🟢 **-95%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 60.0M | ✅ | 850K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 64.6M | ✅ | 832K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 29.4M | ✅ | 840K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.4M | ✅ | 823K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 27.6M | ✅ | 831K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 29.9M | ✅ | 746K | 🟢 **-98%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 27.1M | ✅ | 1.0M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 29.6M | ✅ | 825K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 28.6M | ✅ | 831K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 25.9M | ✅ | 1.4M | 🟢 **-95%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 31.3M | ✅ | 669K | 🟢 **-98%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 15.2M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 15.2M | ✅ | 820K | 🟢 **-95%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 15.2M | ✅ | 921K | 🟢 **-94%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 29.5M | ✅ | 802K | 🟢 **-97%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 22.5M | ✅ | 645K | 🟢 **-97%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 22.7M | ✅ | 687K | 🟢 **-97%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 8.4M | ✅ | 661K | 🟢 **-92%** |
...
| optional/format/email.json | validation of e-mail addresses | 17 | ✅ | 18.4M | ✅ | 413K | 🟢 **-98%** |
| optional/format/hostname.json | validation of host names | 27 | ✅ | 10.7M | ✅ | 1.4M | 🟢 **-87%** |
| optional/format/ipv4.json | validation of IP addresses | 16 | ✅ | 38.8M | ✅ | 1.1M | 🟢 **-97%** |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 174.7M | ❌ | - | - |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 32.5M | ❌ | - | - |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 187.2M | ❌ | - | - |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 68.7M | ❌ | - | - |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 174.9M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 174.4M | ❌ | - | - |
...
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 174.6M | ❌ | - | - |
...
| allOf.json | allOf with two empty schemas | 1 | ✅ | 174.3M | ❌ | - | - |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 84.4M | ❌ | - | - |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 126.9M | ❌ | - | - |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 86.0M | ❌ | - | - |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 85.5M | ❌ | - | - |
| anyOf.json | anyOf | 4 | ✅ | 88.0M | ❌ | - | - |
| anyOf.json | anyOf with base schema | 3 | ✅ | 54.2M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 170.3M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 175.5M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 75.2M | ❌ | - | - |
| anyOf.json | anyOf complex types | 4 | ✅ | 79.2M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 190.4M | ❌ | - | - |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 128.9M | ❌ | - | - |
...
| contains.json | contains with null instance elements | 1 | ✅ | 88.5M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 113.3M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 59.7M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 85.3M | ❌ | - | - |
| definitions.json | validate definition against metaschema | 2 | ✅ | 11.2M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 97.6M | ❌ | - | - |
| dependencies.json | dependencies with empty array | 3 | ✅ | 197.9M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 82.8M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 67.1M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 82.4M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 59.5M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 87.8M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 97.0M | ❌ | - | - |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 187.4M | ❌ | - | - |
...
| items.json | single-form items with null instance ... | 1 | ✅ | 84.9M | ❌ | - | - |
| items.json | array-form items with null instance e... | 1 | ✅ | 79.9M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 69.2M | ❌ | - | - |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 76.3M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 99.6M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 75.6M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 75.6M | ❌ | - | - |
| oneOf.json | oneOf complex types | 4 | ✅ | 46.4M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 82.4M | ❌ | - | - |
| oneOf.json | oneOf with required | 4 | ✅ | 53.7M | ❌ | - | - |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 54.4M | ❌ | - | - |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 82.1M | ❌ | - | - |
| pattern.json | pattern validation | 8 | ✅ | 59.9M | ❌ | - | - |
| pattern.json | pattern is not anchored | 1 | ✅ | 16.6M | ❌ | - | - |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 78.4M | ❌ | - | - |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 182.9M | ❌ | - | - |
...
| required.json | required default validation | 1 | ✅ | 175.4M | ❌ | - | - |
...
| type.json | string type matches strings | 9 | ✅ | 73.0M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 62.7M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 67.5M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 70.6M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 65.1M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 69.6M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 84.3M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 79.3M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 84.0M | ❌ | - | - |
...
| optional/bignum.json | string | 1 | ✅ | 71.8M | ❌ | - | - |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 88.0M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 66.5M | ❌ | - | - |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 87.5M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 66.5M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 67.5M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 21.2M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 32.4M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 32.0M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 32.4M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 29.5M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 32.6M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 32.6M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 29.1M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 34.8M | ❌ | - | - |
...
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 75.1M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 68.7M | ❌ | - | - |
...
| allOf.json | allOf with one empty schema | 1 | ✅ | 146.9M | ❌ | - | - |
...
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 170.7M | ❌ | - | - |
...
| default.json | invalid type for default | 2 | ✅ | 64.2M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 67.9M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 47.7M | ❌ | - | - |
| definitions.json | validate definition against metaschema | 2 | ✅ | 12.3M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 62.6M | ❌ | - | - |
| dependencies.json | dependencies with empty array | 3 | ✅ | 176.6M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 52.6M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 46.3M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 71.1M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 43.0M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 70.7M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 62.0M | ❌ | - | - |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 62.9M | ❌ | - | - |
...
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 72.5M | ❌ | - | - |
...
| type.json | string type matches strings | 9 | ✅ | 65.4M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 56.5M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 61.1M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 61.9M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 57.8M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 63.3M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 73.1M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 65.1M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 29.3M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 28.8M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.7M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 31.2M | ❌ | - | - |
...
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 87.7M | ❌ | - | - |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 78.9M | ❌ | - | - |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 29.2M | ✅ | 507K | 🟢 **-98%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 42.7M | ❌ | - | - |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 107.7M | ❌ | - | - |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 158.3M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.4M | ❌ | - | - |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 31.2M | ✅ | 569K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 69.0M | ❌ | - | - |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 31.7M | ❌ | - | - |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 38.0M | ✅ | 538K | 🟢 **-99%** |
...
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 66.1M | ✅ | 702K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 701K | 🟢 **-99%** |
...
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 159.0M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 159.4M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 66.0M | ✅ | 691K | 🟢 **-99%** |
...
| content.json | validation of string-encoded content ... | 3 | ✅ | 172.7M | ❌ | - | - |
| content.json | validation of binary string-encoding | 3 | ✅ | 175.6M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 178.7M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 182.8M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 70.4M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 88.8M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 47.6M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 74.8M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 45.1M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 77.8M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 63.4M | ❌ | - | - |
...
| items.json | array-form items with null instance e... | 1 | ✅ | 79.0M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 57.3M | ✅ | 658K | 🟢 **-99%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 57.8M | ✅ | 693K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 59.8M | ✅ | 709K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 60.4M | ✅ | 741K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 66.1M | ✅ | 670K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 90.0M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 66.1M | ✅ | 667K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 670K | 🟢 **-99%** |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 24.3M | ❌ | - | - |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 70.1M | ❌ | - | - |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 170.9M | ❌ | - | - |
...
| ref.json | $ref to boolean schema false | 1 | ✅ | 66.1M | ✅ | 652K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 9.6M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 54.4M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 32.9M | ✅ | 564K | 🟢 **-98%** |
...
| required.json | required default validation | 1 | ✅ | 159.3M | ❌ | - | - |
...
| type.json | object type matches objects | 7 | ✅ | 56.3M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 64.6M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 66.5M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 63.8M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 65.9M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 91.2M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 87.7M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 88.6M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 42.1M | ✅ | 528K | 🟢 **-99%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 47.7M | ✅ | 588K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 43.7M | ✅ | 561K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 32.2M | ✅ | 480K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 35.3M | ✅ | 582K | 🟢 **-98%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 35.3M | ✅ | 583K | 🟢 **-98%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 31.2M | ✅ | 554K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 33.0M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 24.1M | ✅ | 526K | 🟢 **-98%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 29.8M | ✅ | 567K | 🟢 **-98%** |
...
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 59.9M | ✅ | 733K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 78.9M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 60.0M | ✅ | 730K | 🟢 **-99%** |
...
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 176.1M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 64.5M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 29.5M | ❌ | - | - |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 68.0M | ✅ | 2.7M | 🟢 **-96%** |
...
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 34.0M | ✅ | 437K | 🟢 **-99%** |
...
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 38.3M | ✅ | 432K | 🟢 **-99%** |
...
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 66.1M | ✅ | 513K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 483K | 🟢 **-99%** |
...
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 491K | 🟢 **-99%** |
...
| contains.json | contains with null instance elements | 1 | ✅ | 77.1M | ❌ | - | - |
| content.json | validation of string-encoded content ... | 3 | ✅ | 175.5M | ❌ | - | - |
| content.json | validation of binary string-encoding | 3 | ✅ | 176.3M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 179.6M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 175.8M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 70.3M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 54.8M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 53.5M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 38.0M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 44.0M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 64.1M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 45.2M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 40.7M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 61.1M | ❌ | - | - |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 71.1M | ❌ | - | - |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 71.1M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 58.8M | ✅ | 517K | 🟢 **-99%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 57.8M | ✅ | 523K | 🟢 **-99%** |
...
| not.json | forbidden property | 2 | ✅ | 54.4M | ❌ | - | - |
| not.json | forbid everything with empty schema | 9 | ✅ | 60.5M | ✅ | 569K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 60.7M | ✅ | 589K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 66.0M | ✅ | 505K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 89.9M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 66.1M | ✅ | 504K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 512K | 🟢 **-99%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 45.0M | ❌ | - | - |
...
| prefixItems.json | prefixItems with null instance elements | 1 | ✅ | 79.0M | ❌ | - | - |
| properties.json | object properties validation | 6 | ✅ | 56.2M | ❌ | - | - |
...
| ref.json | $ref to boolean schema true | 1 | ✅ | 159.4M | ❌ | - | - |
| ref.json | $ref to boolean schema false | 1 | ✅ | 66.1M | ✅ | 496K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 9.7M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 54.4M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 32.8M | ✅ | 437K | 🟢 **-99%** |
...
| type.json | string type matches strings | 9 | ✅ | 68.8M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 58.6M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 64.2M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 66.4M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 65.7M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 66.1M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 76.8M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 70.2M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 77.5M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems true | 2 | ✅ | 83.0M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems false | 2 | ✅ | 61.7M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 42.1M | ✅ | 422K | 🟢 **-99%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 47.7M | ✅ | 462K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 43.8M | ✅ | 443K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 28.7M | ✅ | 408K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 35.3M | ✅ | 456K | 🟢 **-99%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 35.3M | ✅ | 455K | 🟢 **-99%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 28.4M | ✅ | 491K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 32.3M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 23.1M | ✅ | 471K | 🟢 **-98%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 29.5M | ✅ | 444K | 🟢 **-98%** |
...
| optional/bignum.json | number | 2 | ✅ | 88.7M | ❌ | - | - |
| optional/bignum.json | string | 1 | ✅ | 63.5M | ✅ | 562K | 🟢 **-99%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 78.9M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 60.0M | ✅ | 543K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 78.9M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 59.9M | ✅ | 554K | 🟢 **-99%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 27.6M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 28.9M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 27.3M | ❌ | - | - |
...
| optional/format/duration.json | validation of duration strings | 26 | ✅ | 41.8M | ❌ | - | - |
| optional/format/ecmascript-regex.json | \a is not an ECMA 262 control escape | 1 | ✅ | 51.1M | ✅ | 556K | 🟢 **-99%** |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 68.0M | ✅ | 1.9M | 🟢 **-97%** |
