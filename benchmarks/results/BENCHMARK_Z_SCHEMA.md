...
|-------|-------:|---------:|----------:|-----------:|----------:|----------:|-----:|
| draft4 | 199 | 198/199 | 26.4M | 169/199 | 1.1M | 169 | 🟢 **-96%** |
| draft6 | 276 | ✅ 276 | 28.7M | 0/276 | - | 0 | - |
| draft7 | 313 | ✅ 313 | 15.6M | 0/313 | - | 0 | - |
| draft2019-09 | 435 | ✅ 435 | 18.6M | 28/435 | 526K | 28 | 🟢 **-97%** |
| draft2020-12 | 448 | ✅ 448 | 18.8M | 28/448 | 695K | 28 | 🟢 **-96%** |
| **Total** | 1671 | 1670/1671 | 19.7M | 225/1671 | 970K | 225 | 🟢 **-95%** |

## Head-to-Head Performance

Direct comparison using only test groups where **both** validators pass **all** tests. This ensures a fair comparison by excluding groups where either validator has incomplete or incorrect implementations.

**Result**: 🟢 **tjs** is **36.72x faster** (28 ns vs 1031 ns per test, 803 tests in 225 groups)
...
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 7.5M | ✅ | 882K | 🟢 **-88%** |
| additionalItems.json | when items is schema, additionalItems... | 1 | ✅ | 85.1M | ✅ | 1.8M | 🟢 **-98%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 144.6M | ✅ | 2.4M | 🟢 **-98%** |
...
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 44.4M | ✅ | 513K | 🟢 **-99%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 58.3M | ✅ | 867K | 🟢 **-99%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 69.6M | ✅ | 1.8M | 🟢 **-97%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 151.9M | ✅ | 3.5M | 🟢 **-98%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 38.7M | ✅ | 1.3M | 🟢 **-97%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 22.0M | ✅ | 1.1M | 🟢 **-95%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 34.9M | ✅ | 1.0M | 🟢 **-97%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 43.9M | ✅ | 1.1M | 🟢 **-98%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 77.1M | ✅ | 1.5M | 🟢 **-98%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 32.5M | ✅ | 498K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 50.9M | ✅ | 1.8M | 🟢 **-96%** |
| allOf.json | allOf | 4 | ✅ | 46.8M | ✅ | 556K | 🟢 **-99%** |
| allOf.json | allOf with base schema | 5 | ✅ | 26.8M | ✅ | 456K | 🟢 **-98%** |
| allOf.json | allOf simple types | 2 | ✅ | 109.9M | ✅ | 1.3M | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 85.2M | ✅ | 3.3M | 🟢 **-96%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 151.9M | ✅ | 2.6M | 🟢 **-98%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 73.4M | ✅ | 1.3M | 🟢 **-98%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.5M | ✅ | 1.3M | 🟢 **-99%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 74.5M | ✅ | 1.3M | 🟢 **-98%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 84.4M | ✅ | 509K | 🟢 **-99%** |
| anyOf.json | anyOf | 4 | ✅ | 76.0M | ✅ | 891K | 🟢 **-99%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 45.1M | ✅ | 830K | 🟢 **-98%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 48.0M | ✅ | 542K | 🟢 **-99%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 163.7M | ✅ | 2.9M | 🟢 **-98%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 74.6M | ✅ | 918K | 🟢 **-99%** |
| default.json | invalid type for default | 2 | ✅ | 107.6M | ✅ | 2.1M | 🟢 **-98%** |
| default.json | invalid string value for default | 2 | ✅ | 52.7M | ✅ | 2.0M | 🟢 **-96%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 77.2M | ✅ | 1.1M | 🟢 **-99%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 12.3M | ✅ | 146K | 🟢 **-99%** |
| dependencies.json | dependencies | 7 | ✅ | 90.8M | ✅ | 2.3M | 🟢 **-97%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 33.2M | ✅ | 1.2M | 🟢 **-96%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 31.7M | ✅ | 564K | 🟢 **-98%** |
| dependencies.json | dependencies with escaped characters | 7 | ✅ | 18.5M | ✅ | 931K | 🟢 **-95%** |
| dependencies.json | dependent subschema incompatible with... | 4 | ✅ | 45.7M | ✅ | 1.0M | 🟢 **-98%** |
| enum.json | simple enum validation | 2 | ✅ | 71.9M | ✅ | 1.9M | 🟢 **-97%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 60.6M | ✅ | 1.0M | 🟢 **-98%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 71.1M | ✅ | 2.4M | 🟢 **-97%** |
| enum.json | enums in properties | 6 | ✅ | 14.9M | ✅ | 813K | 🟢 **-95%** |
| enum.json | enum with escaped characters | 3 | ✅ | 57.4M | ✅ | 2.3M | 🟢 **-96%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 106.5M | ✅ | 1.8M | 🟢 **-98%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 61.6M | ✅ | 1.4M | 🟢 **-98%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 57.8M | ✅ | 1.8M | 🟢 **-97%** |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 31.7M | ✅ | 1.4M | 🟢 **-96%** |
| enum.json | enum with 0 does not match false | 3 | ✅ | 114.3M | ✅ | 2.4M | 🟢 **-98%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 63.5M | ✅ | 1.9M | 🟢 **-97%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 104.7M | ✅ | 2.4M | 🟢 **-98%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 63.3M | ✅ | 1.9M | 🟢 **-97%** |
...
| format.json | email format | 6 | ✅ | 79.6M | ✅ | 3.5M | 🟢 **-96%** |
| format.json | ipv4 format | 6 | ✅ | 162.5M | ✅ | 3.2M | 🟢 **-98%** |
| format.json | ipv6 format | 6 | ✅ | 79.4M | ✅ | 3.2M | 🟢 **-96%** |
| format.json | hostname format | 6 | ✅ | 134.1M | ✅ | 3.2M | 🟢 **-98%** |
| format.json | date-time format | 6 | ✅ | 82.8M | ✅ | 3.2M | 🟢 **-96%** |
| format.json | uri format | 6 | ✅ | 133.5M | ✅ | 3.2M | 🟢 **-98%** |
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 38.3M | ✅ | 444K | 🟢 **-99%** |
| items.json | a schema given for items | 4 | ✅ | 68.4M | ✅ | 1.2M | 🟢 **-98%** |
| items.json | an array of schemas for items | 6 | ✅ | 33.4M | ✅ | 1.2M | 🟢 **-96%** |
| items.json | items and subitems | 6 | ✅ | 13.4M | ✅ | 264K | 🟢 **-98%** |
| items.json | nested items | 3 | ✅ | 11.8M | ✅ | 153K | 🟢 **-99%** |
| items.json | items with null instance elements | 1 | ✅ | 72.0M | ✅ | 2.3M | 🟢 **-97%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 76.9M | ✅ | 2.5M | 🟢 **-97%** |
| maxItems.json | maxItems validation | 4 | ✅ | 74.5M | ✅ | 2.4M | 🟢 **-97%** |
| maxLength.json | maxLength validation | 5 | ✅ | 56.1M | ✅ | 2.5M | 🟢 **-96%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 55.1M | ✅ | 2.2M | 🟢 **-96%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 43.1M | ✅ | 1.6M | 🟢 **-96%** |
| maximum.json | maximum validation | 4 | ✅ | 66.4M | ✅ | 1.9M | 🟢 **-97%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 66.0M | ✅ | 2.0M | 🟢 **-97%** |
| maximum.json | maximum validation (explicit false ex... | 4 | ✅ | 72.6M | ✅ | 1.8M | 🟢 **-98%** |
| maximum.json | exclusiveMaximum validation | 2 | ✅ | 67.4M | ✅ | 1.6M | 🟢 **-98%** |
| minItems.json | minItems validation | 4 | ✅ | 73.7M | ✅ | 2.4M | 🟢 **-97%** |
| minLength.json | minLength validation | 5 | ✅ | 56.3M | ✅ | 2.0M | 🟢 **-96%** |
| minProperties.json | minProperties validation | 6 | ✅ | 57.3M | ✅ | 2.4M | 🟢 **-96%** |
| minimum.json | minimum validation | 4 | ✅ | 70.0M | ✅ | 1.9M | 🟢 **-97%** |
| minimum.json | minimum validation (explicit false ex... | 4 | ✅ | 70.8M | ✅ | 1.8M | 🟢 **-98%** |
| minimum.json | exclusiveMinimum validation | 2 | ✅ | 63.2M | ✅ | 1.4M | 🟢 **-98%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 69.0M | ✅ | 2.1M | 🟢 **-97%** |
| multipleOf.json | by int | 3 | ✅ | 74.0M | ✅ | 1.9M | 🟢 **-97%** |
| multipleOf.json | by number | 3 | ✅ | 67.1M | ✅ | 1.6M | 🟢 **-98%** |
| multipleOf.json | by small number | 2 | ✅ | 64.0M | ✅ | 1.3M | 🟢 **-98%** |
| multipleOf.json | float division = inf | 1 | ✅ | 55.8M | ✅ | 801K | 🟢 **-99%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 71.9M | ✅ | 1.9M | 🟢 **-97%** |
| not.json | not | 2 | ✅ | 73.4M | ✅ | 1.2M | 🟢 **-98%** |
| not.json | not multiple types | 3 | ✅ | 67.9M | ✅ | 1.1M | 🟢 **-98%** |
| not.json | not more complex schema | 3 | ✅ | 65.9M | ✅ | 717K | 🟢 **-99%** |
| not.json | forbidden property | 2 | ✅ | 49.5M | ✅ | 1.1M | 🟢 **-98%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 60.3M | ✅ | 1.5M | 🟢 **-98%** |
| not.json | double negation | 1 | ✅ | 85.2M | ✅ | 1.4M | 🟢 **-98%** |
| oneOf.json | oneOf | 4 | ✅ | 74.3M | ✅ | 653K | 🟢 **-99%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 33.3M | ✅ | 762K | 🟢 **-98%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 43.4M | ✅ | 431K | 🟢 **-99%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 72.4M | ✅ | 1.0M | 🟢 **-99%** |
| oneOf.json | oneOf with required | 4 | ✅ | 46.7M | ✅ | 540K | 🟢 **-99%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 57.4M | ✅ | 542K | 🟢 **-99%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 67.9M | ✅ | 896K | 🟢 **-99%** |
| pattern.json | pattern validation | 8 | ✅ | 54.0M | ✅ | 2.6M | 🟢 **-95%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 24.8M | ✅ | 2.6M | 🟢 **-89%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 25.5M | ✅ | 922K | 🟢 **-96%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 13.9M | ✅ | 527K | 🟢 **-96%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 14.0M | ✅ | 787K | 🟢 **-94%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 17.9M | ✅ | 1.3M | 🟢 **-92%** |
| properties.json | object properties validation | 6 | ✅ | 53.0M | ✅ | 970K | 🟢 **-98%** |
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 19.3M | ✅ | 703K | 🟢 **-96%** |
| properties.json | properties with escaped characters | 2 | ✅ | 48.8M | ✅ | 241K | 🟢 **-100%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 67.2M | ✅ | 1.8M | 🟢 **-97%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 27.9M | ❌ | - | - |
| ref.json | root pointer ref | 4 | ✅ | 25.3M | ✅ | 962K | 🟢 **-96%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 51.3M | ✅ | 929K | 🟢 **-98%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 55.6M | ✅ | 885K | 🟢 **-98%** |
| ref.json | escaped pointer ref | 6 | ✅ | 45.5M | ✅ | 899K | 🟢 **-98%** |
| ref.json | nested refs | 2 | ✅ | 38.2M | ✅ | 1.2M | 🟢 **-97%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 52.9M | ✅ | 1.0M | 🟢 **-98%** |
| ref.json | $ref prevents a sibling id from chang... | 2 | ✅ | 73.5M | ❌ | - | - |
| ref.json | remote ref, containing refs itself | 2 | ✅ | 24.5M | ✅ | 381K | 🟢 **-98%** |
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 52.1M | ✅ | 981K | 🟢 **-98%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 50.2M | ✅ | 929K | 🟢 **-98%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 11.0M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 50.5M | ✅ | 927K | 🟢 **-98%** |
| ref.json | Location-independent identifier | 2 | ✅ | 73.2M | ✅ | 1.3M | 🟢 **-98%** |
...
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 67.3M | ✅ | 1.3M | 🟢 **-98%** |
...
| required.json | required validation | 5 | ✅ | 62.4M | ✅ | 2.0M | 🟢 **-97%** |
| required.json | required default validation | 1 | ✅ | 85.2M | ✅ | 3.3M | 🟢 **-96%** |
| required.json | required with escaped characters | 2 | ✅ | 49.9M | ✅ | 785K | 🟢 **-98%** |
| required.json | required properties whose names are J... | 7 | ✅ | 26.0M | ❌ | - | - |
| type.json | integer type matches integers | 8 | ✅ | 60.7M | ✅ | 1.3M | 🟢 **-98%** |
| type.json | number type matches numbers | 9 | ✅ | 65.8M | ✅ | 1.5M | 🟢 **-98%** |
| type.json | string type matches strings | 9 | ✅ | 65.8M | ✅ | 1.5M | 🟢 **-98%** |
| type.json | object type matches objects | 7 | ✅ | 56.9M | ✅ | 1.3M | 🟢 **-98%** |
| type.json | array type matches arrays | 7 | ✅ | 61.2M | ✅ | 1.3M | 🟢 **-98%** |
| type.json | boolean type matches booleans | 10 | ✅ | 63.1M | ✅ | 1.4M | 🟢 **-98%** |
| type.json | null type matches only the null object | 10 | ✅ | 62.9M | ✅ | 1.3M | 🟢 **-98%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 63.6M | ✅ | 1.1M | 🟢 **-98%** |
| type.json | type as array with one item | 2 | ✅ | 71.4M | ✅ | 1.5M | 🟢 **-98%** |
| type.json | type: array or object | 5 | ✅ | 69.0M | ✅ | 1.2M | 🟢 **-98%** |
| type.json | type: array, object or null | 5 | ✅ | 73.4M | ✅ | 1.5M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 17.7M | ✅ | 1.6M | 🟢 **-91%** |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 31.7M | ✅ | 961K | 🟢 **-97%** |
| uniqueItems.json | uniqueItems with an array of items an... | 5 | ✅ | 18.9M | ✅ | 937K | 🟢 **-95%** |
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 86.1M | ✅ | 4.3M | 🟢 **-95%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 68.5M | ✅ | 1.5M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 69.3M | ✅ | 1.3M | 🟢 **-98%** |
| optional/bignum.json | integer | 2 | ✅ | 83.8M | ✅ | 2.7M | 🟢 **-97%** |
| optional/bignum.json | number | 2 | ✅ | 84.0M | ✅ | 2.6M | 🟢 **-97%** |
| optional/bignum.json | string | 1 | ✅ | 60.9M | ✅ | 1.1M | 🟢 **-98%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 75.2M | ✅ | 3.8M | 🟢 **-95%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 57.8M | ✅ | 914K | 🟢 **-98%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 75.2M | ✅ | 3.8M | 🟢 **-95%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 57.8M | ✅ | 912K | 🟢 **-98%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 27.8M | ✅ | 1.1M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 28.8M | ✅ | 1.1M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 27.8M | ✅ | 1.1M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 33.8M | ✅ | 1.1M | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 28.0M | ✅ | 956K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 23.3M | ✅ | 1.3M | 🟢 **-94%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 27.9M | ✅ | 1.1M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 27.7M | ✅ | 1.1M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 25.2M | ✅ | 1.6M | 🟢 **-94%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 29.5M | ✅ | 876K | 🟢 **-97%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 16.7M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 14.8M | ✅ | 1.2M | 🟢 **-92%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 15.1M | ✅ | 1.3M | 🟢 **-92%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 27.7M | ✅ | 1.1M | 🟢 **-96%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 20.0M | ✅ | 828K | 🟢 **-96%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 18.1M | ✅ | 831K | 🟢 **-95%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 7.6M | ✅ | 789K | 🟢 **-90%** |
...
| optional/format/email.json | validation of e-mail addresses | 17 | ✅ | 18.6M | ✅ | 462K | 🟢 **-98%** |
| optional/format/hostname.json | validation of host names | 27 | ✅ | 11.1M | ✅ | 1.4M | 🟢 **-87%** |
| optional/format/ipv4.json | validation of IP addresses | 16 | ✅ | 37.2M | ✅ | 1.5M | 🟢 **-96%** |
...
| allOf.json | allOf with the first empty schema | 2 | ✅ | 70.0M | ❌ | - | - |
...
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 83.4M | ❌ | - | - |
...
| default.json | the default keyword does not do anyth... | 3 | ✅ | 79.5M | ❌ | - | - |
| definitions.json | validate definition against metaschema | 2 | ✅ | 11.2M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 91.2M | ❌ | - | - |
| dependencies.json | dependencies with empty array | 3 | ✅ | 84.7M | ❌ | - | - |
...
| enum.json | enum with escaped characters | 3 | ✅ | 72.3M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 89.9M | ❌ | - | - |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 78.2M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 57.7M | ❌ | - | - |
...
| oneOf.json | oneOf with empty schema | 2 | ✅ | 69.0M | ❌ | - | - |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 24.4M | ❌ | - | - |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 63.5M | ❌ | - | - |
...
| required.json | required with empty array | 1 | ✅ | 80.4M | ❌ | - | - |
...
| type.json | string type matches strings | 9 | ✅ | 61.4M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 54.7M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 57.8M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 59.4M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 59.2M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 60.0M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 69.3M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 61.5M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 67.8M | ❌ | - | - |
...
| optional/bignum.json | string | 1 | ✅ | 57.9M | ❌ | - | - |
...
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 55.8M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 26.7M | ❌ | - | - |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 149.2M | ❌ | - | - |
...
| contains.json | contains with null instance elements | 1 | ✅ | 124.2M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 60.4M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 47.7M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 64.2M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 14.7M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 80.2M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 60.2M | ❌ | - | - |
...
| required.json | required default validation | 1 | ✅ | 87.9M | ❌ | - | - |
...
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 78.6M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 25.8M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 26.5M | ❌ | - | - |
...
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 54.4M | ✅ | 410K | 🟢 **-99%** |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 152.8M | ❌ | - | - |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 28.4M | ✅ | 447K | 🟢 **-98%** |
...
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 31.3M | ✅ | 452K | 🟢 **-99%** |
| allOf.json | allOf | 4 | ✅ | 38.7M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 30.7M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 65.9M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 143.1M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 60.7M | ✅ | 517K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 514K | 🟢 **-99%** |
...
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 85.1M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 63.2M | ✅ | 507K | 🟢 **-99%** |
...
| content.json | validation of string-encoded content ... | 3 | ✅ | 90.1M | ❌ | - | - |
| content.json | validation of binary string-encoding | 3 | ✅ | 89.6M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 87.7M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 73.0M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 68.0M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 53.2M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 26.2M | ❌ | - | - |
...
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 70.9M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 57.0M | ❌ | - | - |
...
| items.json | array-form items with null instance e... | 1 | ✅ | 69.4M | ❌ | - | - |
...
| minContains.json | minContains without contains is ignored | 2 | ✅ | 88.3M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 54.6M | ✅ | 533K | 🟢 **-99%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 55.7M | ✅ | 518K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 61.7M | ✅ | 568K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 60.9M | ✅ | 587K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 62.4M | ✅ | 502K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 85.1M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 63.2M | ✅ | 493K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 63.2M | ✅ | 493K | 🟢 **-99%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 43.4M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 72.4M | ❌ | - | - |
...
| ref.json | $ref to boolean schema false | 1 | ✅ | 63.2M | ✅ | 481K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.5M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 52.4M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 26.3M | ✅ | 435K | 🟢 **-98%** |
...
| type.json | boolean type matches booleans | 10 | ✅ | 62.8M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 62.6M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 63.1M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 73.0M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 68.3M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 40.3M | ✅ | 408K | 🟢 **-99%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 45.2M | ✅ | 448K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 41.8M | ✅ | 437K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 22.7M | ✅ | 390K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.7M | ✅ | 443K | 🟢 **-99%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.8M | ✅ | 444K | 🟢 **-99%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 25.9M | ✅ | 471K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 27.5M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 21.0M | ✅ | 447K | 🟢 **-98%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 24.1M | ✅ | 421K | 🟢 **-98%** |
...
| optional/bignum.json | string | 1 | ✅ | 60.9M | ✅ | 515K | 🟢 **-99%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 75.2M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 57.8M | ✅ | 520K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 75.2M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 57.8M | ✅ | 534K | 🟢 **-99%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 27.0M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 27.9M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 25.8M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 27.9M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 27.7M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 25.7M | ❌ | - | - |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 62.8M | ✅ | 1.8M | 🟢 **-97%** |
...
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 32.7M | ❌ | - | - |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 152.6M | ❌ | - | - |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 28.2M | ✅ | 588K | 🟢 **-98%** |
...
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 31.2M | ✅ | 549K | 🟢 **-98%** |
| allOf.json | allOf | 4 | ✅ | 39.2M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 30.8M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 69.7M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 142.0M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 63.0M | ✅ | 729K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 724K | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 77.1M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 152.8M | ❌ | - | - |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 72.1M | ❌ | - | - |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.8M | ❌ | - | - |
...
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 63.4M | ✅ | 682K | 🟢 **-99%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 48.9M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 79.9M | ❌ | - | - |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 74.7M | ❌ | - | - |
...
| contains.json | contains with null instance elements | 1 | ✅ | 73.6M | ❌ | - | - |
| content.json | validation of string-encoded content ... | 3 | ✅ | 75.0M | ❌ | - | - |
| content.json | validation of binary string-encoding | 3 | ✅ | 90.3M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 79.6M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 76.3M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 64.4M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 53.1M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 26.3M | ❌ | - | - |
...
| enum.json | enum with escaped characters | 3 | ✅ | 72.9M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 53.9M | ✅ | 666K | 🟢 **-99%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 55.8M | ✅ | 708K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 61.0M | ✅ | 734K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 61.5M | ✅ | 759K | 🟢 **-99%** |
...
| oneOf.json | oneOf with base schema | 3 | ✅ | 33.0M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 63.0M | ✅ | 690K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 85.2M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 63.2M | ✅ | 684K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 63.4M | ✅ | 686K | 🟢 **-99%** |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 22.7M | ❌ | - | - |
...
| prefixItems.json | additional items are allowed by default | 1 | ✅ | 77.0M | ❌ | - | - |
...
| ref.json | $ref to boolean schema false | 1 | ✅ | 63.5M | ✅ | 658K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.7M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 52.4M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 26.4M | ✅ | 563K | 🟢 **-98%** |
| ref.json | naive replacement of $ref with its de... | 3 | ✅ | 54.9M | ❌ | - | - |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 72.6M | ❌ | - | - |
...
| type.json | object type matches objects | 7 | ✅ | 56.2M | ❌ | - | - |
...
| type.json | type: array or object | 5 | ✅ | 67.3M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 73.1M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with anyOf | 4 | ✅ | 12.2M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with oneOf | 2 | ✅ | 15.5M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 40.1M | ✅ | 539K | 🟢 **-99%** |
| unevaluatedItems.json | unevaluatedItems with if/then/else | 4 | ✅ | 11.1M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 44.5M | ✅ | 614K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 41.4M | ✅ | 583K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 23.3M | ✅ | 509K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 27.4M | ✅ | 604K | 🟢 **-98%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.3M | ✅ | 609K | 🟢 **-98%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 25.5M | ✅ | 583K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 25.8M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 20.1M | ✅ | 567K | 🟢 **-97%** |
...
| unevaluatedProperties.json | dependentSchemas with unevaluatedProp... | 3 | ✅ | 21.9M | ❌ | - | - |
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 24.0M | ✅ | 579K | 🟢 **-98%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 17.4M | ❌ | - | - |
...
| optional/bignum.json | string | 1 | ✅ | 61.0M | ✅ | 750K | 🟢 **-99%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 75.2M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 57.8M | ✅ | 750K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 75.2M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 57.8M | ✅ | 745K | 🟢 **-99%** |
...
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 90.1M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 28.3M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 19.9M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 27.1M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 27.8M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 13.7M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 12.7M | ❌ | - | - |
...
| optional/format/ecmascript-regex.json | \a is not an ECMA 262 control escape | 1 | ✅ | 49.8M | ✅ | 750K | 🟢 **-98%** |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 61.7M | ✅ | 2.5M | 🟢 **-96%** |
