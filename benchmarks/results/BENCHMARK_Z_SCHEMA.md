...
|-------|-------:|---------:|----------:|-----------:|----------:|----------:|-----:|
| draft4 | 199 | 198/199 | 26.7M | 169/199 | 842K | 169 | 🟢 **-97%** |
| draft6 | 276 | ✅ 276 | 29.9M | 0/276 | - | 0 | - |
| draft7 | 313 | ✅ 313 | 15.4M | 0/313 | - | 0 | - |
| draft2019-09 | 435 | ✅ 435 | 17.9M | 28/435 | 521K | 28 | 🟢 **-97%** |
| draft2020-12 | 448 | ✅ 448 | 18.9M | 28/448 | 678K | 28 | 🟢 **-96%** |
| **Total** | 1671 | 1670/1671 | 19.5M | 225/1671 | 797K | 225 | 🟢 **-96%** |

## Head-to-Head Performance

Direct comparison using only test groups where **both** validators pass **all** tests. This ensures a fair comparison by excluding groups where either validator has incomplete or incorrect implementations.

**Result**: 🟢 **tjs** is **44.11x faster** (28 ns vs 1255 ns per test, 803 tests in 225 groups)
...
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 7.0M | ✅ | 628K | 🟢 **-91%** |
| additionalItems.json | when items is schema, additionalItems... | 1 | ✅ | 90.2M | ✅ | 1.7M | 🟢 **-98%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 134.2M | ✅ | 1.7M | 🟢 **-99%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 94.1M | ✅ | 3.3M | 🟢 **-97%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 123.1M | ✅ | 2.2M | 🟢 **-98%** |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 31.0M | ✅ | 353K | 🟢 **-99%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 44.6M | ✅ | 651K | 🟢 **-99%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 72.9M | ✅ | 1.2M | 🟢 **-98%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 167.5M | ✅ | 3.5M | 🟢 **-98%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 36.0M | ✅ | 1.1M | 🟢 **-97%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 19.0M | ✅ | 842K | 🟢 **-96%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 29.7M | ✅ | 841K | 🟢 **-97%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 34.0M | ✅ | 791K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 82.6M | ✅ | 1.5M | 🟢 **-98%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 22.4M | ✅ | 396K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 51.8M | ✅ | 1.8M | 🟢 **-97%** |
| allOf.json | allOf | 4 | ✅ | 37.4M | ✅ | 463K | 🟢 **-99%** |
| allOf.json | allOf with base schema | 5 | ✅ | 23.5M | ✅ | 393K | 🟢 **-98%** |
| allOf.json | allOf simple types | 2 | ✅ | 122.0M | ✅ | 1.2M | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 89.8M | ✅ | 3.0M | 🟢 **-97%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 167.9M | ✅ | 2.5M | 🟢 **-98%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 77.1M | ✅ | 965K | 🟢 **-99%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 120.1M | ✅ | 981K | 🟢 **-99%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 73.4M | ✅ | 957K | 🟢 **-99%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 84.6M | ✅ | 338K | 🟢 **-100%** |
| anyOf.json | anyOf | 4 | ✅ | 79.6M | ✅ | 662K | 🟢 **-99%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 46.8M | ✅ | 574K | 🟢 **-99%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 47.1M | ✅ | 393K | 🟢 **-99%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 172.4M | ✅ | 2.6M | 🟢 **-98%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 77.4M | ✅ | 627K | 🟢 **-99%** |
| default.json | invalid type for default | 2 | ✅ | 112.0M | ✅ | 2.0M | 🟢 **-98%** |
| default.json | invalid string value for default | 2 | ✅ | 56.0M | ✅ | 1.7M | 🟢 **-97%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 67.4M | ✅ | 899K | 🟢 **-99%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 11.3M | ✅ | 127K | 🟢 **-99%** |
| dependencies.json | dependencies | 7 | ✅ | 87.1M | ✅ | 1.8M | 🟢 **-98%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 30.8M | ✅ | 851K | 🟢 **-97%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 50.8M | ✅ | 459K | 🟢 **-99%** |
| dependencies.json | dependencies with escaped characters | 7 | ✅ | 16.4M | ✅ | 735K | 🟢 **-96%** |
| dependencies.json | dependent subschema incompatible with... | 4 | ✅ | 38.9M | ✅ | 788K | 🟢 **-98%** |
| enum.json | simple enum validation | 2 | ✅ | 71.8M | ✅ | 1.7M | 🟢 **-98%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 65.8M | ✅ | 788K | 🟢 **-99%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 65.2M | ✅ | 1.7M | 🟢 **-97%** |
| enum.json | enums in properties | 6 | ✅ | 14.9M | ✅ | 644K | 🟢 **-96%** |
| enum.json | enum with escaped characters | 3 | ✅ | 54.6M | ✅ | 2.1M | 🟢 **-96%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 46.1M | ✅ | 1.2M | 🟢 **-97%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 60.6M | ✅ | 1.0M | 🟢 **-98%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 116.8M | ✅ | 1.2M | 🟢 **-99%** |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 58.4M | ✅ | 1.0M | 🟢 **-98%** |
| enum.json | enum with 0 does not match false | 3 | ✅ | 123.8M | ✅ | 1.8M | 🟢 **-99%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 66.5M | ✅ | 1.4M | 🟢 **-98%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 127.1M | ✅ | 2.1M | 🟢 **-98%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 67.3M | ✅ | 1.4M | 🟢 **-98%** |
| enum.json | nul characters in strings | 2 | ✅ | 94.3M | ✅ | 2.0M | 🟢 **-98%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 59.5M | ✅ | 1.9M | 🟢 **-97%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 91.3M | ✅ | 1.8M | 🟢 **-98%** |
| format.json | email format | 6 | ✅ | 36.4M | ✅ | 3.3M | 🟢 **-91%** |
| format.json | ipv4 format | 6 | ✅ | 154.8M | ✅ | 3.1M | 🟢 **-98%** |
| format.json | ipv6 format | 6 | ✅ | 90.6M | ✅ | 3.1M | 🟢 **-97%** |
| format.json | hostname format | 6 | ✅ | 157.2M | ✅ | 3.1M | 🟢 **-98%** |
| format.json | date-time format | 6 | ✅ | 90.6M | ✅ | 3.1M | 🟢 **-97%** |
| format.json | uri format | 6 | ✅ | 154.3M | ✅ | 3.2M | 🟢 **-98%** |
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 29.7M | ✅ | 365K | 🟢 **-99%** |
| items.json | a schema given for items | 4 | ✅ | 69.0M | ✅ | 996K | 🟢 **-99%** |
| items.json | an array of schemas for items | 6 | ✅ | 58.4M | ✅ | 944K | 🟢 **-98%** |
| items.json | items and subitems | 6 | ✅ | 15.7M | ✅ | 245K | 🟢 **-98%** |
| items.json | nested items | 3 | ✅ | 12.5M | ✅ | 137K | 🟢 **-99%** |
| items.json | items with null instance elements | 1 | ✅ | 69.3M | ✅ | 2.2M | 🟢 **-97%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 79.9M | ✅ | 2.3M | 🟢 **-97%** |
| maxItems.json | maxItems validation | 4 | ✅ | 27.9M | ✅ | 1.8M | 🟢 **-93%** |
| maxLength.json | maxLength validation | 5 | ✅ | 57.3M | ✅ | 2.0M | 🟢 **-96%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 55.9M | ✅ | 1.6M | 🟢 **-97%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 46.6M | ✅ | 1.1M | 🟢 **-98%** |
| maximum.json | maximum validation | 4 | ✅ | 69.0M | ✅ | 1.5M | 🟢 **-98%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 78.1M | ✅ | 1.6M | 🟢 **-98%** |
| maximum.json | maximum validation (explicit false ex... | 4 | ✅ | 78.2M | ✅ | 1.4M | 🟢 **-98%** |
| maximum.json | exclusiveMaximum validation | 2 | ✅ | 71.3M | ✅ | 1.5M | 🟢 **-98%** |
| minItems.json | minItems validation | 4 | ✅ | 77.1M | ✅ | 1.8M | 🟢 **-98%** |
| minLength.json | minLength validation | 5 | ✅ | 55.9M | ✅ | 1.6M | 🟢 **-97%** |
| minProperties.json | minProperties validation | 6 | ✅ | 58.1M | ✅ | 1.9M | 🟢 **-97%** |
| minimum.json | minimum validation | 4 | ✅ | 78.0M | ✅ | 1.5M | 🟢 **-98%** |
| minimum.json | minimum validation (explicit false ex... | 4 | ✅ | 77.4M | ✅ | 1.4M | 🟢 **-98%** |
| minimum.json | exclusiveMinimum validation | 2 | ✅ | 71.1M | ✅ | 1.4M | 🟢 **-98%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 71.9M | ✅ | 1.7M | 🟢 **-98%** |
| multipleOf.json | by int | 3 | ✅ | 79.2M | ✅ | 1.3M | 🟢 **-98%** |
| multipleOf.json | by number | 3 | ✅ | 72.1M | ✅ | 1.2M | 🟢 **-98%** |
| multipleOf.json | by small number | 2 | ✅ | 66.6M | ✅ | 1.2M | 🟢 **-98%** |
| multipleOf.json | float division = inf | 1 | ✅ | 56.5M | ✅ | 769K | 🟢 **-99%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 72.0M | ✅ | 2.0M | 🟢 **-97%** |
| not.json | not | 2 | ✅ | 75.8M | ✅ | 827K | 🟢 **-99%** |
| not.json | not multiple types | 3 | ✅ | 71.3M | ✅ | 878K | 🟢 **-99%** |
| not.json | not more complex schema | 3 | ✅ | 67.8M | ✅ | 533K | 🟢 **-99%** |
| not.json | forbidden property | 2 | ✅ | 41.6M | ✅ | 880K | 🟢 **-98%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 63.2M | ✅ | 1.2M | 🟢 **-98%** |
| not.json | double negation | 1 | ✅ | 88.1M | ✅ | 1.3M | 🟢 **-98%** |
| oneOf.json | oneOf | 4 | ✅ | 73.9M | ✅ | 468K | 🟢 **-99%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 33.2M | ✅ | 587K | 🟢 **-98%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 42.4M | ✅ | 310K | 🟢 **-99%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 75.8M | ✅ | 737K | 🟢 **-99%** |
| oneOf.json | oneOf with required | 4 | ✅ | 47.8M | ✅ | 378K | 🟢 **-99%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 47.3M | ✅ | 373K | 🟢 **-99%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 76.0M | ✅ | 650K | 🟢 **-99%** |
| pattern.json | pattern validation | 8 | ✅ | 53.2M | ✅ | 2.1M | 🟢 **-96%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 25.8M | ✅ | 2.5M | 🟢 **-90%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 25.0M | ✅ | 754K | 🟢 **-97%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 13.3M | ✅ | 448K | 🟢 **-97%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 14.3M | ✅ | 632K | 🟢 **-96%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 19.7M | ✅ | 1.3M | 🟢 **-93%** |
| properties.json | object properties validation | 6 | ✅ | 45.9M | ✅ | 954K | 🟢 **-98%** |
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 17.2M | ✅ | 573K | 🟢 **-97%** |
| properties.json | properties with escaped characters | 2 | ✅ | 43.2M | ✅ | 191K | 🟢 **-100%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 70.5M | ✅ | 1.7M | 🟢 **-98%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 25.8M | ❌ | - | - |
| ref.json | root pointer ref | 4 | ✅ | 22.3M | ✅ | 769K | 🟢 **-97%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 41.9M | ✅ | 747K | 🟢 **-98%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 49.2M | ✅ | 701K | 🟢 **-99%** |
| ref.json | escaped pointer ref | 6 | ✅ | 41.1M | ✅ | 714K | 🟢 **-98%** |
| ref.json | nested refs | 2 | ✅ | 34.4M | ✅ | 928K | 🟢 **-97%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 49.1M | ✅ | 868K | 🟢 **-98%** |
| ref.json | $ref prevents a sibling id from chang... | 2 | ✅ | 74.6M | ❌ | - | - |
| ref.json | remote ref, containing refs itself | 2 | ✅ | 20.5M | ✅ | 335K | 🟢 **-98%** |
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 42.2M | ✅ | 732K | 🟢 **-98%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 45.8M | ✅ | 723K | 🟢 **-98%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 11.2M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 43.8M | ✅ | 714K | 🟢 **-98%** |
| ref.json | Location-independent identifier | 2 | ✅ | 74.5M | ✅ | 896K | 🟢 **-99%** |
...
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 71.1M | ✅ | 931K | 🟢 **-99%** |
...
| required.json | required validation | 5 | ✅ | 57.9M | ✅ | 1.6M | 🟢 **-97%** |
| required.json | required default validation | 1 | ✅ | 88.9M | ✅ | 3.1M | 🟢 **-97%** |
| required.json | required with escaped characters | 2 | ✅ | 40.0M | ✅ | 588K | 🟢 **-99%** |
| required.json | required properties whose names are J... | 7 | ✅ | 23.8M | ❌ | - | - |
| type.json | integer type matches integers | 8 | ✅ | 63.7M | ✅ | 880K | 🟢 **-99%** |
| type.json | number type matches numbers | 9 | ✅ | 68.2M | ✅ | 1.0M | 🟢 **-98%** |
| type.json | string type matches strings | 9 | ✅ | 66.9M | ✅ | 1.0M | 🟢 **-98%** |
| type.json | object type matches objects | 7 | ✅ | 55.7M | ✅ | 897K | 🟢 **-98%** |
| type.json | array type matches arrays | 7 | ✅ | 62.8M | ✅ | 920K | 🟢 **-99%** |
| type.json | boolean type matches booleans | 10 | ✅ | 64.9M | ✅ | 967K | 🟢 **-99%** |
| type.json | null type matches only the null object | 10 | ✅ | 63.1M | ✅ | 864K | 🟢 **-99%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 63.3M | ✅ | 797K | 🟢 **-99%** |
| type.json | type as array with one item | 2 | ✅ | 77.2M | ✅ | 1.3M | 🟢 **-98%** |
| type.json | type: array or object | 5 | ✅ | 70.8M | ✅ | 851K | 🟢 **-99%** |
| type.json | type: array, object or null | 5 | ✅ | 76.2M | ✅ | 1.2M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 16.1M | ✅ | 1.1M | 🟢 **-93%** |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 34.6M | ✅ | 696K | 🟢 **-98%** |
| uniqueItems.json | uniqueItems with an array of items an... | 5 | ✅ | 19.9M | ✅ | 704K | 🟢 **-96%** |
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 79.0M | ✅ | 3.7M | 🟢 **-95%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 68.4M | ✅ | 1.3M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 59.8M | ✅ | 1.1M | 🟢 **-98%** |
| optional/bignum.json | integer | 2 | ✅ | 84.7M | ✅ | 2.5M | 🟢 **-97%** |
| optional/bignum.json | number | 2 | ✅ | 87.7M | ✅ | 2.5M | 🟢 **-97%** |
| optional/bignum.json | string | 1 | ✅ | 66.4M | ✅ | 1.0M | 🟢 **-98%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 80.0M | ✅ | 3.4M | 🟢 **-96%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 59.2M | ✅ | 855K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 80.1M | ✅ | 3.4M | 🟢 **-96%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 61.5M | ✅ | 863K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 27.8M | ✅ | 790K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 30.9M | ✅ | 802K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.0M | ✅ | 794K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 29.7M | ✅ | 805K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 28.9M | ✅ | 730K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 27.0M | ✅ | 1.0M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 30.1M | ✅ | 796K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 29.5M | ✅ | 785K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.8M | ✅ | 1.3M | 🟢 **-95%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 31.5M | ✅ | 630K | 🟢 **-98%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 17.9M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 17.2M | ✅ | 751K | 🟢 **-96%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 16.2M | ✅ | 889K | 🟢 **-95%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 29.2M | ✅ | 777K | 🟢 **-97%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 17.3M | ✅ | 660K | 🟢 **-96%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 16.9M | ✅ | 694K | 🟢 **-96%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 7.8M | ✅ | 649K | 🟢 **-92%** |
...
| optional/format/email.json | validation of e-mail addresses | 17 | ✅ | 19.2M | ✅ | 415K | 🟢 **-98%** |
| optional/format/hostname.json | validation of host names | 27 | ✅ | 11.2M | ✅ | 1.1M | 🟢 **-91%** |
| optional/format/ipv4.json | validation of IP addresses | 16 | ✅ | 44.5M | ✅ | 1.1M | 🟢 **-97%** |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 150.5M | ❌ | - | - |
...
| allOf.json | allOf with the first empty schema | 2 | ✅ | 76.6M | ❌ | - | - |
...
| default.json | the default keyword does not do anyth... | 3 | ✅ | 78.6M | ❌ | - | - |
...
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 111.8M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 14.0M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 124.5M | ❌ | - | - |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 164.2M | ❌ | - | - |
...
| items.json | array-form items with null instance e... | 1 | ✅ | 128.4M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 60.1M | ❌ | - | - |
...
| oneOf.json | oneOf with empty schema | 2 | ✅ | 113.7M | ❌ | - | - |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 104.5M | ❌ | - | - |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 163.9M | ❌ | - | - |
...
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 163.1M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 152.1M | ❌ | - | - |
...
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 53.0M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 92.5M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 60.9M | ❌ | - | - |
| allOf.json | allOf with one empty schema | 1 | ✅ | 152.8M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 73.4M | ❌ | - | - |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 117.8M | ❌ | - | - |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 68.7M | ❌ | - | - |
...
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 73.5M | ❌ | - | - |
...
| default.json | the default keyword does not do anyth... | 3 | ✅ | 76.7M | ❌ | - | - |
| definitions.json | validate definition against metaschema | 2 | ✅ | 10.3M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 91.1M | ❌ | - | - |
| dependencies.json | dependencies with empty array | 3 | ✅ | 84.9M | ❌ | - | - |
...
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 68.2M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 15.9M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 72.8M | ❌ | - | - |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 60.5M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 80.8M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 60.7M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 60.6M | ❌ | - | - |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 20.7M | ❌ | - | - |
...
| type.json | string type matches strings | 9 | ✅ | 61.1M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 54.7M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 57.8M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 58.2M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 59.2M | ❌ | - | - |
...
| optional/bignum.json | string | 1 | ✅ | 58.0M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 28.3M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 27.6M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 27.4M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 25.4M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 29.4M | ❌ | - | - |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 153.2M | ❌ | - | - |
...
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 53.5M | ✅ | 396K | 🟢 **-99%** |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 66.0M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 26.8M | ✅ | 442K | 🟢 **-98%** |
...
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 31.2M | ✅ | 447K | 🟢 **-99%** |
...
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 55.8M | ✅ | 507K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 508K | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 73.2M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 153.0M | ❌ | - | - |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 63.3M | ❌ | - | - |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.8M | ❌ | - | - |
...
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 73.2M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 56.2M | ✅ | 494K | 🟢 **-99%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 44.7M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 68.2M | ❌ | - | - |
...
| contains.json | contains with null instance elements | 1 | ✅ | 64.6M | ❌ | - | - |
| content.json | validation of string-encoded content ... | 3 | ✅ | 75.8M | ❌ | - | - |
| content.json | validation of binary string-encoding | 3 | ✅ | 76.0M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 60.1M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 61.2M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 58.1M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 46.4M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 46.1M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 31.7M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 42.4M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 60.2M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 14.2M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 63.4M | ❌ | - | - |
...
| items.json | single-form items with null instance ... | 1 | ✅ | 63.3M | ❌ | - | - |
| items.json | array-form items with null instance e... | 1 | ✅ | 67.3M | ❌ | - | - |
| maxContains.json | maxContains without contains is ignored | 2 | ✅ | 75.1M | ❌ | - | - |
...
| minContains.json | minContains without contains is ignored | 2 | ✅ | 75.3M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 47.4M | ✅ | 501K | 🟢 **-99%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 50.4M | ✅ | 497K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 50.2M | ✅ | 557K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 50.2M | ✅ | 592K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 56.0M | ✅ | 493K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 73.2M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 56.1M | ✅ | 497K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 56.1M | ✅ | 489K | 🟢 **-99%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 39.7M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 62.6M | ❌ | - | - |
| oneOf.json | oneOf with required | 4 | ✅ | 43.0M | ❌ | - | - |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 43.6M | ❌ | - | - |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 61.1M | ❌ | - | - |
| pattern.json | pattern validation | 8 | ✅ | 48.8M | ❌ | - | - |
| pattern.json | pattern is not anchored | 1 | ✅ | 13.6M | ❌ | - | - |
...
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 10.9M | ❌ | - | - |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 75.2M | ❌ | - | - |
...
| ref.json | $ref to boolean schema false | 1 | ✅ | 56.3M | ✅ | 477K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.3M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 45.6M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 24.8M | ✅ | 428K | 🟢 **-98%** |
...
| required.json | required default validation | 1 | ✅ | 73.1M | ❌ | - | - |
...
| type.json | string type matches strings | 9 | ✅ | 56.9M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 50.9M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 53.5M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 55.4M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 52.2M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 55.0M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 63.1M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 36.7M | ✅ | 413K | 🟢 **-99%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 40.6M | ✅ | 448K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 38.0M | ✅ | 433K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 24.2M | ✅ | 384K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 26.3M | ✅ | 444K | 🟢 **-98%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 27.0M | ✅ | 440K | 🟢 **-98%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 22.4M | ✅ | 465K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 25.8M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 19.8M | ✅ | 449K | 🟢 **-98%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 22.7M | ✅ | 432K | 🟢 **-98%** |
...
| optional/bignum.json | string | 1 | ✅ | 54.3M | ✅ | 535K | 🟢 **-99%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 66.0M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 50.4M | ✅ | 540K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 65.3M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 52.0M | ✅ | 538K | 🟢 **-99%** |
...
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 76.1M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 25.4M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 19.2M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 25.3M | ❌ | - | - |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 54.9M | ✅ | 1.8M | 🟢 **-97%** |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 152.3M | ❌ | - | - |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 28.5M | ✅ | 551K | 🟢 **-98%** |
...
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 30.9M | ✅ | 528K | 🟢 **-98%** |
...
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 62.8M | ✅ | 691K | 🟢 **-99%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 91.7M | ✅ | 691K | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 77.0M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 152.2M | ❌ | - | - |
...
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 62.9M | ✅ | 678K | 🟢 **-99%** |
...
| content.json | validation of binary string-encoding | 3 | ✅ | 88.8M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 91.1M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 72.0M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 67.7M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 53.1M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 50.9M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 71.8M | ❌ | - | - |
...
| enum.json | enum with escaped characters | 3 | ✅ | 70.5M | ❌ | - | - |
...
| items.json | items with null instance elements | 1 | ✅ | 72.0M | ❌ | - | - |
...
| minContains.json | minContains without contains is ignored | 2 | ✅ | 88.4M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 56.6M | ✅ | 653K | 🟢 **-99%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 55.8M | ✅ | 695K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 62.1M | ✅ | 714K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 61.3M | ✅ | 752K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 63.4M | ✅ | 682K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 85.2M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 63.4M | ✅ | 677K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 63.0M | ✅ | 681K | 🟢 **-99%** |
...
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 70.1M | ❌ | - | - |
...
| prefixItems.json | additional items are allowed by default | 1 | ✅ | 75.7M | ❌ | - | - |
| prefixItems.json | prefixItems with null instance elements | 1 | ✅ | 77.0M | ❌ | - | - |
...
| ref.json | $ref to boolean schema false | 1 | ✅ | 63.4M | ✅ | 653K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.6M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 52.9M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 24.1M | ✅ | 548K | 🟢 **-98%** |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 72.7M | ❌ | - | - |
...
| type.json | string type matches strings | 9 | ✅ | 62.8M | ❌ | - | - |
| type.json | object type matches objects | 7 | ✅ | 56.8M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 61.3M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 60.9M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 63.0M | ❌ | - | - |
| type.json | multiple types can be specified in an... | 7 | ✅ | 62.8M | ❌ | - | - |
| type.json | type as array with one item | 2 | ✅ | 72.6M | ❌ | - | - |
| type.json | type: array or object | 5 | ✅ | 67.8M | ❌ | - | - |
| type.json | type: array, object or null | 5 | ✅ | 73.7M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 40.2M | ✅ | 520K | 🟢 **-99%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 44.9M | ✅ | 592K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 41.3M | ✅ | 549K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 21.3M | ✅ | 499K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.4M | ✅ | 586K | 🟢 **-98%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.3M | ✅ | 583K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer f... | 2 | ✅ | 27.9M | ❌ | - | - |
| unevaluatedProperties.json | nested unevaluatedProperties, outer f... | 2 | ✅ | 27.9M | ❌ | - | - |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 25.5M | ✅ | 567K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 27.2M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 19.8M | ✅ | 552K | 🟢 **-97%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 23.9M | ✅ | 562K | 🟢 **-98%** |
...
| optional/bignum.json | string | 1 | ✅ | 61.0M | ✅ | 733K | 🟢 **-99%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 72.9M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 57.7M | ✅ | 738K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 71.3M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 57.2M | ✅ | 734K | 🟢 **-99%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 28.8M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 16.4M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 27.5M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.6M | ❌ | - | - |
...
| optional/format/ecmascript-regex.json | \a is not an ECMA 262 control escape | 1 | ✅ | 49.8M | ✅ | 740K | 🟢 **-99%** |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 61.9M | ✅ | 2.6M | 🟢 **-96%** |
