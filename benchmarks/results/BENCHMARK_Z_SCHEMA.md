...
|-------|-------:|---------:|----------:|-----------:|----------:|----------:|-----:|
| draft4 | 199 | 198/199 | 26.8M | 169/199 | 858K | 169 | 🟢 **-97%** |
| draft6 | 276 | ✅ 276 | 29.8M | 0/276 | - | 0 | - |
| draft7 | 313 | ✅ 313 | 15.1M | 0/313 | - | 0 | - |
| draft2019-09 | 435 | ✅ 435 | 18.8M | 28/435 | 488K | 28 | 🟢 **-97%** |
| draft2020-12 | 448 | ✅ 448 | 19.1M | 28/448 | 686K | 28 | 🟢 **-96%** |
| **Total** | 1671 | 1670/1671 | 19.7M | 225/1671 | 805K | 225 | 🟢 **-96%** |

## Head-to-Head Performance

Direct comparison using only test groups where **both** validators pass **all** tests. This ensures a fair comparison by excluding groups where either validator has incomplete or incorrect implementations.

**Result**: 🟢 **tjs** is **45.14x faster** (28 ns vs 1243 ns per test, 803 tests in 225 groups)
...
|------|-------|------:|:---:|----------:|:---:|----------:|-----:|
| additionalItems.json | additionalItems as schema | 2 | ✅ | 7.4M | ✅ | 685K | 🟢 **-91%** |
| additionalItems.json | when items is schema, additionalItems... | 1 | ✅ | 85.1M | ✅ | 1.7M | 🟢 **-98%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 146.1M | ✅ | 1.8M | 🟢 **-99%** |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 88.3M | ✅ | 3.3M | 🟢 **-96%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 124.5M | ✅ | 2.2M | 🟢 **-98%** |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 45.1M | ✅ | 374K | 🟢 **-99%** |
| additionalItems.json | items validation adjusts the starting... | 2 | ✅ | 49.6M | ✅ | 669K | 🟢 **-99%** |
| additionalItems.json | additionalItems with heterogeneous array | 2 | ✅ | 69.7M | ✅ | 1.3M | 🟢 **-98%** |
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 152.9M | ✅ | 3.4M | 🟢 **-98%** |
| additionalProperties.json | additionalProperties being false does... | 6 | ✅ | 37.0M | ✅ | 1.1M | 🟢 **-97%** |
| additionalProperties.json | non-ASCII pattern with additionalProp... | 2 | ✅ | 24.9M | ✅ | 839K | 🟢 **-97%** |
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 35.2M | ✅ | 742K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 44.5M | ✅ | 778K | 🟢 **-98%** |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 77.1M | ✅ | 1.4M | 🟢 **-98%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 32.8M | ✅ | 385K | 🟢 **-99%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 50.9M | ✅ | 1.2M | 🟢 **-98%** |
| allOf.json | allOf | 4 | ✅ | 47.8M | ✅ | 456K | 🟢 **-99%** |
| allOf.json | allOf with base schema | 5 | ✅ | 27.0M | ✅ | 398K | 🟢 **-99%** |
| allOf.json | allOf simple types | 2 | ✅ | 109.9M | ✅ | 1.2M | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 84.4M | ✅ | 3.1M | 🟢 **-96%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 152.9M | ✅ | 2.6M | 🟢 **-98%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 73.4M | ✅ | 1.1M | 🟢 **-99%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 117.8M | ✅ | 1.0M | 🟢 **-99%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 74.7M | ✅ | 952K | 🟢 **-99%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 84.5M | ✅ | 350K | 🟢 **-100%** |
| anyOf.json | anyOf | 4 | ✅ | 75.9M | ✅ | 668K | 🟢 **-99%** |
| anyOf.json | anyOf with base schema | 3 | ✅ | 51.4M | ✅ | 567K | 🟢 **-99%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 48.9M | ✅ | 398K | 🟢 **-99%** |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 164.2M | ✅ | 2.6M | 🟢 **-98%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 74.7M | ✅ | 632K | 🟢 **-99%** |
| default.json | invalid type for default | 2 | ✅ | 107.6M | ✅ | 2.1M | 🟢 **-98%** |
| default.json | invalid string value for default | 2 | ✅ | 53.1M | ✅ | 1.7M | 🟢 **-97%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 76.8M | ✅ | 908K | 🟢 **-99%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 11.7M | ✅ | 128K | 🟢 **-99%** |
| dependencies.json | dependencies | 7 | ✅ | 91.0M | ✅ | 1.8M | 🟢 **-98%** |
| dependencies.json | multiple dependencies | 6 | ✅ | 33.8M | ✅ | 870K | 🟢 **-97%** |
| dependencies.json | multiple dependencies subschema | 5 | ✅ | 56.2M | ✅ | 465K | 🟢 **-99%** |
| dependencies.json | dependencies with escaped characters | 7 | ✅ | 11.5M | ✅ | 726K | 🟢 **-94%** |
| dependencies.json | dependent subschema incompatible with... | 4 | ✅ | 47.4M | ✅ | 781K | 🟢 **-98%** |
| enum.json | simple enum validation | 2 | ✅ | 71.8M | ✅ | 1.7M | 🟢 **-98%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 60.9M | ✅ | 800K | 🟢 **-99%** |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 71.1M | ✅ | 2.1M | 🟢 **-97%** |
| enum.json | enums in properties | 6 | ✅ | 14.8M | ✅ | 650K | 🟢 **-96%** |
| enum.json | enum with escaped characters | 3 | ✅ | 59.0M | ✅ | 2.2M | 🟢 **-96%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 112.7M | ✅ | 1.2M | 🟢 **-99%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 63.3M | ✅ | 1.0M | 🟢 **-98%** |
| enum.json | enum with true does not match 1 | 3 | ✅ | 111.5M | ✅ | 1.2M | 🟢 **-99%** |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 64.0M | ✅ | 1.0M | 🟢 **-98%** |
| enum.json | enum with 0 does not match false | 3 | ✅ | 114.4M | ✅ | 1.8M | 🟢 **-98%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 65.8M | ✅ | 1.4M | 🟢 **-98%** |
| enum.json | enum with 1 does not match true | 3 | ✅ | 111.7M | ✅ | 2.3M | 🟢 **-98%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 65.4M | ✅ | 1.5M | 🟢 **-98%** |
| enum.json | nul characters in strings | 2 | ✅ | 91.3M | ✅ | 2.0M | 🟢 **-98%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 56.1M | ✅ | 1.9M | 🟢 **-97%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 93.9M | ✅ | 1.9M | 🟢 **-98%** |
| format.json | email format | 6 | ✅ | 87.0M | ✅ | 3.4M | 🟢 **-96%** |
| format.json | ipv4 format | 6 | ✅ | 162.7M | ✅ | 3.1M | 🟢 **-98%** |
| format.json | ipv6 format | 6 | ✅ | 86.6M | ✅ | 3.1M | 🟢 **-96%** |
| format.json | hostname format | 6 | ✅ | 162.8M | ✅ | 3.1M | 🟢 **-98%** |
| format.json | date-time format | 6 | ✅ | 87.1M | ✅ | 3.0M | 🟢 **-97%** |
| format.json | uri format | 6 | ✅ | 162.2M | ✅ | 3.1M | 🟢 **-98%** |
| infinite-loop-detection.json | evaluating the same schema location a... | 2 | ✅ | 43.4M | ✅ | 366K | 🟢 **-99%** |
| items.json | a schema given for items | 4 | ✅ | 80.7M | ✅ | 1.0M | 🟢 **-99%** |
| items.json | an array of schemas for items | 6 | ✅ | 65.4M | ✅ | 964K | 🟢 **-99%** |
| items.json | items and subitems | 6 | ✅ | 28.8M | ✅ | 247K | 🟢 **-99%** |
| items.json | nested items | 3 | ✅ | 12.1M | ✅ | 136K | 🟢 **-99%** |
...
| maxItems.json | maxItems validation | 4 | ✅ | 74.9M | ✅ | 1.8M | 🟢 **-98%** |
| maxLength.json | maxLength validation | 5 | ✅ | 56.4M | ✅ | 2.1M | 🟢 **-96%** |
| maxProperties.json | maxProperties validation | 6 | ✅ | 55.5M | ✅ | 1.7M | 🟢 **-97%** |
| maxProperties.json | maxProperties = 0 means the object is... | 2 | ✅ | 49.5M | ✅ | 1.1M | 🟢 **-98%** |
| maximum.json | maximum validation | 4 | ✅ | 73.2M | ✅ | 1.6M | 🟢 **-98%** |
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 72.0M | ✅ | 1.7M | 🟢 **-98%** |
| maximum.json | maximum validation (explicit false ex... | 4 | ✅ | 73.2M | ✅ | 1.5M | 🟢 **-98%** |
| maximum.json | exclusiveMaximum validation | 2 | ✅ | 67.4M | ✅ | 1.5M | 🟢 **-98%** |
| minItems.json | minItems validation | 4 | ✅ | 74.6M | ✅ | 1.9M | 🟢 **-98%** |
| minLength.json | minLength validation | 5 | ✅ | 55.5M | ✅ | 1.5M | 🟢 **-97%** |
| minProperties.json | minProperties validation | 6 | ✅ | 57.5M | ✅ | 1.9M | 🟢 **-97%** |
| minimum.json | minimum validation | 4 | ✅ | 71.1M | ✅ | 1.6M | 🟢 **-98%** |
| minimum.json | minimum validation (explicit false ex... | 4 | ✅ | 71.8M | ✅ | 1.5M | 🟢 **-98%** |
| minimum.json | exclusiveMinimum validation | 2 | ✅ | 67.4M | ✅ | 1.4M | 🟢 **-98%** |
| minimum.json | minimum validation with signed integer | 7 | ✅ | 66.3M | ✅ | 1.8M | 🟢 **-97%** |
| multipleOf.json | by int | 3 | ✅ | 73.0M | ✅ | 1.4M | 🟢 **-98%** |
| multipleOf.json | by number | 3 | ✅ | 67.3M | ✅ | 1.3M | 🟢 **-98%** |
| multipleOf.json | by small number | 2 | ✅ | 64.1M | ✅ | 910K | 🟢 **-99%** |
| multipleOf.json | float division = inf | 1 | ✅ | 41.2M | ✅ | 782K | 🟢 **-98%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 71.9M | ✅ | 1.9M | 🟢 **-97%** |
| not.json | not | 2 | ✅ | 72.9M | ✅ | 849K | 🟢 **-99%** |
| not.json | not multiple types | 3 | ✅ | 65.4M | ✅ | 892K | 🟢 **-99%** |
| not.json | not more complex schema | 3 | ✅ | 63.0M | ✅ | 555K | 🟢 **-99%** |
| not.json | forbidden property | 2 | ✅ | 50.5M | ✅ | 908K | 🟢 **-98%** |
| not.json | forbid everything with empty schema | 9 | ✅ | 61.5M | ✅ | 1.2M | 🟢 **-98%** |
| not.json | double negation | 1 | ✅ | 85.0M | ✅ | 1.3M | 🟢 **-98%** |
| oneOf.json | oneOf | 4 | ✅ | 70.9M | ✅ | 492K | 🟢 **-99%** |
| oneOf.json | oneOf with base schema | 3 | ✅ | 33.1M | ✅ | 594K | 🟢 **-98%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 43.4M | ✅ | 318K | 🟢 **-99%** |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 72.5M | ✅ | 776K | 🟢 **-99%** |
| oneOf.json | oneOf with required | 4 | ✅ | 45.6M | ✅ | 387K | 🟢 **-99%** |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 42.3M | ✅ | 390K | 🟢 **-99%** |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 58.7M | ✅ | 672K | 🟢 **-99%** |
| pattern.json | pattern validation | 8 | ✅ | 53.2M | ✅ | 2.1M | 🟢 **-96%** |
| pattern.json | pattern is not anchored | 1 | ✅ | 21.3M | ✅ | 2.5M | 🟢 **-88%** |
| patternProperties.json | patternProperties validates propertie... | 7 | ✅ | 26.6M | ✅ | 759K | 🟢 **-97%** |
| patternProperties.json | multiple simultaneous patternProperti... | 6 | ✅ | 14.2M | ✅ | 456K | 🟢 **-97%** |
| patternProperties.json | regexes are not anchored by default a... | 4 | ✅ | 16.2M | ✅ | 648K | 🟢 **-96%** |
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 16.5M | ✅ | 1.3M | 🟢 **-92%** |
| properties.json | object properties validation | 6 | ✅ | 53.5M | ✅ | 768K | 🟢 **-99%** |
| properties.json | properties, patternProperties, additi... | 8 | ✅ | 19.7M | ✅ | 588K | 🟢 **-97%** |
| properties.json | properties with escaped characters | 2 | ✅ | 44.6M | ✅ | 195K | 🟢 **-100%** |
| properties.json | properties with null valued instance ... | 1 | ✅ | 67.1M | ✅ | 1.7M | 🟢 **-98%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 27.6M | ❌ | - | - |
| ref.json | root pointer ref | 4 | ✅ | 22.3M | ✅ | 784K | 🟢 **-96%** |
| ref.json | relative pointer ref to object | 2 | ✅ | 25.5M | ✅ | 752K | 🟢 **-97%** |
| ref.json | relative pointer ref to array | 2 | ✅ | 52.0M | ✅ | 699K | 🟢 **-99%** |
| ref.json | escaped pointer ref | 6 | ✅ | 44.8M | ✅ | 727K | 🟢 **-98%** |
| ref.json | nested refs | 2 | ✅ | 29.1M | ✅ | 956K | 🟢 **-97%** |
| ref.json | ref overrides any sibling keywords | 3 | ✅ | 49.2M | ✅ | 893K | 🟢 **-98%** |
| ref.json | $ref prevents a sibling id from chang... | 2 | ✅ | 73.1M | ❌ | - | - |
| ref.json | remote ref, containing refs itself | 2 | ✅ | 24.6M | ✅ | 345K | 🟢 **-99%** |
| ref.json | property named $ref that is not a ref... | 2 | ✅ | 53.3M | ✅ | 772K | 🟢 **-99%** |
| ref.json | property named $ref, containing an ac... | 2 | ✅ | 51.9M | ✅ | 735K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 11.1M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 51.6M | ✅ | 734K | 🟢 **-99%** |
| ref.json | Location-independent identifier | 2 | ✅ | 73.1M | ✅ | 939K | 🟢 **-99%** |
...
| ref.json | empty tokens in $ref json-pointer | 2 | ✅ | 60.9M | ✅ | 962K | 🟢 **-98%** |
...
| required.json | required validation | 5 | ✅ | 62.6M | ✅ | 1.7M | 🟢 **-97%** |
| required.json | required default validation | 1 | ✅ | 84.0M | ✅ | 3.0M | 🟢 **-96%** |
| required.json | required with escaped characters | 2 | ✅ | 49.9M | ✅ | 586K | 🟢 **-99%** |
| required.json | required properties whose names are J... | 7 | ✅ | 27.3M | ❌ | - | - |
| type.json | integer type matches integers | 8 | ✅ | 61.5M | ✅ | 896K | 🟢 **-99%** |
| type.json | number type matches numbers | 9 | ✅ | 66.1M | ✅ | 1.1M | 🟢 **-98%** |
| type.json | string type matches strings | 9 | ✅ | 65.4M | ✅ | 1.1M | 🟢 **-98%** |
| type.json | object type matches objects | 7 | ✅ | 56.7M | ✅ | 885K | 🟢 **-98%** |
| type.json | array type matches arrays | 7 | ✅ | 61.2M | ✅ | 894K | 🟢 **-99%** |
| type.json | boolean type matches booleans | 10 | ✅ | 62.8M | ✅ | 968K | 🟢 **-98%** |
| type.json | null type matches only the null object | 10 | ✅ | 62.9M | ✅ | 862K | 🟢 **-99%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 63.4M | ✅ | 863K | 🟢 **-99%** |
| type.json | type as array with one item | 2 | ✅ | 73.1M | ✅ | 1.3M | 🟢 **-98%** |
| type.json | type: array or object | 5 | ✅ | 68.8M | ✅ | 878K | 🟢 **-99%** |
| type.json | type: array, object or null | 5 | ✅ | 73.1M | ✅ | 1.2M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 17.8M | ✅ | 1.5M | 🟢 **-92%** |
| uniqueItems.json | uniqueItems with an array of items | 8 | ✅ | 32.5M | ✅ | 722K | 🟢 **-98%** |
| uniqueItems.json | uniqueItems with an array of items an... | 5 | ✅ | 18.7M | ✅ | 726K | 🟢 **-96%** |
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 86.2M | ✅ | 3.7M | 🟢 **-96%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 68.8M | ✅ | 1.3M | 🟢 **-98%** |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 64.2M | ✅ | 1.1M | 🟢 **-98%** |
| optional/bignum.json | integer | 2 | ✅ | 83.8M | ✅ | 2.6M | 🟢 **-97%** |
| optional/bignum.json | number | 2 | ✅ | 83.1M | ✅ | 2.6M | 🟢 **-97%** |
| optional/bignum.json | string | 1 | ✅ | 60.9M | ✅ | 988K | 🟢 **-98%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 75.2M | ✅ | 3.7M | 🟢 **-95%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 57.7M | ✅ | 797K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 75.2M | ✅ | 3.6M | 🟢 **-95%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 57.7M | ✅ | 847K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 28.1M | ✅ | 812K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 28.8M | ✅ | 822K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 27.8M | ✅ | 826K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 26.2M | ✅ | 809K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 28.0M | ✅ | 741K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 25.0M | ✅ | 1.0M | 🟢 **-96%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 28.0M | ✅ | 826K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 26.0M | ✅ | 835K | 🟢 **-97%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 25.8M | ✅ | 1.4M | 🟢 **-95%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 29.9M | ✅ | 644K | 🟢 **-98%** |
| optional/ecmascript-regex.json | patterns always use unicode semantics... | 4 | ✅ | 16.9M | ❌ | - | - |
| optional/ecmascript-regex.json | \w in patterns matches [A-Za-z0-9_], ... | 4 | ✅ | 15.3M | ✅ | 798K | 🟢 **-95%** |
| optional/ecmascript-regex.json | pattern with ASCII ranges | 3 | ✅ | 15.4M | ✅ | 909K | 🟢 **-94%** |
| optional/ecmascript-regex.json | \d in pattern matches [0-9], not unic... | 3 | ✅ | 27.8M | ✅ | 808K | 🟢 **-97%** |
...
| optional/ecmascript-regex.json | \w in patternProperties matches [A-Za... | 4 | ✅ | 20.4M | ✅ | 656K | 🟢 **-97%** |
| optional/ecmascript-regex.json | patternProperties with ASCII ranges | 3 | ✅ | 19.8M | ✅ | 700K | 🟢 **-96%** |
| optional/ecmascript-regex.json | \d in patternProperties matches [0-9]... | 3 | ✅ | 8.1M | ✅ | 652K | 🟢 **-92%** |
...
| optional/format/email.json | validation of e-mail addresses | 17 | ✅ | 18.4M | ✅ | 422K | 🟢 **-98%** |
| optional/format/hostname.json | validation of host names | 27 | ✅ | 11.1M | ✅ | 1.1M | 🟢 **-90%** |
| optional/format/ipv4.json | validation of IP addresses | 16 | ✅ | 37.5M | ✅ | 1.2M | 🟢 **-97%** |
...
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 163.2M | ❌ | - | - |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 79.9M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 150.8M | ❌ | - | - |
...
| allOf.json | allOf with one empty schema | 1 | ✅ | 52.8M | ❌ | - | - |
...
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 93.5M | ❌ | - | - |
...
| default.json | invalid string value for default | 2 | ✅ | 55.1M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 76.6M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 90.6M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 64.0M | ❌ | - | - |
...
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 76.0M | ❌ | - | - |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 93.6M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 36.1M | ❌ | - | - |
...
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 158.8M | ❌ | - | - |
...
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 152.3M | ❌ | - | - |
...
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 119.3M | ❌ | - | - |
...
| contains.json | contains with null instance elements | 1 | ✅ | 56.3M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 107.7M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 51.4M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 65.4M | ❌ | - | - |
| definitions.json | validate definition against metaschema | 2 | ✅ | 10.6M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 90.6M | ❌ | - | - |
| dependencies.json | dependencies with empty array | 3 | ✅ | 84.8M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 56.0M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 59.0M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 65.8M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 15.6M | ❌ | - | - |
| enum.json | enum with escaped characters | 3 | ✅ | 69.9M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 81.1M | ❌ | - | - |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 83.2M | ❌ | - | - |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 58.0M | ❌ | - | - |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 14.3M | ❌ | - | - |
...
| type.json | object type matches objects | 7 | ✅ | 54.8M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 23.5M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 28.1M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 24.3M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 25.6M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 25.2M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 24.6M | ❌ | - | - |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 90.0M | ❌ | - | - |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 132.1M | ❌ | - | - |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 93.9M | ❌ | - | - |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 124.5M | ❌ | - | - |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 46.5M | ✅ | 338K | 🟢 **-99%** |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 153.1M | ❌ | - | - |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 81.0M | ❌ | - | - |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 34.0M | ✅ | 405K | 🟢 **-99%** |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 52.5M | ❌ | - | - |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 29.3M | ❌ | - | - |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 28.0M | ✅ | 428K | 🟢 **-98%** |
| allOf.json | allOf | 4 | ✅ | 47.8M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 27.5M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 137.9M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 89.9M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 146.5M | ✅ | 487K | 🟢 **-100%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 485K | 🟢 **-99%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 152.9M | ❌ | - | - |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 80.9M | ❌ | - | - |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 117.8M | ❌ | - | - |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 76.6M | ❌ | - | - |
...
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 492K | 🟢 **-99%** |
...
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 86.4M | ❌ | - | - |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 78.9M | ❌ | - | - |
| default.json | invalid type for default | 2 | ✅ | 36.0M | ❌ | - | - |
| default.json | invalid string value for default | 2 | ✅ | 54.9M | ❌ | - | - |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 29.6M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 58.6M | ✅ | 492K | 🟢 **-99%** |
...
| multipleOf.json | by small number | 2 | ✅ | 66.8M | ❌ | - | - |
| multipleOf.json | float division = inf | 1 | ✅ | 42.3M | ✅ | 470K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 60.4M | ✅ | 531K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 90.4M | ✅ | 521K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 66.1M | ✅ | 453K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 90.0M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 66.1M | ✅ | 471K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 466K | 🟢 **-99%** |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 13.2M | ❌ | - | - |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 45.3M | ❌ | - | - |
...
| ref.json | $ref to boolean schema true | 1 | ✅ | 89.9M | ❌ | - | - |
| ref.json | $ref to boolean schema false | 1 | ✅ | 89.7M | ✅ | 426K | 🟢 **-100%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.6M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 54.6M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 27.6M | ✅ | 399K | 🟢 **-99%** |
...
| type.json | boolean type matches booleans | 10 | ✅ | 86.0M | ❌ | - | - |
| type.json | null type matches only the null object | 10 | ✅ | 65.9M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 41.6M | ✅ | 372K | 🟢 **-99%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 47.0M | ✅ | 421K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 43.4M | ✅ | 404K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 26.0M | ✅ | 366K | 🟢 **-99%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 30.1M | ✅ | 425K | 🟢 **-99%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 30.0M | ✅ | 426K | 🟢 **-99%** |
...
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 26.6M | ✅ | 446K | 🟢 **-98%** |
| unevaluatedProperties.json | nested unevaluatedProperties, outer t... | 2 | ✅ | 28.1M | ❌ | - | - |
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 21.5M | ✅ | 434K | 🟢 **-98%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 24.8M | ✅ | 414K | 🟢 **-98%** |
...
| optional/bignum.json | number | 2 | ✅ | 88.7M | ❌ | - | - |
| optional/bignum.json | string | 1 | ✅ | 63.4M | ✅ | 491K | 🟢 **-99%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 78.9M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 60.0M | ✅ | 494K | 🟢 **-99%** |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 78.9M | ❌ | - | - |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 60.0M | ✅ | 502K | 🟢 **-99%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 36.2M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 20.1M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 24.4M | ❌ | - | - |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 66.3M | ✅ | 1.7M | 🟢 **-97%** |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 153.0M | ❌ | - | - |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 29.8M | ✅ | 578K | 🟢 **-98%** |
...
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 31.5M | ✅ | 549K | 🟢 **-98%** |
| allOf.json | allOf | 4 | ✅ | 40.1M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 31.1M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 72.7M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 126.7M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 66.1M | ✅ | 725K | 🟢 **-99%** |
...
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 89.9M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 89.9M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 700K | 🟢 **-99%** |
...
| contains.json | contains with false if subschema | 2 | ✅ | 68.9M | ❌ | - | - |
| contains.json | contains with null instance elements | 1 | ✅ | 77.1M | ❌ | - | - |
| content.json | validation of string-encoded content ... | 3 | ✅ | 95.4M | ❌ | - | - |
| content.json | validation of binary string-encoding | 3 | ✅ | 95.4M | ❌ | - | - |
...
| default.json | the default keyword does not do anyth... | 3 | ✅ | 52.8M | ❌ | - | - |
...
| enum.json | simple enum validation | 2 | ✅ | 70.7M | ❌ | - | - |
| enum.json | heterogeneous enum validation | 5 | ✅ | 45.7M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 63.7M | ❌ | - | - |
| enum.json | enums in properties | 6 | ✅ | 15.0M | ❌ | - | - |
...
| enum.json | nul characters in strings | 2 | ✅ | 61.3M | ❌ | - | - |
...
| minContains.json | maxContains < minContains | 4 | ✅ | 59.0M | ✅ | 649K | 🟢 **-99%** |
...
| multipleOf.json | by small number | 2 | ✅ | 66.8M | ❌ | - | - |
| multipleOf.json | float division = inf | 1 | ✅ | 57.8M | ✅ | 684K | 🟢 **-99%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 75.2M | ❌ | - | - |
| not.json | not | 2 | ✅ | 77.0M | ❌ | - | - |
| not.json | not multiple types | 3 | ✅ | 70.9M | ❌ | - | - |
| not.json | not more complex schema | 3 | ✅ | 68.9M | ❌ | - | - |
| not.json | forbidden property | 2 | ✅ | 54.1M | ❌ | - | - |
| not.json | forbid everything with empty schema | 9 | ✅ | 65.3M | ✅ | 713K | 🟢 **-99%** |
| not.json | forbid everything with boolean schema... | 9 | ✅ | 60.1M | ✅ | 749K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 66.1M | ✅ | 684K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 89.9M | ❌ | - | - |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 66.1M | ✅ | 687K | 🟢 **-99%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 66.1M | ✅ | 686K | 🟢 **-99%** |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 21.1M | ❌ | - | - |
...
| ref.json | $ref to boolean schema true | 1 | ✅ | 89.9M | ❌ | - | - |
| ref.json | $ref to boolean schema false | 1 | ✅ | 66.1M | ✅ | 666K | 🟢 **-99%** |
| ref.json | Recursive references between schemas | 2 | ✅ | 8.7M | ❌ | - | - |
| ref.json | refs with quote | 2 | ✅ | 54.9M | ❌ | - | - |
| ref.json | ref creates new scope when adjacent t... | 1 | ✅ | 25.1M | ✅ | 572K | 🟢 **-98%** |
| ref.json | naive replacement of $ref with its de... | 3 | ✅ | 56.9M | ❌ | - | - |
...
| type.json | object type matches objects | 7 | ✅ | 59.0M | ❌ | - | - |
| type.json | array type matches arrays | 7 | ✅ | 64.6M | ❌ | - | - |
| type.json | boolean type matches booleans | 10 | ✅ | 56.8M | ❌ | - | - |
...
| type.json | type: array, object or null | 5 | ✅ | 76.6M | ❌ | - | - |
| unevaluatedItems.json | unevaluatedItems true | 2 | ✅ | 83.0M | ❌ | - | - |
...
| unevaluatedItems.json | unevaluatedItems with not | 1 | ✅ | 41.3M | ✅ | 537K | 🟢 **-99%** |
...
| unevaluatedItems.json | unevaluatedItems can't see inside cou... | 1 | ✅ | 46.4M | ✅ | 610K | 🟢 **-99%** |
...
| unevaluatedItems.json | Evaluated items collection needs to c... | 1 | ✅ | 42.3M | ✅ | 576K | 🟢 **-99%** |
| unevaluatedProperties.json | unevaluatedProperties true | 2 | ✅ | 58.2M | ❌ | - | - |
...
| unevaluatedProperties.json | unevaluatedProperties with not | 1 | ✅ | 23.8M | ✅ | 506K | 🟢 **-98%** |
...
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 30.2M | ✅ | 596K | 🟢 **-98%** |
| unevaluatedProperties.json | unevaluatedProperties can't see insid... | 1 | ✅ | 29.2M | ✅ | 598K | 🟢 **-98%** |
...
| unevaluatedProperties.json | cousin unevaluatedProperties, true an... | 2 | ✅ | 20.5M | ✅ | 568K | 🟢 **-97%** |
...
| unevaluatedProperties.json | Evaluated properties collection needs... | 1 | ✅ | 23.5M | ✅ | 549K | 🟢 **-98%** |
...
| optional/bignum.json | integer | 2 | ✅ | 88.5M | ❌ | - | - |
| optional/bignum.json | number | 2 | ✅ | 88.7M | ❌ | - | - |
| optional/bignum.json | string | 1 | ✅ | 63.3M | ✅ | 731K | 🟢 **-99%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 78.9M | ❌ | - | - |
...
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 95.8M | ❌ | - | - |
...
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 28.0M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 28.3M | ❌ | - | - |
...
| optional/format/ecmascript-regex.json | \a is not an ECMA 262 control escape | 1 | ✅ | 51.3M | ✅ | 724K | 🟢 **-99%** |
...
| optional/no-schema.json | validation without $schema | 3 | ✅ | 64.1M | ✅ | 2.6M | 🟢 **-96%** |
