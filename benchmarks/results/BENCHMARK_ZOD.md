...
|-------|-------:|---------:|----------:|-----------:|----------:|----------:|-----:|
| draft4 | 199 | 198/199 | 26.5M | 73/199 | 146K | 73 | 🟢 **-99%** |
| draft6 | 276 | ✅ 276 | 29.7M | 102/276 | 150K | 102 | 🟢 **-99%** |
| draft7 | 313 | ✅ 313 | 16.3M | 110/313 | 169K | 110 | 🟢 **-99%** |
| draft2019-09 | 435 | ✅ 435 | 17.5M | 125/435 | 184K | 125 | 🟢 **-99%** |
| draft2020-12 | 448 | ✅ 448 | 19.6M | 121/448 | 192K | 121 | 🟢 **-99%** |
...
**Result**: 🟢 **tjs** is **319.74x faster** (18 ns vs 5902 ns per test, 1962 tests in 531 groups)
...
| additionalItems.json | when items is schema, additionalItems... | 1 | ✅ | 159.1M | ✅ | 50.3M | 🟢 **-68%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 132.8M | ❌ | - | - |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 171.6M | ✅ | 43.2M | 🟢 **-75%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 126.1M | ✅ | 65.2M | 🟢 **-48%** |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 154.2M | ✅ | 43.7M | 🟢 **-72%** |
...
| additionalProperties.json | additionalProperties with schema | 3 | ✅ | 33.2M | ❌ | - | - |
| additionalProperties.json | additionalProperties can exist by itself | 2 | ✅ | 48.1M | ❌ | - | - |
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 158.8M | ✅ | 43.9M | 🟢 **-72%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 39.3M | ❌ | - | - |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 46.7M | ✅ | 43.9M | -6% |
| allOf.json | allOf | 4 | ✅ | 49.1M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 23.0M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 113.7M | ❌ | - | - |
| allOf.json | allOf with one empty schema | 1 | ✅ | 159.0M | ✅ | 27.4M | 🟢 **-83%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.5M | ✅ | 5.8M | 🟢 **-96%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 55.7M | ✅ | 138K | 🟢 **-100%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 115.7M | ✅ | 103K | 🟢 **-100%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 57.6M | ✅ | 127K | 🟢 **-100%** |
...
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 171.1M | ✅ | 10.5M | 🟢 **-94%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 57.6M | ✅ | 118K | 🟢 **-100%** |
| default.json | invalid type for default | 2 | ✅ | 101.3M | ✅ | 25.2M | 🟢 **-75%** |
| default.json | invalid string value for default | 2 | ✅ | 48.7M | ✅ | 25.3M | 🟢 **-48%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 78.7M | ✅ | 176K | 🟢 **-100%** |
...
| enum.json | simple enum validation | 2 | ✅ | 56.6M | ✅ | 88K | 🟢 **-100%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 60.4M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 59.4M | ✅ | 144K | 🟢 **-100%** |
| enum.json | enums in properties | 6 | ✅ | 48.9M | ✅ | 89K | 🟢 **-100%** |
| enum.json | enum with escaped characters | 3 | ✅ | 49.5M | ✅ | 180K | 🟢 **-100%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 110.4M | ✅ | 94K | 🟢 **-100%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 48.1M | ❌ | - | - |
| enum.json | enum with true does not match 1 | 3 | ✅ | 106.9M | ✅ | 95K | 🟢 **-100%** |
...
| enum.json | enum with 1 does not match true | 3 | ✅ | 114.4M | ✅ | 186K | 🟢 **-100%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 53.4M | ❌ | - | - |
| enum.json | nul characters in strings | 2 | ✅ | 88.8M | ✅ | 123K | 🟢 **-100%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 46.2M | ✅ | 119K | 🟢 **-100%** |
| enum.json | characters with the same visual repre... | 2 | ✅ | 91.3M | ✅ | 124K | 🟢 **-100%** |
| format.json | email format | 6 | ✅ | 74.0M | ✅ | 27.1M | 🟢 **-63%** |
| format.json | ipv4 format | 6 | ✅ | 163.3M | ✅ | 26.5M | 🟢 **-84%** |
| format.json | ipv6 format | 6 | ✅ | 79.2M | ✅ | 28.6M | 🟢 **-64%** |
| format.json | hostname format | 6 | ✅ | 163.7M | ✅ | 26.9M | 🟢 **-84%** |
| format.json | date-time format | 6 | ✅ | 78.5M | ✅ | 28.3M | 🟢 **-64%** |
| format.json | uri format | 6 | ✅ | 163.6M | ✅ | 26.8M | 🟢 **-84%** |
...
| items.json | nested items | 3 | ✅ | 12.9M | ✅ | 67K | 🟢 **-99%** |
| items.json | items with null instance elements | 1 | ✅ | 70.3M | ✅ | 27.5M | 🟢 **-61%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 75.2M | ✅ | 26.3M | 🟢 **-65%** |
...
| multipleOf.json | float division = inf | 1 | ✅ | 39.0M | ✅ | 46K | 🟢 **-100%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 63.5M | ✅ | 808K | 🟢 **-99%** |
| not.json | not | 2 | ✅ | 55.9M | ❌ | - | - |
| not.json | not multiple types | 3 | ✅ | 49.0M | ❌ | - | - |
| not.json | not more complex schema | 3 | ✅ | 52.7M | ❌ | - | - |
| not.json | forbidden property | 2 | ✅ | 42.4M | ❌ | - | - |
| not.json | forbid everything with empty schema | 9 | ✅ | 40.9M | ✅ | 67K | 🟢 **-100%** |
...
| oneOf.json | oneOf with empty schema | 2 | ✅ | 55.2M | ✅ | 125K | 🟢 **-100%** |
| oneOf.json | oneOf with required | 4 | ✅ | 38.3M | ❌ | - | - |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 40.2M | ❌ | - | - |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 55.7M | ✅ | 124K | 🟢 **-100%** |
| pattern.json | pattern validation | 8 | ✅ | 49.1M | ❌ | - | - |
| pattern.json | pattern is not anchored | 1 | ✅ | 46.1M | ✅ | 25.6M | 🟢 **-44%** |
...
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 17.4M | ✅ | 25.7M | 🔴 **+48%** |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 60.0M | ✅ | 24.9M | 🟢 **-58%** |
...
| required.json | required default validation | 1 | ✅ | 159.5M | ✅ | 25.6M | 🟢 **-84%** |
| required.json | required with escaped characters | 2 | ✅ | 40.6M | ❌ | - | - |
| required.json | required properties whose names are J... | 7 | ✅ | 23.4M | ❌ | - | - |
| type.json | integer type matches integers | 8 | ✅ | 41.3M | ✅ | 73K | 🟢 **-100%** |
| type.json | number type matches numbers | 9 | ✅ | 45.7M | ✅ | 102K | 🟢 **-100%** |
| type.json | string type matches strings | 9 | ✅ | 48.4M | ✅ | 103K | 🟢 **-100%** |
| type.json | object type matches objects | 7 | ✅ | 41.4M | ✅ | 80K | 🟢 **-100%** |
| type.json | array type matches arrays | 7 | ✅ | 44.5M | ✅ | 79K | 🟢 **-100%** |
| type.json | boolean type matches booleans | 10 | ✅ | 44.0M | ✅ | 86K | 🟢 **-100%** |
| type.json | null type matches only the null object | 10 | ✅ | 42.8M | ✅ | 78K | 🟢 **-100%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 46.1M | ✅ | 71K | 🟢 **-100%** |
| type.json | type as array with one item | 2 | ✅ | 55.7M | ✅ | 124K | 🟢 **-100%** |
| type.json | type: array or object | 5 | ✅ | 49.6M | ✅ | 78K | 🟢 **-100%** |
| type.json | type: array, object or null | 5 | ✅ | 55.7M | ✅ | 107K | 🟢 **-100%** |
...
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 161.3M | ✅ | 25.7M | 🟢 **-84%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 70.0M | ✅ | 25.7M | 🟢 **-63%** |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 58.8M | ❌ | - | - |
| optional/bignum.json | integer | 2 | ✅ | 72.5M | ❌ | - | - |
| optional/bignum.json | number | 2 | ✅ | 76.0M | ✅ | 24.3M | 🟢 **-68%** |
| optional/bignum.json | string | 1 | ✅ | 42.5M | ✅ | 62K | 🟢 **-100%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 70.3M | ✅ | 25.5M | 🟢 **-64%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 40.9M | ❌ | - | - |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 70.3M | ✅ | 25.4M | 🟢 **-64%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 40.9M | ❌ | - | - |
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 48.6M | ✅ | 115K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 18.3M | ✅ | 116K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 25.5M | ✅ | 116K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 18.2M | ✅ | 115K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 25.0M | ✅ | 87K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 24.5M | ✅ | 173K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 24.4M | ✅ | 117K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 24.1M | ✅ | 117K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 25.0M | ✅ | 313K | 🟢 **-99%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 74.6M | ✅ | 25.6M | 🟢 **-66%** |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 158.3M | ✅ | 50.1M | 🟢 **-68%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 77.0M | ❌ | - | - |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 167.7M | ✅ | 43.0M | 🟢 **-74%** |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 158.6M | ✅ | 43.9M | 🟢 **-72%** |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 158.1M | ✅ | 43.5M | 🟢 **-73%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 28.7M | ❌ | - | - |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 66.7M | ✅ | 41.9M | 🟢 **-37%** |
| allOf.json | allOf | 4 | ✅ | 34.8M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 30.5M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 51.1M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 159.3M | ✅ | 5.6M | 🟢 **-96%** |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 49.8M | ✅ | 70K | 🟢 **-100%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 61K | 🟢 **-100%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 157.4M | ✅ | 25.2M | 🟢 **-84%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.3M | ✅ | 5.2M | 🟢 **-97%** |
...
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 64.8M | ✅ | 130K | 🟢 **-100%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 83.3M | ❌ | - | - |
| anyOf.json | anyOf | 4 | ✅ | 66.7M | ❌ | - | - |
| anyOf.json | anyOf with base schema | 3 | ✅ | 45.7M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 158.7M | ✅ | 17.1M | 🟢 **-89%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 157.7M | ✅ | 18.9M | 🟢 **-88%** |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 49.8M | ✅ | 47K | 🟢 **-100%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 74.6M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 166.8M | ✅ | 10.4M | 🟢 **-94%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 119.7M | ✅ | 120K | 🟢 **-100%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 179.6M | ✅ | 30.3M | 🟢 **-83%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 90.8M | ✅ | 70K | 🟢 **-100%** |
| const.json | const validation | 3 | ✅ | 54.9M | ✅ | 90K | 🟢 **-100%** |
...
| const.json | const with true does not match 1 | 3 | ✅ | 54.7M | ✅ | 90K | 🟢 **-100%** |
...
| const.json | const with 0 does not match other zer... | 6 | ✅ | 51.6M | ✅ | 90K | 🟢 **-100%** |
| const.json | const with 1 does not match true | 3 | ✅ | 57.9M | ✅ | 179K | 🟢 **-100%** |
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 55.7M | ✅ | 100K | 🟢 **-100%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 110.0M | ✅ | 117K | 🟢 **-100%** |
| const.json | nul characters in strings | 2 | ✅ | 53.8M | ✅ | 120K | 🟢 **-100%** |
...
| contains.json | contains with null instance elements | 1 | ✅ | 80.9M | ✅ | 20.6M | 🟢 **-75%** |
| default.json | invalid type for default | 2 | ✅ | 101.3M | ✅ | 30.3M | 🟢 **-70%** |
| default.json | invalid string value for default | 2 | ✅ | 52.7M | ✅ | 25.2M | 🟢 **-52%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 78.0M | ✅ | 175K | 🟢 **-100%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 12.2M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 50.4M | ❌ | - | - |
| dependencies.json | dependencies with empty array | 3 | ✅ | 171.5M | ✅ | 24.5M | 🟢 **-86%** |
...
| enum.json | simple enum validation | 2 | ✅ | 63.5M | ✅ | 89K | 🟢 **-100%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 61.2M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 61.2M | ✅ | 146K | 🟢 **-100%** |
| enum.json | enums in properties | 6 | ✅ | 54.1M | ✅ | 89K | 🟢 **-100%** |
| enum.json | enum with escaped characters | 3 | ✅ | 59.7M | ✅ | 181K | 🟢 **-100%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 110.1M | ✅ | 95K | 🟢 **-100%** |
...
| enum.json | enum with 0 does not match false | 3 | ✅ | 113.5M | ✅ | 185K | 🟢 **-100%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 56.4M | ❌ | - | - |
| enum.json | enum with 1 does not match true | 3 | ✅ | 113.8M | ✅ | 188K | 🟢 **-100%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 56.1M | ❌ | - | - |
| enum.json | nul characters in strings | 2 | ✅ | 88.8M | ✅ | 124K | 🟢 **-100%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 55.2M | ❌ | - | - |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 112.5M | ❌ | - | - |
| format.json | email format | 6 | ✅ | 81.0M | ✅ | 22.7M | 🟢 **-72%** |
| format.json | ipv4 format | 6 | ✅ | 147.6M | ✅ | 24.4M | 🟢 **-83%** |
| format.json | ipv6 format | 6 | ✅ | 85.2M | ✅ | 24.4M | 🟢 **-71%** |
| format.json | hostname format | 6 | ✅ | 156.4M | ✅ | 24.6M | 🟢 **-84%** |
| format.json | date-time format | 6 | ✅ | 81.2M | ✅ | 21.8M | 🟢 **-73%** |
| format.json | json-pointer format | 6 | ✅ | 157.2M | ✅ | 24.5M | 🟢 **-84%** |
| format.json | uri format | 6 | ✅ | 88.5M | ✅ | 23.0M | 🟢 **-74%** |
| format.json | uri-reference format | 6 | ✅ | 157.0M | ✅ | 24.6M | 🟢 **-84%** |
| format.json | uri-template format | 6 | ✅ | 88.6M | ✅ | 24.5M | 🟢 **-72%** |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 167.5M | ✅ | 23.7M | 🟢 **-86%** |
...
| items.json | single-form items with null instance ... | 1 | ✅ | 77.1M | ✅ | 24.7M | 🟢 **-68%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 83.0M | ✅ | 24.9M | 🟢 **-70%** |
...
| multipleOf.json | small multiple of large integer | 1 | ✅ | 68.9M | ✅ | 841K | 🟢 **-99%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 49.8M | ✅ | 63K | 🟢 **-100%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 158.7M | ✅ | 5.9M | 🟢 **-96%** |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 49.8M | ✅ | 63K | 🟢 **-100%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 49.8M | ✅ | 45K | 🟢 **-100%** |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 48.1M | ✅ | 24.9M | 🟢 **-48%** |
...
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 17.8M | ✅ | 24.8M | 🔴 **+39%** |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 166.9M | ✅ | 24.3M | 🟢 **-85%** |
...
| required.json | required default validation | 1 | ✅ | 158.1M | ✅ | 23.8M | 🟢 **-85%** |
| required.json | required with empty array | 1 | ✅ | 158.6M | ✅ | 24.2M | 🟢 **-85%** |
...
| type.json | string type matches strings | 9 | ✅ | 54.4M | ✅ | 102K | 🟢 **-100%** |
...
| type.json | multiple types can be specified in an... | 7 | ✅ | 51.0M | ✅ | 71K | 🟢 **-100%** |
| type.json | type as array with one item | 2 | ✅ | 62.3M | ✅ | 125K | 🟢 **-100%** |
| type.json | type: array or object | 5 | ✅ | 54.5M | ✅ | 78K | 🟢 **-100%** |
...
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 159.4M | ✅ | 24.0M | 🟢 **-85%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 76.1M | ✅ | 24.2M | 🟢 **-68%** |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 64.0M | ❌ | - | - |
| optional/bignum.json | integer | 2 | ✅ | 79.9M | ❌ | - | - |
| optional/bignum.json | number | 2 | ✅ | 84.2M | ✅ | 22.8M | 🟢 **-73%** |
| optional/bignum.json | string | 1 | ✅ | 47.5M | ✅ | 62K | 🟢 **-100%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 77.0M | ✅ | 24.8M | 🟢 **-68%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 26.9M | ✅ | 116K | 🟢 **-100%** |
...
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 24.7M | ✅ | 172K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 26.4M | ✅ | 115K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 25.3M | ✅ | 115K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.1M | ✅ | 312K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 27.7M | ✅ | 80K | 🟢 **-100%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 81.9M | ✅ | 24.2M | 🟢 **-70%** |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 174.5M | ✅ | 23.2M | 🟢 **-87%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 77.4M | ❌ | - | - |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 191.0M | ✅ | 41.7M | 🟢 **-78%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 85.4M | ✅ | 33.4M | 🟢 **-61%** |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 174.8M | ✅ | 37.5M | 🟢 **-79%** |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 174.5M | ✅ | 39.2M | 🟢 **-78%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 29.3M | ❌ | - | - |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 70.4M | ✅ | 42.3M | 🟢 **-40%** |
| allOf.json | allOf | 4 | ✅ | 35.4M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 32.1M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 62.4M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 174.5M | ✅ | 5.7M | 🟢 **-97%** |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 51.6M | ✅ | 65K | 🟢 **-100%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 95.0M | ✅ | 65K | 🟢 **-100%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 174.8M | ✅ | 24.5M | 🟢 **-86%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 174.6M | ✅ | 5.3M | 🟢 **-97%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 65.6M | ✅ | 113K | 🟢 **-100%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 123.4M | ✅ | 115K | 🟢 **-100%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 67.0M | ✅ | 121K | 🟢 **-100%** |
| allOf.json | allOf combined with anyOf, oneOf | 8 | ✅ | 83.0M | ❌ | - | - |
| anyOf.json | anyOf | 4 | ✅ | 61.6M | ❌ | - | - |
| anyOf.json | anyOf with base schema | 3 | ✅ | 51.4M | ❌ | - | - |
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 174.7M | ✅ | 16.6M | 🟢 **-91%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 165.3M | ✅ | 20.2M | 🟢 **-88%** |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 51.5M | ✅ | 47K | 🟢 **-100%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 88.2M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 146.5M | ✅ | 10.4M | 🟢 **-93%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 123.6M | ✅ | 120K | 🟢 **-100%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 151.5M | ✅ | 31.3M | 🟢 **-79%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 88.7M | ✅ | 69K | 🟢 **-100%** |
| const.json | const validation | 3 | ✅ | 55.9M | ✅ | 89K | 🟢 **-100%** |
| const.json | const with object | 4 | ✅ | 53.6M | ❌ | - | - |
| const.json | const with array | 3 | ✅ | 46.6M | ❌ | - | - |
| const.json | const with null | 2 | ✅ | 123.9M | ✅ | 118K | 🟢 **-100%** |
| const.json | const with false does not match 0 | 3 | ✅ | 59.2M | ✅ | 90K | 🟢 **-100%** |
| const.json | const with true does not match 1 | 3 | ✅ | 106.9M | ✅ | 89K | 🟢 **-100%** |
...
| const.json | const with 0 does not match other zer... | 6 | ✅ | 52.2M | ✅ | 90K | 🟢 **-100%** |
| const.json | const with 1 does not match true | 3 | ✅ | 94.2M | ✅ | 178K | 🟢 **-100%** |
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 56.7M | ✅ | 100K | 🟢 **-100%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 113.4M | ✅ | 116K | 🟢 **-100%** |
| const.json | nul characters in strings | 2 | ✅ | 55.5M | ✅ | 120K | 🟢 **-100%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 86.5M | ✅ | 116K | 🟢 **-100%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 57.4M | ✅ | 119K | 🟢 **-100%** |
...
| contains.json | contains with null instance elements | 1 | ✅ | 133.3M | ✅ | 22.5M | 🟢 **-83%** |
| default.json | invalid type for default | 2 | ✅ | 66.9M | ✅ | 30.9M | 🟢 **-54%** |
| default.json | invalid string value for default | 2 | ✅ | 71.1M | ✅ | 25.4M | 🟢 **-64%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 47.1M | ✅ | 171K | 🟢 **-100%** |
| definitions.json | validate definition against metaschema | 2 | ✅ | 11.6M | ❌ | - | - |
| dependencies.json | dependencies | 7 | ✅ | 58.2M | ❌ | - | - |
| dependencies.json | dependencies with empty array | 3 | ✅ | 197.1M | ✅ | 25.6M | 🟢 **-87%** |
...
| enum.json | simple enum validation | 2 | ✅ | 64.3M | ✅ | 87K | 🟢 **-100%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 42.5M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 60.1M | ✅ | 143K | 🟢 **-100%** |
| enum.json | enums in properties | 6 | ✅ | 37.2M | ✅ | 95K | 🟢 **-100%** |
| enum.json | enum with escaped characters | 3 | ✅ | 68.6M | ✅ | 178K | 🟢 **-100%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 57.2M | ✅ | 94K | 🟢 **-100%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 55.5M | ❌ | - | - |
| enum.json | enum with true does not match 1 | 3 | ✅ | 60.6M | ✅ | 94K | 🟢 **-100%** |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 55.5M | ❌ | - | - |
| enum.json | enum with 0 does not match false | 3 | ✅ | 69.4M | ✅ | 185K | 🟢 **-100%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 63.7M | ❌ | - | - |
| enum.json | enum with 1 does not match true | 3 | ✅ | 69.2M | ✅ | 185K | 🟢 **-100%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 62.4M | ❌ | - | - |
| enum.json | nul characters in strings | 2 | ✅ | 53.1M | ✅ | 123K | 🟢 **-100%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 60.1M | ❌ | - | - |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 60.0M | ❌ | - | - |
| format.json | email format | 6 | ✅ | 87.7M | ✅ | 26.2M | 🟢 **-70%** |
| format.json | idn-email format | 6 | ✅ | 93.4M | ✅ | 31.2M | 🟢 **-67%** |
| format.json | regex format | 6 | ✅ | 93.7M | ✅ | 25.9M | 🟢 **-72%** |
| format.json | ipv4 format | 6 | ✅ | 93.6M | ✅ | 26.2M | 🟢 **-72%** |
| format.json | ipv6 format | 6 | ✅ | 92.9M | ✅ | 26.1M | 🟢 **-72%** |
| format.json | idn-hostname format | 6 | ✅ | 91.1M | ✅ | 26.1M | 🟢 **-71%** |
| format.json | hostname format | 6 | ✅ | 93.6M | ✅ | 31.1M | 🟢 **-67%** |
| format.json | date format | 6 | ✅ | 93.8M | ✅ | 25.8M | 🟢 **-72%** |
| format.json | date-time format | 6 | ✅ | 93.0M | ✅ | 26.0M | 🟢 **-72%** |
| format.json | time format | 6 | ✅ | 90.7M | ✅ | 23.9M | 🟢 **-74%** |
| format.json | json-pointer format | 6 | ✅ | 92.4M | ✅ | 26.2M | 🟢 **-72%** |
| format.json | relative-json-pointer format | 6 | ✅ | 84.9M | ✅ | 30.4M | 🟢 **-64%** |
| format.json | iri format | 6 | ✅ | 92.9M | ✅ | 25.6M | 🟢 **-72%** |
| format.json | iri-reference format | 6 | ✅ | 83.2M | ✅ | 26.3M | 🟢 **-68%** |
| format.json | uri format | 6 | ✅ | 93.0M | ✅ | 25.7M | 🟢 **-72%** |
| format.json | uri-reference format | 6 | ✅ | 93.4M | ✅ | 30.2M | 🟢 **-68%** |
| format.json | uri-template format | 6 | ✅ | 80.3M | ✅ | 25.9M | 🟢 **-68%** |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 164.6M | ✅ | 25.6M | 🟢 **-84%** |
...
| items.json | nested items | 3 | ✅ | 13.4M | ✅ | 68K | 🟢 **-99%** |
| items.json | single-form items with null instance ... | 1 | ✅ | 79.7M | ✅ | 24.1M | 🟢 **-70%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 85.2M | ✅ | 29.0M | 🟢 **-66%** |
...
| multipleOf.json | by small number | 2 | ✅ | 57.2M | ❌ | - | - |
| multipleOf.json | float division = inf | 1 | ✅ | 42.6M | ✅ | 47K | 🟢 **-100%** |
| multipleOf.json | small multiple of large integer | 1 | ✅ | 72.6M | ✅ | 829K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 44.7M | ✅ | 69K | 🟢 **-100%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 51.0M | ✅ | 62K | 🟢 **-100%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 174.6M | ✅ | 5.6M | 🟢 **-97%** |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 51.2M | ✅ | 62K | 🟢 **-100%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 50.8M | ✅ | 44K | 🟢 **-100%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 41.8M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 62.9M | ✅ | 124K | 🟢 **-100%** |
| oneOf.json | oneOf with required | 4 | ✅ | 41.0M | ❌ | - | - |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 45.8M | ❌ | - | - |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 64.4M | ✅ | 125K | 🟢 **-100%** |
| pattern.json | pattern validation | 8 | ✅ | 51.5M | ❌ | - | - |
| pattern.json | pattern is not anchored | 1 | ✅ | 53.0M | ✅ | 23.2M | 🟢 **-56%** |
...
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 19.4M | ✅ | 24.1M | 🔴 **+24%** |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 70.4M | ✅ | 24.1M | 🟢 **-66%** |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 187.7M | ✅ | 24.0M | 🟢 **-87%** |
...
| required.json | required default validation | 1 | ✅ | 175.1M | ✅ | 23.6M | 🟢 **-87%** |
| required.json | required with empty array | 1 | ✅ | 173.5M | ✅ | 24.1M | 🟢 **-86%** |
| required.json | required with escaped characters | 2 | ✅ | 36.6M | ❌ | - | - |
| required.json | required properties whose names are J... | 7 | ✅ | 22.7M | ❌ | - | - |
| type.json | integer type matches integers | 9 | ✅ | 51.9M | ✅ | 81K | 🟢 **-100%** |
| type.json | number type matches numbers | 9 | ✅ | 54.8M | ✅ | 101K | 🟢 **-100%** |
| type.json | string type matches strings | 9 | ✅ | 55.2M | ✅ | 100K | 🟢 **-100%** |
| type.json | object type matches objects | 7 | ✅ | 46.1M | ✅ | 79K | 🟢 **-100%** |
| type.json | array type matches arrays | 7 | ✅ | 48.0M | ✅ | 79K | 🟢 **-100%** |
| type.json | boolean type matches booleans | 10 | ✅ | 51.7M | ✅ | 85K | 🟢 **-100%** |
| type.json | null type matches only the null object | 10 | ✅ | 47.5M | ✅ | 77K | 🟢 **-100%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 49.5M | ✅ | 70K | 🟢 **-100%** |
| type.json | type as array with one item | 2 | ✅ | 65.7M | ✅ | 124K | 🟢 **-100%** |
| type.json | type: array or object | 5 | ✅ | 54.5M | ✅ | 84K | 🟢 **-100%** |
| type.json | type: array, object or null | 5 | ✅ | 62.4M | ✅ | 115K | 🟢 **-100%** |
| uniqueItems.json | uniqueItems validation | 28 | ✅ | 16.1M | ❌ | - | - |
...
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 164.8M | ✅ | 24.1M | 🟢 **-85%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 73.5M | ✅ | 25.2M | 🟢 **-66%** |
| uniqueItems.json | uniqueItems=false with an array of it... | 5 | ✅ | 60.6M | ❌ | - | - |
| optional/bignum.json | integer | 2 | ✅ | 86.6M | ❌ | - | - |
| optional/bignum.json | number | 2 | ✅ | 90.3M | ✅ | 22.7M | 🟢 **-75%** |
| optional/bignum.json | string | 1 | ✅ | 48.3M | ✅ | 62K | 🟢 **-100%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 81.0M | ✅ | 24.0M | 🟢 **-70%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 46.4M | ❌ | - | - |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 81.1M | ✅ | 23.6M | 🟢 **-71%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 54.2M | ✅ | 116K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 18.6M | ✅ | 116K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 28.1M | ✅ | 118K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 25.1M | ✅ | 117K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 26.7M | ✅ | 88K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 25.7M | ✅ | 174K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 27.8M | ✅ | 117K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 28.2M | ✅ | 117K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 26.7M | ✅ | 315K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 28.3M | ✅ | 81K | 🟢 **-100%** |
...
| optional/format/unknown.json | unknown format | 7 | ✅ | 91.1M | ✅ | 23.9M | 🟢 **-74%** |
...
| additionalItems.json | when items is schema, boolean additio... | 1 | ✅ | 155.3M | ✅ | 44.9M | 🟢 **-71%** |
| additionalItems.json | array of items with no additionalItem... | 5 | ✅ | 63.2M | ❌ | - | - |
| additionalItems.json | additionalItems as false without items | 2 | ✅ | 163.5M | ✅ | 41.0M | 🟢 **-75%** |
| additionalItems.json | additionalItems are allowed by default | 1 | ✅ | 74.9M | ✅ | 67.6M | -10% |
| additionalItems.json | additionalItems does not look in appl... | 1 | ✅ | 56.8M | ❌ | - | - |
...
| additionalItems.json | additionalItems with null instance el... | 1 | ✅ | 155.0M | ✅ | 42.7M | 🟢 **-72%** |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 155.0M | ✅ | 42.8M | 🟢 **-72%** |
| additionalProperties.json | additionalProperties does not look in... | 1 | ✅ | 19.9M | ❌ | - | - |
| additionalProperties.json | additionalProperties with null valued... | 1 | ✅ | 66.8M | ✅ | 42.4M | 🟢 **-36%** |
| additionalProperties.json | additionalProperties with propertyNames | 2 | ✅ | 27.8M | ❌ | - | - |
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 25.6M | ❌ | - | - |
| allOf.json | allOf | 4 | ✅ | 31.7M | ❌ | - | - |
| allOf.json | allOf with base schema | 5 | ✅ | 38.5M | ❌ | - | - |
| allOf.json | allOf simple types | 2 | ✅ | 54.3M | ❌ | - | - |
| allOf.json | allOf with boolean schemas, all true | 1 | ✅ | 155.3M | ✅ | 5.3M | 🟢 **-97%** |
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 43.6M | ✅ | 73K | 🟢 **-100%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 62K | 🟢 **-100%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 155.1M | ✅ | 21.2M | 🟢 **-86%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 158.8M | ✅ | 4.8M | 🟢 **-97%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 55.7M | ✅ | 115K | 🟢 **-100%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 115.4M | ✅ | 115K | 🟢 **-100%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 57.6M | ✅ | 120K | 🟢 **-100%** |
...
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 154.4M | ✅ | 13.0M | 🟢 **-92%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 152.1M | ✅ | 16.2M | 🟢 **-89%** |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 44.2M | ✅ | 48K | 🟢 **-100%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 43.0M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 164.9M | ✅ | 9.2M | 🟢 **-94%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 57.5M | ✅ | 120K | 🟢 **-100%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 183.0M | ✅ | 30.6M | 🟢 **-83%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 41.2M | ✅ | 68K | 🟢 **-100%** |
| const.json | const validation | 3 | ✅ | 49.1M | ✅ | 89K | 🟢 **-100%** |
| const.json | const with object | 4 | ✅ | 31.5M | ❌ | - | - |
| const.json | const with array | 3 | ✅ | 37.0M | ❌ | - | - |
| const.json | const with null | 2 | ✅ | 57.6M | ✅ | 118K | 🟢 **-100%** |
| const.json | const with false does not match 0 | 3 | ✅ | 51.7M | ✅ | 90K | 🟢 **-100%** |
| const.json | const with true does not match 1 | 3 | ✅ | 51.4M | ✅ | 90K | 🟢 **-100%** |
...
| const.json | const with 0 does not match other zer... | 6 | ✅ | 47.3M | ✅ | 89K | 🟢 **-100%** |
| const.json | const with 1 does not match true | 3 | ✅ | 60.0M | ✅ | 177K | 🟢 **-100%** |
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 49.3M | ✅ | 100K | 🟢 **-100%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 50.8M | ✅ | 118K | 🟢 **-100%** |
| const.json | nul characters in strings | 2 | ✅ | 45.3M | ✅ | 120K | 🟢 **-100%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 44.5M | ✅ | 115K | 🟢 **-100%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 47.0M | ✅ | 119K | 🟢 **-100%** |
...
| contains.json | contains with null instance elements | 1 | ✅ | 73.4M | ✅ | 24.1M | 🟢 **-67%** |
| content.json | validation of string-encoded content ... | 3 | ✅ | 176.1M | ✅ | 29.8M | 🟢 **-83%** |
| content.json | validation of binary string-encoding | 3 | ✅ | 175.0M | ✅ | 26.7M | 🟢 **-85%** |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 176.3M | ✅ | 27.5M | 🟢 **-84%** |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 159.8M | ✅ | 28.0M | 🟢 **-83%** |
| default.json | invalid type for default | 2 | ✅ | 61.2M | ✅ | 24.9M | 🟢 **-59%** |
| default.json | invalid string value for default | 2 | ✅ | 47.0M | ✅ | 25.7M | 🟢 **-45%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 27.3M | ✅ | 169K | 🟢 **-99%** |
...
| enum.json | simple enum validation | 2 | ✅ | 47.7M | ✅ | 88K | 🟢 **-100%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 34.8M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 51.2M | ✅ | 144K | 🟢 **-100%** |
| enum.json | enums in properties | 6 | ✅ | 33.7M | ✅ | 88K | 🟢 **-100%** |
| enum.json | enum with escaped characters | 3 | ✅ | 32.8M | ✅ | 177K | 🟢 **-99%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 47.0M | ✅ | 92K | 🟢 **-100%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 43.7M | ❌ | - | - |
| enum.json | enum with true does not match 1 | 3 | ✅ | 51.4M | ✅ | 92K | 🟢 **-100%** |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 47.6M | ❌ | - | - |
| enum.json | enum with 0 does not match false | 3 | ✅ | 58.6M | ✅ | 184K | 🟢 **-100%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 53.7M | ❌ | - | - |
| enum.json | enum with 1 does not match true | 3 | ✅ | 58.8M | ✅ | 184K | 🟢 **-100%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 53.1M | ❌ | - | - |
| enum.json | nul characters in strings | 2 | ✅ | 47.6M | ✅ | 122K | 🟢 **-100%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 47.9M | ❌ | - | - |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 48.1M | ❌ | - | - |
| format.json | email format | 6 | ✅ | 182.0M | ✅ | 25.9M | 🟢 **-86%** |
| format.json | idn-email format | 6 | ✅ | 182.6M | ✅ | 30.9M | 🟢 **-83%** |
| format.json | regex format | 6 | ✅ | 162.2M | ✅ | 27.2M | 🟢 **-83%** |
| format.json | ipv4 format | 6 | ✅ | 174.1M | ✅ | 28.1M | 🟢 **-84%** |
| format.json | ipv6 format | 6 | ✅ | 182.4M | ✅ | 26.7M | 🟢 **-85%** |
| format.json | idn-hostname format | 6 | ✅ | 174.0M | ✅ | 27.2M | 🟢 **-84%** |
| format.json | hostname format | 6 | ✅ | 171.6M | ✅ | 26.3M | 🟢 **-85%** |
| format.json | date format | 6 | ✅ | 174.2M | ✅ | 26.5M | 🟢 **-85%** |
| format.json | date-time format | 6 | ✅ | 182.5M | ✅ | 27.1M | 🟢 **-85%** |
| format.json | time format | 6 | ✅ | 181.3M | ✅ | 26.1M | 🟢 **-86%** |
| format.json | json-pointer format | 6 | ✅ | 182.6M | ✅ | 31.0M | 🟢 **-83%** |
| format.json | relative-json-pointer format | 6 | ✅ | 182.7M | ✅ | 26.3M | 🟢 **-86%** |
| format.json | iri format | 6 | ✅ | 179.0M | ✅ | 26.6M | 🟢 **-85%** |
| format.json | iri-reference format | 6 | ✅ | 181.1M | ✅ | 26.6M | 🟢 **-85%** |
| format.json | uri format | 6 | ✅ | 174.3M | ✅ | 30.4M | 🟢 **-83%** |
| format.json | uri-reference format | 6 | ✅ | 182.4M | ✅ | 25.9M | 🟢 **-86%** |
| format.json | uri-template format | 6 | ✅ | 182.3M | ✅ | 27.0M | 🟢 **-85%** |
| format.json | uuid format | 6 | ✅ | 182.0M | ✅ | 26.1M | 🟢 **-86%** |
| format.json | duration format | 6 | ✅ | 182.6M | ✅ | 31.4M | 🟢 **-83%** |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 164.5M | ✅ | 25.2M | 🟢 **-85%** |
...
| items.json | nested items | 3 | ✅ | 10.2M | ✅ | 67K | 🟢 **-99%** |
| items.json | single-form items with null instance ... | 1 | ✅ | 70.3M | ✅ | 29.8M | 🟢 **-58%** |
| items.json | array-form items with null instance e... | 1 | ✅ | 75.2M | ✅ | 25.2M | 🟢 **-66%** |
| maxContains.json | maxContains without contains is ignored | 2 | ✅ | 171.3M | ✅ | 28.8M | 🟢 **-83%** |
...
| maximum.json | maximum validation with unsigned integer | 4 | ✅ | 61.0M | ❌ | - | - |
| minContains.json | minContains without contains is ignored | 2 | ✅ | 170.9M | ✅ | 25.5M | 🟢 **-85%** |
...
| minContains.json | minContains = 0 with no maxContains | 2 | ✅ | 171.7M | ✅ | 26.4M | 🟢 **-85%** |
...
| multipleOf.json | small multiple of large integer | 1 | ✅ | 63.4M | ✅ | 765K | 🟢 **-99%** |
| not.json | not | 2 | ✅ | 56.2M | ❌ | - | - |
| not.json | not multiple types | 3 | ✅ | 49.9M | ❌ | - | - |
| not.json | not more complex schema | 3 | ✅ | 52.8M | ❌ | - | - |
| not.json | forbidden property | 2 | ✅ | 42.4M | ❌ | - | - |
| not.json | forbid everything with empty schema | 9 | ✅ | 41.2M | ✅ | 68K | 🟢 **-100%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 43.7M | ✅ | 62K | 🟢 **-100%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 159.0M | ✅ | 4.0M | 🟢 **-97%** |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 44.3M | ✅ | 60K | 🟢 **-100%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 44.2M | ✅ | 44K | 🟢 **-100%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 36.0M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 55.2M | ✅ | 121K | 🟢 **-100%** |
...
| pattern.json | pattern is not anchored | 1 | ✅ | 34.9M | ✅ | 23.6M | 🟢 **-32%** |
...
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 14.9M | ✅ | 22.7M | 🔴 **+53%** |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 60.0M | ✅ | 23.8M | 🟢 **-60%** |
...
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 170.5M | ✅ | 24.8M | 🟢 **-85%** |
...
| recursiveRef.json | $recursiveRef with nesting | 5 | ✅ | 2.7M | ✅ | 2.8M | +5% |
...
| ref.json | nested refs | 2 | ✅ | 30.2M | ✅ | 121K | 🟢 **-100%** |
...
| ref.json | $ref to boolean schema true | 1 | ✅ | 159.0M | ✅ | 22.1M | 🟢 **-86%** |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 55.7M | ✅ | 122K | 🟢 **-100%** |
...
| required.json | required default validation | 1 | ✅ | 159.4M | ✅ | 23.4M | 🟢 **-85%** |
| required.json | required with empty array | 1 | ✅ | 159.2M | ✅ | 24.5M | 🟢 **-85%** |
| required.json | required with escaped characters | 2 | ✅ | 38.3M | ❌ | - | - |
| required.json | required properties whose names are J... | 7 | ✅ | 15.2M | ❌ | - | - |
| type.json | integer type matches integers | 9 | ✅ | 42.7M | ✅ | 86K | 🟢 **-100%** |
| type.json | number type matches numbers | 9 | ✅ | 45.1M | ✅ | 102K | 🟢 **-100%** |
| type.json | string type matches strings | 9 | ✅ | 47.3M | ✅ | 102K | 🟢 **-100%** |
| type.json | object type matches objects | 7 | ✅ | 39.9M | ✅ | 79K | 🟢 **-100%** |
| type.json | array type matches arrays | 7 | ✅ | 44.9M | ✅ | 78K | 🟢 **-100%** |
| type.json | boolean type matches booleans | 10 | ✅ | 43.2M | ✅ | 85K | 🟢 **-100%** |
| type.json | null type matches only the null object | 10 | ✅ | 43.0M | ✅ | 76K | 🟢 **-100%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 53.8M | ✅ | 70K | 🟢 **-100%** |
| type.json | type as array with one item | 2 | ✅ | 55.7M | ✅ | 123K | 🟢 **-100%** |
| type.json | type: array or object | 5 | ✅ | 48.3M | ✅ | 87K | 🟢 **-100%** |
| type.json | type: array, object or null | 5 | ✅ | 54.2M | ✅ | 118K | 🟢 **-100%** |
...
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 161.0M | ✅ | 26.3M | 🟢 **-84%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 69.9M | ✅ | 26.9M | 🟢 **-62%** |
...
| optional/bignum.json | number | 2 | ✅ | 76.0M | ✅ | 21.8M | 🟢 **-71%** |
| optional/bignum.json | string | 1 | ✅ | 42.6M | ✅ | 61K | 🟢 **-100%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 70.3M | ✅ | 23.4M | 🟢 **-67%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 40.9M | ❌ | - | - |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 70.2M | ✅ | 24.3M | 🟢 **-65%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 40.9M | ❌ | - | - |
...
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 176.9M | ✅ | 26.0M | 🟢 **-85%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 46.8M | ✅ | 116K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 13.4M | ✅ | 116K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 15.5M | ✅ | 117K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 regex escapes control codes ... | 2 | ✅ | 16.2M | ✅ | 117K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 15.2M | ✅ | 88K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 15.1M | ✅ | 173K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 16.2M | ✅ | 117K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 15.8M | ✅ | 117K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 15.3M | ✅ | 315K | 🟢 **-98%** |
| optional/ecmascript-regex.json | ECMA 262 \S matches everything but wh... | 11 | ✅ | 15.7M | ✅ | 80K | 🟢 **-99%** |
...
| optional/format/time.json | validation of time strings | 46 | ✅ | 6.5M | ❌ | - | - |
| optional/format/unknown.json | unknown format | 7 | ✅ | 74.2M | ✅ | 24.4M | 🟢 **-67%** |
...
| additionalProperties.json | additionalProperties are allowed by d... | 1 | ✅ | 159.2M | ✅ | 21.0M | 🟢 **-87%** |
...
| additionalProperties.json | dependentSchemas with additionalPrope... | 3 | ✅ | 33.5M | ❌ | - | - |
...
| allOf.json | allOf with boolean schemas, some false | 1 | ✅ | 46.9M | ✅ | 72K | 🟢 **-100%** |
| allOf.json | allOf with boolean schemas, all false | 1 | ✅ | 92.5M | ✅ | 66K | 🟢 **-100%** |
| allOf.json | allOf with one empty schema | 1 | ✅ | 159.3M | ✅ | 25.5M | 🟢 **-84%** |
| allOf.json | allOf with two empty schemas | 1 | ✅ | 159.4M | ✅ | 5.0M | 🟢 **-97%** |
| allOf.json | allOf with the first empty schema | 2 | ✅ | 58.9M | ✅ | 143K | 🟢 **-100%** |
| allOf.json | allOf with the last empty schema | 2 | ✅ | 115.7M | ✅ | 144K | 🟢 **-100%** |
| allOf.json | nested allOf, to check validation sem... | 2 | ✅ | 47.0M | ✅ | 129K | 🟢 **-100%** |
...
| anyOf.json | anyOf with boolean schemas, all true | 1 | ✅ | 157.2M | ✅ | 15.4M | 🟢 **-90%** |
| anyOf.json | anyOf with boolean schemas, some true | 1 | ✅ | 159.3M | ✅ | 18.6M | 🟢 **-88%** |
| anyOf.json | anyOf with boolean schemas, all false | 1 | ✅ | 46.9M | ✅ | 49K | 🟢 **-100%** |
| anyOf.json | anyOf complex types | 4 | ✅ | 42.8M | ❌ | - | - |
| anyOf.json | anyOf with one empty schema | 2 | ✅ | 171.6M | ✅ | 10.5M | 🟢 **-94%** |
| anyOf.json | nested anyOf, to check validation sem... | 2 | ✅ | 61.0M | ✅ | 127K | 🟢 **-100%** |
| boolean_schema.json | boolean schema 'true' | 9 | ✅ | 179.4M | ✅ | 28.7M | 🟢 **-84%** |
| boolean_schema.json | boolean schema 'false' | 9 | ✅ | 42.6M | ✅ | 69K | 🟢 **-100%** |
| const.json | const validation | 3 | ✅ | 49.7M | ✅ | 100K | 🟢 **-100%** |
| const.json | const with object | 4 | ✅ | 33.5M | ❌ | - | - |
| const.json | const with array | 3 | ✅ | 41.4M | ❌ | - | - |
| const.json | const with null | 2 | ✅ | 61.0M | ✅ | 127K | 🟢 **-100%** |
| const.json | const with false does not match 0 | 3 | ✅ | 50.2M | ✅ | 96K | 🟢 **-100%** |
| const.json | const with true does not match 1 | 3 | ✅ | 54.6M | ✅ | 97K | 🟢 **-100%** |
...
| const.json | const with 0 does not match other zer... | 6 | ✅ | 50.0M | ✅ | 96K | 🟢 **-100%** |
| const.json | const with 1 does not match true | 3 | ✅ | 60.1M | ✅ | 190K | 🟢 **-100%** |
| const.json | const with -2.0 matches integer and f... | 5 | ✅ | 51.4M | ✅ | 107K | 🟢 **-100%** |
| const.json | float and integers are equal up to 64... | 4 | ✅ | 57.4M | ✅ | 125K | 🟢 **-100%** |
| const.json | nul characters in strings | 2 | ✅ | 52.4M | ✅ | 128K | 🟢 **-100%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 46.6M | ✅ | 123K | 🟢 **-100%** |
| const.json | characters with the same visual repre... | 2 | ✅ | 53.5M | ✅ | 129K | 🟢 **-100%** |
...
| contains.json | contains with null instance elements | 1 | ✅ | 77.0M | ✅ | 25.7M | 🟢 **-67%** |
| content.json | validation of string-encoded content ... | 3 | ✅ | 174.5M | ✅ | 28.2M | 🟢 **-84%** |
| content.json | validation of binary string-encoding | 3 | ✅ | 176.3M | ✅ | 27.1M | 🟢 **-85%** |
| content.json | validation of binary-encoded media ty... | 4 | ✅ | 178.8M | ✅ | 28.9M | 🟢 **-84%** |
| content.json | validation of binary-encoded media ty... | 8 | ✅ | 175.3M | ✅ | 27.2M | 🟢 **-84%** |
| default.json | invalid type for default | 2 | ✅ | 64.7M | ✅ | 27.9M | 🟢 **-57%** |
| default.json | invalid string value for default | 2 | ✅ | 46.7M | ✅ | 26.6M | 🟢 **-43%** |
| default.json | the default keyword does not do anyth... | 3 | ✅ | 41.2M | ✅ | 172K | 🟢 **-100%** |
...
| enum.json | simple enum validation | 2 | ✅ | 57.6M | ✅ | 88K | 🟢 **-100%** |
| enum.json | heterogeneous enum validation | 5 | ✅ | 39.2M | ❌ | - | - |
| enum.json | heterogeneous enum-with-null validation | 3 | ✅ | 62.9M | ✅ | 145K | 🟢 **-100%** |
| enum.json | enums in properties | 6 | ✅ | 34.7M | ✅ | 90K | 🟢 **-100%** |
| enum.json | enum with escaped characters | 3 | ✅ | 67.2M | ✅ | 178K | 🟢 **-100%** |
| enum.json | enum with false does not match 0 | 3 | ✅ | 55.3M | ✅ | 94K | 🟢 **-100%** |
| enum.json | enum with [false] does not match [0] | 3 | ✅ | 51.0M | ❌ | - | - |
| enum.json | enum with true does not match 1 | 3 | ✅ | 54.7M | ✅ | 94K | 🟢 **-100%** |
| enum.json | enum with [true] does not match [1] | 3 | ✅ | 50.9M | ❌ | - | - |
| enum.json | enum with 0 does not match false | 3 | ✅ | 61.8M | ✅ | 183K | 🟢 **-100%** |
| enum.json | enum with [0] does not match [false] | 3 | ✅ | 56.3M | ❌ | - | - |
| enum.json | enum with 1 does not match true | 3 | ✅ | 61.7M | ✅ | 185K | 🟢 **-100%** |
| enum.json | enum with [1] does not match [true] | 3 | ✅ | 56.0M | ❌ | - | - |
| enum.json | nul characters in strings | 2 | ✅ | 52.7M | ✅ | 124K | 🟢 **-100%** |
| exclusiveMaximum.json | exclusiveMaximum validation | 4 | ✅ | 56.0M | ❌ | - | - |
| exclusiveMinimum.json | exclusiveMinimum validation | 4 | ✅ | 56.3M | ❌ | - | - |
| format.json | email format | 7 | ✅ | 182.9M | ✅ | 26.1M | 🟢 **-86%** |
| format.json | idn-email format | 7 | ✅ | 175.2M | ✅ | 28.8M | 🟢 **-84%** |
| format.json | regex format | 7 | ✅ | 181.7M | ✅ | 27.0M | 🟢 **-85%** |
| format.json | ipv4 format | 7 | ✅ | 182.4M | ✅ | 28.9M | 🟢 **-84%** |
| format.json | ipv6 format | 7 | ✅ | 183.5M | ✅ | 27.0M | 🟢 **-85%** |
| format.json | idn-hostname format | 7 | ✅ | 183.2M | ✅ | 28.8M | 🟢 **-84%** |
| format.json | hostname format | 7 | ✅ | 182.6M | ✅ | 27.2M | 🟢 **-85%** |
| format.json | date format | 7 | ✅ | 184.3M | ✅ | 27.8M | 🟢 **-85%** |
| format.json | date-time format | 7 | ✅ | 175.7M | ✅ | 26.6M | 🟢 **-85%** |
| format.json | time format | 7 | ✅ | 179.4M | ✅ | 28.7M | 🟢 **-84%** |
| format.json | json-pointer format | 7 | ✅ | 182.7M | ✅ | 27.2M | 🟢 **-85%** |
| format.json | relative-json-pointer format | 7 | ✅ | 182.8M | ✅ | 28.6M | 🟢 **-84%** |
| format.json | iri format | 7 | ✅ | 182.4M | ✅ | 25.9M | 🟢 **-86%** |
| format.json | iri-reference format | 7 | ✅ | 183.5M | ✅ | 28.8M | 🟢 **-84%** |
| format.json | uri format | 7 | ✅ | 183.2M | ✅ | 26.6M | 🟢 **-85%** |
| format.json | uri-reference format | 7 | ✅ | 180.5M | ✅ | 28.6M | 🟢 **-84%** |
| format.json | uri-template format | 7 | ✅ | 183.0M | ✅ | 27.1M | 🟢 **-85%** |
| format.json | uuid format | 7 | ✅ | 183.7M | ✅ | 28.7M | 🟢 **-84%** |
| format.json | duration format | 7 | ✅ | 183.6M | ✅ | 27.1M | 🟢 **-85%** |
...
| items.json | items with boolean schema (true) | 2 | ✅ | 171.0M | ✅ | 26.6M | 🟢 **-84%** |
| items.json | items with boolean schema (false) | 2 | ✅ | 58.6M | ❌ | - | - |
| items.json | items and subitems | 6 | ✅ | 27.3M | ❌ | - | - |
| items.json | nested items | 3 | ✅ | 12.7M | ✅ | 65K | 🟢 **-99%** |
...
| items.json | items with null instance elements | 1 | ✅ | 73.6M | ✅ | 25.4M | 🟢 **-65%** |
| maxContains.json | maxContains without contains is ignored | 2 | ✅ | 171.0M | ✅ | 28.1M | 🟢 **-84%** |
...
| minContains.json | minContains without contains is ignored | 2 | ✅ | 171.5M | ✅ | 26.3M | 🟢 **-85%** |
...
| minContains.json | minContains = 0 | 2 | ✅ | 171.3M | ✅ | 26.3M | 🟢 **-85%** |
...
| multipleOf.json | small multiple of large integer | 1 | ✅ | 66.1M | ✅ | 810K | 🟢 **-99%** |
...
| not.json | forbid everything with empty schema | 9 | ✅ | 43.0M | ✅ | 70K | 🟢 **-100%** |
...
| oneOf.json | oneOf with boolean schemas, all true | 1 | ✅ | 46.9M | ✅ | 61K | 🟢 **-100%** |
| oneOf.json | oneOf with boolean schemas, one true | 1 | ✅ | 159.0M | ✅ | 4.9M | 🟢 **-97%** |
| oneOf.json | oneOf with boolean schemas, more than... | 1 | ✅ | 46.9M | ✅ | 61K | 🟢 **-100%** |
| oneOf.json | oneOf with boolean schemas, all false | 1 | ✅ | 46.9M | ✅ | 42K | 🟢 **-100%** |
| oneOf.json | oneOf complex types | 4 | ✅ | 36.4M | ❌ | - | - |
| oneOf.json | oneOf with empty schema | 2 | ✅ | 58.2M | ✅ | 120K | 🟢 **-100%** |
| oneOf.json | oneOf with required | 4 | ✅ | 37.4M | ❌ | - | - |
| oneOf.json | oneOf with missing optional property | 4 | ✅ | 38.4M | ❌ | - | - |
| oneOf.json | nested oneOf, to check validation sem... | 2 | ✅ | 58.8M | ✅ | 124K | 🟢 **-100%** |
| pattern.json | pattern validation | 8 | ✅ | 49.7M | ❌ | - | - |
| pattern.json | pattern is not anchored | 1 | ✅ | 47.4M | ✅ | 25.6M | 🟢 **-46%** |
...
| patternProperties.json | patternProperties with null valued in... | 1 | ✅ | 15.9M | ✅ | 25.5M | 🔴 **+60%** |
| prefixItems.json | a schema given for prefixItems | 6 | ✅ | 58.5M | ❌ | - | - |
| prefixItems.json | prefixItems with boolean schemas | 3 | ✅ | 57.2M | ❌ | - | - |
| prefixItems.json | additional items are allowed by default | 1 | ✅ | 78.9M | ✅ | 25.3M | 🟢 **-68%** |
| prefixItems.json | prefixItems with null instance elements | 1 | ✅ | 78.8M | ✅ | 24.5M | 🟢 **-69%** |
...
| properties.json | properties with null valued instance ... | 1 | ✅ | 62.3M | ✅ | 25.2M | 🟢 **-60%** |
| properties.json | properties whose names are Javascript... | 7 | ✅ | 25.0M | ❌ | - | - |
| propertyNames.json | propertyNames validation | 6 | ✅ | 41.4M | ❌ | - | - |
| propertyNames.json | propertyNames validation with pattern | 3 | ✅ | 19.0M | ❌ | - | - |
| propertyNames.json | propertyNames with boolean schema true | 2 | ✅ | 171.5M | ✅ | 25.8M | 🟢 **-85%** |
...
| ref.json | nested refs | 2 | ✅ | 45.5M | ✅ | 124K | 🟢 **-100%** |
...
| ref.json | $ref to boolean schema true | 1 | ✅ | 158.8M | ✅ | 25.6M | 🟢 **-84%** |
...
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 58.9M | ✅ | 126K | 🟢 **-100%** |
| ref.json | $id with file URI still resolves poin... | 2 | ✅ | 58.9M | ✅ | 126K | 🟢 **-100%** |
...
| required.json | required with empty array | 1 | ✅ | 159.5M | ✅ | 23.6M | 🟢 **-85%** |
| required.json | required with escaped characters | 2 | ✅ | 41.9M | ❌ | - | - |
| required.json | required properties whose names are J... | 7 | ✅ | 22.4M | ❌ | - | - |
| type.json | integer type matches integers | 9 | ✅ | 46.1M | ✅ | 86K | 🟢 **-100%** |
| type.json | number type matches numbers | 9 | ✅ | 50.8M | ✅ | 106K | 🟢 **-100%** |
| type.json | string type matches strings | 9 | ✅ | 51.3M | ✅ | 104K | 🟢 **-100%** |
| type.json | object type matches objects | 7 | ✅ | 43.5M | ✅ | 81K | 🟢 **-100%** |
| type.json | array type matches arrays | 7 | ✅ | 47.7M | ✅ | 81K | 🟢 **-100%** |
| type.json | boolean type matches booleans | 10 | ✅ | 47.4M | ✅ | 86K | 🟢 **-100%** |
| type.json | null type matches only the null object | 10 | ✅ | 43.3M | ✅ | 78K | 🟢 **-100%** |
| type.json | multiple types can be specified in an... | 7 | ✅ | 47.5M | ✅ | 70K | 🟢 **-100%** |
| type.json | type as array with one item | 2 | ✅ | 58.9M | ✅ | 124K | 🟢 **-100%** |
| type.json | type: array or object | 5 | ✅ | 50.3M | ✅ | 79K | 🟢 **-100%** |
| type.json | type: array, object or null | 5 | ✅ | 55.6M | ✅ | 107K | 🟢 **-100%** |
...
| uniqueItems.json | uniqueItems=false validation | 15 | ✅ | 145.5M | ✅ | 25.7M | 🟢 **-82%** |
| uniqueItems.json | uniqueItems=false with an array of items | 8 | ✅ | 68.4M | ✅ | 25.5M | 🟢 **-63%** |
...
| vocabulary.json | ignore unrecognized optional vocabulary | 2 | ✅ | 58.9M | ✅ | 124K | 🟢 **-100%** |
| optional/anchor.json | $anchor inside an enum is not a real ... | 4 | ✅ | 47.3M | ❌ | - | - |
| optional/bignum.json | integer | 2 | ✅ | 76.1M | ❌ | - | - |
| optional/bignum.json | number | 2 | ✅ | 80.0M | ✅ | 24.2M | 🟢 **-70%** |
| optional/bignum.json | string | 1 | ✅ | 45.0M | ✅ | 63K | 🟢 **-100%** |
| optional/bignum.json | maximum integer comparison | 1 | ✅ | 73.5M | ✅ | 24.6M | 🟢 **-66%** |
| optional/bignum.json | float comparison with high precision | 1 | ✅ | 43.1M | ❌ | - | - |
| optional/bignum.json | minimum integer comparison | 1 | ✅ | 73.5M | ✅ | 24.8M | 🟢 **-66%** |
| optional/bignum.json | float comparison with high precision ... | 1 | ✅ | 43.1M | ❌ | - | - |
...
| optional/dependencies-compatibility.json | empty dependents | 3 | ✅ | 175.7M | ✅ | 26.1M | 🟢 **-85%** |
...
| optional/ecmascript-regex.json | ECMA 262 regex $ does not match trail... | 2 | ✅ | 48.2M | ✅ | 115K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 regex converts \t to horizon... | 2 | ✅ | 23.6M | ✅ | 116K | 🟢 **-100%** |
...
| optional/ecmascript-regex.json | ECMA 262 \d matches ascii digits only | 3 | ✅ | 25.0M | ✅ | 89K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \D matches everything but as... | 3 | ✅ | 24.1M | ✅ | 175K | 🟢 **-99%** |
| optional/ecmascript-regex.json | ECMA 262 \w matches ascii letters only | 2 | ✅ | 26.3M | ✅ | 116K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \W matches everything but as... | 2 | ✅ | 24.7M | ✅ | 115K | 🟢 **-100%** |
| optional/ecmascript-regex.json | ECMA 262 \s matches whitespace | 11 | ✅ | 22.8M | ✅ | 313K | 🟢 **-99%** |
...
| optional/format/time.json | validation of time strings | 46 | ✅ | 6.5M | ❌ | - | - |
| optional/format/unknown.json | unknown format | 7 | ✅ | 74.9M | ✅ | 25.4M | 🟢 **-66%** |
| optional/format/uri-reference.json | validation of URI References | 15 | ✅ | 9.8M | ❌ | - | - |
