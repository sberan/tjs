...
type InferSchema<S extends JsonSchemaBase, Defs, Depth extends unknown[], Root> = S extends {
...
type InferArray<S extends JsonSchemaBase, Defs, Depth extends unknown[], Root> = S extends {
  prefixItems: readonly JsonSchema[];
}
  ? S extends { items: false }
    ? InferTuple<S['prefixItems'], Defs, Depth, Root>
...
type InferRef<R extends string, Defs, Depth extends unknown[], Root> = R extends '#'
  ? Infer<Root, Defs, [...Depth, unknown], Root>
...
export interface Validator<T> {
  ...
  validate(
    ...
    | { valid: false; value: undefined; error: unknown[] };
